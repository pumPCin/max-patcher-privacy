...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lepd;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Lw8a;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Lvv4;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lw8a;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lvv4;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lwv4;)Lbod;
    .locals 3

    new-instance v0, Lbod;

    invoke-direct {v0, p1, p5}, Lbod;-><init>(Ljava/lang/Runnable;Lwv4;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lwv4;->a(Lvv4;)Z
    ...
    iget-object v1, p0, Lw8a;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Lbod;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lwv4;->b(Lvv4;)Z
...
.method public final g()V
    ...
    iget-object v0, p0, Lw8a;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

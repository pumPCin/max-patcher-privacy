...
.method public constructor <init>(Lc45;)V
    ...
    iput-object v0, p0, Lzm4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lzm4;->Y:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lzm4;->Z:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lzm4;->r0:Ljava/util/LinkedHashMap;

    iput v1, p0, Lzm4;->s0:I

    iput-boolean v1, p0, Lzm4;->t0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lzm4;->u0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lzm4;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lzm4;->o:Landroid/os/Handler;

    new-instance v0, Lgv6;

    invoke-direct {v0, v1}, Lgv6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lzm4;->c:Lgv6;

    new-instance v0, Lgw4;

    invoke-direct {v0}, Lgw4;-><init>()V

    iput-object v0, p0, Lzm4;->a:Lgw4;

    :try_start_0
    new-instance v0, Lo00;

    invoke-direct {v0, p0, p1}, Lo00;-><init>(Lzm4;Lc45;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lbu1;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lzm4;->release()V
...
.method public final a()V
    ...
    iget-boolean v0, p0, Lzm4;->t0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lzm4;->s0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lzm4;->r0:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lref;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lzm4;->u0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lyt1;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lzm4;->a:Lgw4;

    invoke-virtual {v0}, Lgw4;->q()V

    iget-object v0, p0, Lzm4;->b:Landroid/os/HandlerThread;
...
.method public final b(Lzef;)V
    .locals 3

    iget-object v0, p0, Lzm4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Lwm4;-><init>(Lzef;I)V

    invoke-virtual {p0, v0, v1}, Lzm4;->c(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public final d(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lzm4;->u0:Ljava/util/ArrayList;
...
.method public final e(II)Lo18;
    .locals 1

    new-instance v0, Lbg4;

    invoke-direct {v0, p0, p1, p2}, Lbg4;-><init>(Ljava/lang/Object;II)V
...
.method public final f(Lref;)V
    ...
    invoke-direct {v1, v2, p1}, Lsi4;-><init>(ILjava/lang/Object;)V
...
.method public final g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Llgi;->b([FF)V

    invoke-static {v1}, Llgi;->c([F)V
    ...
    invoke-static {v6}, Ltj6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Ltj6;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Ltj6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Ltj6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Ltj6;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Lgw4;->k:Ljava/lang/Object;
    ...
    iget-object v6, v3, Lgw4;->m:Ljava/lang/Object;

    check-cast v6, Lrj6;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Lsj6;
    ...
    invoke-static {v4}, Ltj6;->b(Ljava/lang/String;)V
...
.method public final h(Ld4g;)V
    ...
    invoke-virtual {p0, p1}, Lzm4;->d(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Ld4g;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Ld4g;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lzm4;->g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Ld4g;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Ls90;->c:Lyt1;

    invoke-virtual {v8, v3}, Lyt1;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lzm4;->Y:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lzm4;->r0:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lzm4;->Z:[F

    invoke-virtual {v3, v5, v0}, Lref;->n([F[F)V
    ...
    :try_start_0
    iget-object v3, p0, Lzm4;->a:Lgw4;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lgw4;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v6, v7}, Lbui;->f(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v8}, Lbui;->f(Ljava/lang/String;Z)V

    new-instance v2, Ld4g;

    iget-object v3, v3, Lref;->o:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Ld4g;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lzm4;->h(Ld4g;)V
    :try_end_1
...
.method public final release()V
    ...
    invoke-direct {v0, v1, p0}, Lsi4;-><init>(ILjava/lang/Object;)V

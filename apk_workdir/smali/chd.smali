...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v0, p0, Lchd;->Y:Landroid/graphics/RectF;

    const/16 v0, 0x8

    new-array v1, v0, [F

    iput-object v1, p0, Lchd;->Z:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lchd;->r0:[F

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, p1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lchd;->s0:Landroid/graphics/Paint;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lchd;->t0:Z

    const/4 v0, 0x0

    iput v0, p0, Lchd;->u0:F

    iput p1, p0, Lchd;->v0:I

    iput p1, p0, Lchd;->w0:I

    iput v0, p0, Lchd;->x0:F

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lchd;->y0:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lchd;->z0:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lchd;->A0:Landroid/graphics/RectF;
...
.method public final a(IF)V
    ...
    iput p2, p0, Lchd;->u0:F

    invoke-virtual {p0}, Lchd;->p()V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lchd;->Y:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lchd;->y0:Landroid/graphics/Path;

    iget-object v8, p0, Lchd;->s0:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, Lchd;->z0:Landroid/graphics/Path;
...
.method public final m([F)V
    ...
    invoke-static {v4, v1}, Lxti;->b(Ljava/lang/String;Z)V
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-super {p0, p1}, Lmc6;->onBoundsChange(Landroid/graphics/Rect;)V
...
.method public final p()V
    ...
    iget-object v0, p0, Lchd;->y0:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lchd;->z0:Landroid/graphics/Path;
    ...
    :cond_0
    iget-boolean v2, p0, Lchd;->t0:Z

    iget-object v4, p0, Lchd;->Z:[F
    ...
    :goto_0
    iget v0, p0, Lchd;->x0:F

    neg-float v0, v0

    invoke-virtual {v3, v0, v0}, Landroid/graphics/RectF;->inset(FF)V

    iget v0, p0, Lchd;->u0:F

    div-float/2addr v0, v5

    invoke-virtual {v3, v0, v0}, Landroid/graphics/RectF;->inset(FF)V

    iget-boolean v0, p0, Lchd;->t0:Z
    ...
    iget v7, p0, Lchd;->x0:F

    add-float/2addr v6, v7

    iget v7, p0, Lchd;->u0:F

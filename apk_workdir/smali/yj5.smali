...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lyj5;->b:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lyj5;->getTypography()Lurf;
    ...
    iput-object p1, p0, Lyj5;->o:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lyj5;->r0:I

    invoke-virtual {v0, p0}, Lk82;->n(Landroid/view/View;)Lv5b;

    move-result-object p1

    invoke-virtual {p0, p1}, Lyj5;->onThemeChanged(Lv5b;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Lnh2;->n(Ljava/lang/CharSequence;)Lnve;
    ...
    iget-object v1, p0, Lyj5;->a:Lfu7;

    iget-object v3, p0, Lyj5;->o:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lyj5;->q0:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lyj5;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lyj5;->u0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lyj5;->r0:I

    if-gt v1, v2, :cond_1

    iget-object p1, p0, Lyj5;->u0:Landroid/text/Layout;
    ...
    iget-object v3, p0, Lyj5;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lyj5;->o:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Lzaf;->e0(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v4, p0}, Loh7;-><init>(ILjava/lang/Object;)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Lsgi;->p(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lyj5;->t0:Landroid/text/Layout;

    iget-boolean v0, p0, Lyj5;->x0:Z
    ...
    :cond_8
    iput-object p1, p0, Lyj5;->s0:Landroid/text/Layout;
...
.method public final c()V
    ...
    invoke-virtual {p0, v0}, Lyj5;->b(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lyj5;->v0:Z
    ...
    :cond_0
    iget-object v0, p0, Lyj5;->z0:Lbr0;
    ...
    iput-object v0, p0, Lyj5;->z0:Lbr0;

    invoke-virtual {p0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Lyj5;->z0:Lbr0;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object v0, p0, Lyj5;->s0:Landroid/text/Layout;

    return-object v0
.end method

.method public final getTypography()Lurf;
    .locals 2

    sget-object v0, Lyj5;->A0:[Ltr7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lyj5;->c:Lsk;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lyj5;->y0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lyj5;->s0:Landroid/text/Layout;
...
.method public final onThemeChanged(Lv5b;)V
    ...
    iget-object v0, p0, Lyj5;->o:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lyj5;->q0:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v1, p0, Lyj5;->s0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Lu15;->c(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    .line 1
    iput-object p1, p0, Lyj5;->q0:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v0, v1}, Lt93;->j(Ljava/lang/CharSequence;II)Landroid/text/Spannable;
    ...
    .line 6
    iput-boolean p1, p0, Lyj5;->x0:Z

    .line 7
    iput-boolean p1, p0, Lyj5;->v0:Z

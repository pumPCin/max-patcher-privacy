...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILax0;)V
    .locals 1
    ...
    iput-object p1, p0, Lnh4;->Z:Ljava/lang/String;

    iput p2, p0, Lnh4;->X:I

    iput p3, p0, Lnh4;->Y:I

    iput-object p4, p0, Lnh4;->r0:Lax0;
    ...
    iput-object p1, p0, Lnh4;->s0:Lax0;
...
.method public final G(Lc94;)J
    ...
    iput-object v0, v1, Lnh4;->t0:Lc94;

    const-wide/16 v12, 0x0

    iput-wide v12, v1, Lnh4;->z0:J

    iput-wide v12, v1, Lnh4;->y0:J
    ...
    iget-object v3, v0, Lc94;->a:Landroid/net/Uri;
    ...
    :goto_0
    iget-object v11, v0, Lc94;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Lnh4;->g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Lc94;->f:J

    iget-wide v5, v0, Lc94;->g:J

    iput-object v2, v1, Lnh4;->u0:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, Lnh4;->x0:I
    ...
    sget-object v8, Li07;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v9}, Lhq;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v9, Li07;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v5}, Lhq;->K(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v10, v5}, Lhq;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v1, Lnh4;->v0:Ljava/io/InputStream;

    if-eqz v7, :cond_a

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Lnh4;->v0:Ljava/io/InputStream;
    ...
    :goto_6
    iput-boolean v9, v1, Lnh4;->w0:Z

    invoke-virtual/range {p0 .. p1}, Lni0;->d(Lc94;)V

    :try_start_5
    invoke-virtual {v1, v3, v4}, Lnh4;->h(J)V
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_4

    iget-wide v2, v1, Lnh4;->y0:J
    ...
    :cond_c
    sget-object v8, Li07;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lnh4;->v0:Ljava/io/InputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Lnh4;->v0:Ljava/io/InputStream;

    invoke-virtual {p0}, Lnh4;->e()V

    iget-boolean v2, p0, Lnh4;->w0:Z

    if-eqz v2, :cond_1

    iput-boolean v0, p0, Lnh4;->w0:Z

    invoke-virtual {p0}, Lni0;->b()V

    :cond_1
    iput-object v1, p0, Lnh4;->u0:Ljava/net/HttpURLConnection;

    iput-object v1, p0, Lnh4;->t0:Lc94;
...
.method public final e()V
    ...
    iget-object v0, p0, Lnh4;->u0:Ljava/net/HttpURLConnection;
...
.method public final g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lnh4;->r0:Lax0;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lax0;->z()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Lnh4;->s0:Lax0;
    ...
    :cond_1
    sget-object p10, Li07;->a:Ljava/util/regex/Pattern;
    ...
    :cond_4
    iget-object p4, p0, Lnh4;->Z:Ljava/lang/String;
    ...
    invoke-static {p2}, Lc94;->b(I)Ljava/lang/String;
...
.method public final getUri()Landroid/net/Uri;
    ...
    :cond_0
    iget-object v0, p0, Lnh4;->t0:Lc94;
...
.method public final h(J)V
    ...
    iget-object v5, p0, Lnh4;->v0:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Lni0;->a(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lnh4;->v0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lnh4;->z0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lnh4;->z0:J

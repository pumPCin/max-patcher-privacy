...
.method public synthetic constructor <init>(Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;Landroid/content/Intent;Landroid/content/Context;ZLandroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-boolean p4, p0, Lkxf;->b:Z

    iput-object p5, p0, Lkxf;->X:Ljava/lang/Object;

    return-void
.end method

.method public constructor <init>(Llxf;ZLjava/io/File;Lno5;)V
    .locals 1
    ...
    iput-object p4, p0, Lkxf;->o:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v2, v1, Lkxf;->o:Ljava/lang/Object;

    check-cast v2, Landroid/content/Context;

    iget-boolean v3, v1, Lkxf;->b:Z

    iget-object v4, v1, Lkxf;->X:Ljava/lang/Object;
    ...
    invoke-direct {v5, v0}, Lp73;-><init>(Landroid/content/Intent;)V
    ...
    invoke-direct {v7, v11, v12}, Lhv9;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v9, v2, v5, v8}, Lun3;-><init>(Landroid/content/Context;Lp73;Ljava/util/concurrent/CountDownLatch;)V
    ...
    invoke-direct {v5, v2, v7}, Ljnb;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v5, v0}, Ljnb;->s(Landroid/content/Intent;)Lflh;
    ...
    iget-object v4, v4, Lxq4;->a:Ljava/io/File;
    ...
    invoke-static {v6, v7}, Lk84;->M(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v0, :cond_9

    :try_start_9
    invoke-static {v4}, Li4f;->c(Ljava/io/File;)V
    ...
    :cond_9
    :goto_8
    iget-object v7, v1, Lkxf;->c:Ljava/lang/Object;

    check-cast v7, Ljava/io/File;

    const/4 v8, 0x1

    invoke-static {v7, v8, v0}, Llxf;->i(Ljava/io/File;BZ)V
    :try_end_9
    ...
    invoke-static {v6, v0}, Lk84;->M(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v3}, Lk84;->M(Ljava/lang/String;Ljava/lang/String;)V

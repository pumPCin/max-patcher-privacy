...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lt76;Landroid/media/MediaFormat;Ljava/lang/String;ZLandroid/view/Surface;)V
    .locals 9

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lnf4;->c:Lt76;

    iput-object p3, p0, Lnf4;->b:Landroid/media/MediaFormat;

    iput-boolean p5, p0, Lnf4;->g:Z
    ...
    iput-boolean p2, p0, Lnf4;->h:Z

    new-instance v0, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {v0}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iput-object v0, p0, Lnf4;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iput-object v0, p0, Lnf4;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p6, v3}, Lpih;->h(Ljava/lang/Object;Z)V
    ...
    iput-object v7, p0, Lnf4;->d:Landroid/media/MediaCodec;

    iput-object v6, p0, Lnf4;->e:Landroid/view/Surface;

    invoke-static {p1}, Lt4g;->N(Landroid/content/Context;)Z
    ...
    invoke-static {p2, p6, p1}, Lj40;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-direct {v0, p3, p4, p6, p5}, Lc11;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, p2, v0}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILc11;)Landroidx/media3/transformer/ExportException;
...
.method public static a(Landroid/media/MediaFormat;ZLgk9;)Lt76;
    .locals 1

    invoke-static {p0}, Lud6;->l(Landroid/media/MediaFormat;)Lt76;

    move-result-object p0

    invoke-virtual {p0}, Lt76;->a()Lq76;

    move-result-object v0

    iput-object p2, v0, Lq76;->k:Lgk9;
    ...
    invoke-direct {p0, v0}, Lt76;-><init>(Lq76;)V
...
.method public final b(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
    ...
    :goto_0
    invoke-virtual {p0}, Lnf4;->c()Ljava/lang/String;

    move-result-object v2

    new-instance v3, Lc11;

    iget-object v4, p0, Lnf4;->b:Landroid/media/MediaFormat;

    invoke-virtual {v4}, Landroid/media/MediaFormat;->toString()Ljava/lang/String;

    move-result-object v4

    iget-boolean v5, p0, Lnf4;->h:Z

    invoke-direct {v3, v4, v2, v5, v0}, Lc11;-><init>(Ljava/lang/String;Ljava/lang/String;ZZ)V

    invoke-static {p1, v1, v3}, Landroidx/media3/transformer/ExportException;->c(Ljava/lang/Exception;ILc11;)Landroidx/media3/transformer/ExportException;
...
.method public final c()Ljava/lang/String;
    ...
    iget-object v2, p0, Lnf4;->d:Landroid/media/MediaCodec;

    if-lt v0, v1, :cond_0

    invoke-static {v2}, Lg4;->h(Landroid/media/MediaCodec;)Ljava/lang/String;
...
.method public final d()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0}, Lnf4;->g(Z)Z
    ...
    :cond_0
    iget-object v0, p0, Lnf4;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v0, p0, Lnf4;->k:Ljava/nio/ByteBuffer;
...
.method public final f(Lkc4;)Z
    ...
    iput-object v2, p1, Lkc4;->X:Ljava/nio/ByteBuffer;
    :try_end_1
    ...
    invoke-static {v1, v0, p1}, Lj40;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V

    invoke-virtual {p0, p1}, Lnf4;->b(Ljava/lang/RuntimeException;)Landroidx/media3/transformer/ExportException;
...
.method public final g(Z)Z
    ...
    iget-object v2, p0, Lnf4;->c:Lt76;

    iget-boolean v3, p0, Lnf4;->g:Z

    iget-object v4, p0, Lnf4;->d:Landroid/media/MediaCodec;

    iget-object v5, p0, Lnf4;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v0, v2, Lt76;->l:Lgk9;

    invoke-static {p1, v3, v0}, Lnf4;->a(Landroid/media/MediaFormat;ZLgk9;)Lt76;

    move-result-object p1

    iput-object p1, p0, Lnf4;->j:Lt76;

    if-eqz v3, :cond_2

    iget-object p1, v2, Lt76;->n:Ljava/lang/String;
    ...
    iget-object p1, p0, Lnf4;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object p1, p0, Lnf4;->k:Ljava/nio/ByteBuffer;
    :try_end_5
    ...
    iget-object p1, p0, Lnf4;->k:Ljava/nio/ByteBuffer;
...
.method public final h(Lkc4;)V
    ...
    iget-object v3, p1, Lkc4;->X:Ljava/nio/ByteBuffer;
    ...
    :goto_4
    :try_start_2
    iget-object v0, p0, Lnf4;->d:Landroid/media/MediaCodec;
    ...
    iput-object v0, p1, Lkc4;->X:Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1, p1}, Lj40;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public final i()V
    ...
    iput-object v0, p0, Lnf4;->k:Ljava/nio/ByteBuffer;

    iget-object v0, p0, Lnf4;->e:Landroid/view/Surface;
...
.method public final j()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lnf4;->k(JZ)V
...
.method public final k(JZ)V
    ...
    iput-object v1, p0, Lnf4;->k:Ljava/nio/ByteBuffer;
    ...
    invoke-static {p2, p3, p1}, Lj40;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V

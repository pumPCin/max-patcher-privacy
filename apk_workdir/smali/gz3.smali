...
.method public synthetic constructor <init>(Lone/me/sdk/arch/Widget;I)V
    ...
    iput-object p1, p0, Lgz3;->e:Ljava/lang/Object;
...
.method public constructor <init>(Lone/me/startconversation/StartConversationScreen;Z)V
    ...
    .line 3
    invoke-direct {p0, p2}, Lada;-><init>(Z)V

    return-void
.end method

.method public constructor <init>(ZLvd6;)V
    .locals 1
...
.method public a()V
    ...
    :cond_0
    iget-object v1, v0, Landroidx/fragment/app/c;->h:Lge0;

    if-eqz v1, :cond_2

    const/4 v2, 0x0

    iput-boolean v2, v1, Lge0;->r:Z
    ...
    iget-object v4, v1, Lge0;->p:Ljava/util/ArrayList;
    ...
    iput-object v4, v1, Lge0;->p:Ljava/util/ArrayList;

    :cond_1
    iget-object v1, v1, Lge0;->p:Ljava/util/ArrayList;

    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Landroidx/fragment/app/c;->h:Lge0;

    invoke-virtual {v1, v2}, Lge0;->d(Z)I
    ...
    iput-object v1, v0, Landroidx/fragment/app/c;->h:Lge0;
...
.method public final b()V
    ...
    iget-object v3, p0, Lgz3;->e:Ljava/lang/Object;

    packed-switch v0, :pswitch_data_0

    check-cast v3, Lone/me/startconversation/StartConversationScreen;

    iget-object v0, v3, Lone/me/startconversation/StartConversationScreen;->u0:Lvoc;
    ...
    invoke-interface {v0, v3, v1}, Lvoc;->D(Ljava/lang/Object;Lpl7;)Ljava/lang/Object;
    ...
    invoke-interface {v3, p0}, Lvd6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v9, v3, Landroidx/fragment/app/c;->h:Lge0;
    ...
    :cond_6
    iget-object v6, v3, Landroidx/fragment/app/c;->h:Lge0;

    iget-object v6, v6, Lge0;->a:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Lsa6;->b:Landroidx/fragment/app/a;
    ...
    iget-object v6, v2, Lvj4;->c:Ljava/util/ArrayList;
    ...
    :cond_9
    invoke-virtual {v2, v6}, Lvj4;->i(Ljava/util/List;)V

    invoke-virtual {v2, v6}, Lvj4;->c(Ljava/util/List;)V

    goto :goto_3

    :cond_a
    iget-object v1, v3, Landroidx/fragment/app/c;->h:Lge0;
    ...
    :cond_c
    iput-object v8, v3, Landroidx/fragment/app/c;->h:Lge0;
    ...
    :cond_10
    iget-object v0, v3, Landroidx/fragment/app/c;->g:Lida;
    ...
    invoke-virtual {v3}, Lone/me/calls/ui/ui/incoming/CallIncomingScreen;->D0()Lm91;

    move-result-object v0

    iget-object v0, v0, Lm91;->s0:Lhne;
    ...
    invoke-direct {v3, v2}, Li91;-><init>(Z)V
    ...
    iget-object v0, v3, Ljz3;->router:Ln6d;

    invoke-virtual {v0}, Ln6d;->i()Ln6d;

    move-result-object v0

    invoke-virtual {v0}, Ln6d;->m()Z

    move-result v0

    if-nez v0, :cond_14

    invoke-virtual {p0, v2}, Lada;->f(Z)V

    invoke-virtual {v3}, Ljz3;->getOnBackPressedDispatcher()Lida;

    move-result-object v0

    invoke-virtual {v0}, Lida;->d()V

    iget-boolean v0, v3, Ljz3;->isBeingDestroyed:Z

    if-nez v0, :cond_14

    invoke-virtual {p0, v1}, Lada;->f(Z)V
...
.method public c(Lfe0;)V
    ...
    :cond_0
    iget-object v2, v0, Landroidx/fragment/app/c;->h:Lge0;

    if-eqz v2, :cond_6

    new-instance v2, Ljava/util/ArrayList;

    iget-object v4, v0, Landroidx/fragment/app/c;->h:Lge0;
    ...
    :cond_2
    iget-object v5, v5, Lvj4;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, v7, Llie;->k:Ljava/util/ArrayList;

    invoke-static {v6, v7}, Lc93;->T(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-static {v5}, Lw83;->B0(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v8, p1}, Lkie;->c(Lfe0;)V
...
.method public d()V
    ...
    invoke-direct {v1, v0}, Lka6;-><init>(Landroidx/fragment/app/c;)V

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroidx/fragment/app/c;->x(Lia6;Z)V

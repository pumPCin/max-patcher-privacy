...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lqx2;)V
    .locals 7
    ...
    invoke-direct {v1, p2, v2, v3}, Lu26;-><init>(Ljava/lang/Object;Ljava/util/concurrent/ExecutorService;I)V

    iput-object v1, p0, Ldqc;->U1:Lu26;
    ...
    iput-object p2, p0, Ldqc;->V1:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lxuc;)V

    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Lcvc;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/RecyclerView;->j(Ldvc;)V

    new-instance v1, Lrs4;

    invoke-direct {v1, p1}, Lrs4;-><init>(Landroid/content/Context;)V

    iput-object p2, v1, Lrs4;->c:Ljava/lang/Object;
    ...
    invoke-direct {p1, p2, v0, v1}, Lxfb;-><init>(ILkotlin/coroutines/Continuation;I)V
...
.method public final setContacts(Ljava/util/List;)V
    ...
    iget-object v0, p0, Ldqc;->U1:Lu26;

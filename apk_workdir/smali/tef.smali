...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Lsef;-><init>(Ljava/lang/Object;Ltef;I)V

    iput-object v0, p0, Ltef;->a:Lsef;
    ...
    invoke-direct {p0}, Ltef;->getTheme()Llwa;
    ...
    iput-object p1, p0, Ltef;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-interface {v2}, Llwa;->i()Laxe;
    ...
    iput-object v0, p0, Ltef;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Ltef;->r0:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Ltef;->s0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Ltef;->t0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Ltef;)Llwa;
    .locals 0
...
.method private final getTheme()Llwa;
    .locals 3
    ...
    invoke-virtual {p0}, Ltef;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lnwa;->a(Ljava/lang/String;)Lzma;
    ...
    invoke-virtual {v0, v2}, Lzma;->a(Z)Llwa;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Ltef;->getIncomingColors()[I
    ...
    iput-object v3, v0, Ltef;->u0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Ltef;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Ltef;->v0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Ltef;->w0:[Lpl7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Ltef;->c:Lsef;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v9, p0, Ltef;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Ltef;->s0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v1, v5, v7}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Ltef;->u0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Ltef;->r0:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Ltef;->t0:Landroid/graphics/RectF;

    invoke-virtual {v3, p1, v7, v5, v4}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Ltef;->v0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Llwa;)V
    ...
    iget-object v0, p0, Ltef;->o:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Ltef;->b:Landroid/graphics/drawable/GradientDrawable;

...
# direct methods
.method public static a(Landroid/hardware/camera2/CaptureRequest$Builder;Ls9b;)V
    .locals 4
    ...
    invoke-interface {p1}, Lk0d;->e()Ljava/util/Set;
...
.method public static b(Landroid/hardware/camera2/CaptureRequest$Builder;ILyr0;)V
    .locals 1
...
.method public static c(Lg42;Landroid/hardware/camera2/CameraDevice;Ljava/util/HashMap;ZLyr0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 9
    ...
    iget-object v1, p0, Lg42;->b:Ls9b;

    iget v2, p0, Lg42;->c:I

    iget-object v3, v1, Ls9b;->a:Ljava/util/TreeMap;
    ...
    invoke-interface {p2}, Lwz1;->n()Landroid/hardware/camera2/CaptureResult;
    ...
    invoke-static {v6, p3}, Lgfi;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, p2}, Lgfi;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_3
    invoke-static {p1, v2, p4}, Lsmi;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILyr0;)V

    sget-object p2, Lg42;->k:Lz90;

    sget-object p3, Lvb0;->f:Landroid/util/Range;

    :try_start_0
    invoke-virtual {v1, p2}, Ls9b;->g(Lz90;)Ljava/lang/Object;
    ...
    sget-object p4, Lg42;->k:Lz90;

    :try_start_1
    invoke-virtual {v1, p4}, Ls9b;->g(Lz90;)Ljava/lang/Object;
    ...
    :cond_7
    invoke-virtual {p0}, Lg42;->b()I

    move-result p2

    if-eq p2, v5, :cond_a

    invoke-virtual {p0}, Lg42;->c()I
    ...
    :cond_d
    invoke-static {p1, v1}, Lsmi;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Ls9b;)V
...
.method public static d(Lg42;Landroid/hardware/camera2/CameraDevice;Lyr0;)Landroid/hardware/camera2/CaptureRequest;
    .locals 3
    ...
    invoke-static {p1, v1, p2}, Lsmi;->b(Landroid/hardware/camera2/CaptureRequest$Builder;ILyr0;)V

    iget-object p0, p0, Lg42;->b:Ls9b;

    invoke-static {p1, p0}, Lsmi;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Ls9b;)V
...
.method public static e(Lpf9;)Ll7a;
    .locals 12
    ...
    invoke-direct {v7, v9}, Law9;-><init>(I)V

    invoke-static {p0, v7}, Lg0i;->s(Lpf9;Llx9;)Ljava/util/ArrayList;

    move-result-object v7

    if-eqz v7, :cond_d

    invoke-static {v7}, Lnb3;->z(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-direct {p0, v8, v7}, Ll7a;-><init>(Ljava/lang/String;Ljava/util/List;)V

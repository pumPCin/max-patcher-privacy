...
.method public constructor <init>(La15;)V
    ...
    iput-object v0, p0, Lck4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lck4;->Y:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lck4;->Z:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lck4;->r0:Ljava/util/LinkedHashMap;

    iput v1, p0, Lck4;->s0:I

    iput-boolean v1, p0, Lck4;->t0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lck4;->u0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lck4;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lck4;->o:Landroid/os/Handler;

    new-instance v0, Lgr6;

    invoke-direct {v0, v1}, Lgr6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lck4;->c:Lgr6;

    new-instance v0, Lgt4;

    invoke-direct {v0}, Lgt4;-><init>()V

    iput-object v0, p0, Lck4;->a:Lgt4;

    :try_start_0
    new-instance v0, Lb00;

    invoke-direct {v0, p0, p1}, Lb00;-><init>(Lck4;La15;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lys1;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lck4;->release()V
...
.method public final a()V
    ...
    iget-boolean v0, p0, Lck4;->t0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lck4;->s0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lck4;->r0:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lj1f;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lck4;->u0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lvs1;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lck4;->a:Lgt4;

    invoke-virtual {v0}, Lgt4;->q()V

    iget-object v0, p0, Lck4;->b:Landroid/os/HandlerThread;
...
.method public final b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    :try_start_0
    iget-object v0, p0, Lck4;->c:Lgr6;

    new-instance v1, Lxi;

    const/16 v2, 0x17

    invoke-direct {v1, p0, p2, p1, v2}, Lxi;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final c(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lck4;->u0:Ljava/util/ArrayList;
...
.method public final d(Lq1f;)V
    ...
    iget-object v0, p0, Lck4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Lzj4;-><init>(Lq1f;I)V

    invoke-virtual {p0, v0, v1}, Lck4;->b(Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final e(II)Lbw7;
    .locals 1

    new-instance v0, Led4;

    invoke-direct {v0, p0, p1, p2}, Led4;-><init>(Ljava/lang/Object;II)V
...
.method public final f(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Ltvf;->E([FF)V

    invoke-static {v1}, Ltvf;->F([F)V
    ...
    invoke-static {v6}, Lyf6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lyf6;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Lyf6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lyf6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lyf6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lyf6;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Lgt4;->k:Ljava/lang/Object;
    ...
    iget-object v6, v3, Lgt4;->m:Ljava/lang/Object;

    check-cast v6, Lwf6;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Lxf6;
    ...
    invoke-static {v1}, Lyf6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lyf6;->b(Ljava/lang/String;)V
...
.method public final g(Ldqf;)V
    ...
    invoke-virtual {p0, p1}, Lck4;->c(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Ldqf;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Ldqf;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lck4;->f(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Ldqf;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lg90;->c:Lvs1;

    invoke-virtual {v8, v3}, Lvs1;->b(Ljava/lang/Object;)Z
...
.method public final h(Lj1f;)V
    ...
    invoke-direct {v1, v2, p1}, Lvd4;-><init>(ILjava/lang/Object;)V
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lck4;->Y:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lck4;->r0:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lck4;->Z:[F

    invoke-virtual {v3, v5, v0}, Lj1f;->n([F[F)V
    ...
    :try_start_0
    iget-object v3, p0, Lck4;->a:Lgt4;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lgt4;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v6, v7}, Lnjg;->l(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v8}, Lnjg;->l(Ljava/lang/String;Z)V

    new-instance v2, Ldqf;

    iget-object v3, v3, Lj1f;->o:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Ldqf;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lck4;->g(Ldqf;)V
    :try_end_1
...
.method public final release()V
    ...
    invoke-direct {v0, v1, p0}, Lvd4;-><init>(ILjava/lang/Object;)V

...
.method public constructor <init>(Lone/me/chatmedia/viewer/ChatMediaViewerScreen;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object p1, p0, Lfk2;->v0:Lone/me/chatmedia/viewer/ChatMediaViewerScreen;

    const-string p1, "chatMediaViewer"

    iput-object p1, p0, Lfk2;->w0:Ljava/lang/String;
    ...
    invoke-direct {v1, v2}, Lyc4;-><init>(I)V

    new-instance v2, Ldg8;

    const/4 v3, 0x3

    invoke-direct {v2, p2, v3, v1}, Ldg8;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {p1, v0, v2}, Lsv;-><init>(Lk18;Ldg8;)V

    iput-object p1, p0, Lfk2;->x0:Lsv;
...
.method public final E(Ljhd;I)V
    ...
    invoke-virtual {v0, v1, p2, p1, v2}, Lkwa;->c(Lf88;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :cond_2
    iget-object v0, p0, Lfk2;->x0:Lsv;
    ...
    :cond_4
    invoke-interface {p2}, Lxr8;->j()J

    move-result-wide v1

    invoke-interface {p2}, Lxr8;->w()Ljava/lang/String;

    move-result-object v3

    instance-of v0, p2, Lir8;
    ...
    iget-boolean p2, p2, Lpr8;->X:Z

    if-eqz p2, :cond_6

    new-instance v0, Lone/me/chatmedia/viewer/photo/GifViewerWidget;

    iget-object v4, p0, Lfk2;->w0:Ljava/lang/String;

    const/4 v5, 0x0

    invoke-direct/range {v0 .. v5}, Lone/me/chatmedia/viewer/photo/GifViewerWidget;-><init>(JLjava/lang/String;Ljava/lang/String;Lvh4;)V
    ...
    invoke-direct/range {v0 .. v5}, Lone/me/chatmedia/viewer/photo/PhotoViewerWidget;-><init>(JLjava/lang/String;Ljava/lang/String;Lvh4;)V

    goto :goto_2

    :cond_7
    instance-of p2, p2, Lvr8;
    ...
    invoke-direct/range {v0 .. v5}, Lone/me/chatmedia/viewer/video/VideoViewerWidget;-><init>(JLjava/lang/String;Ljava/lang/String;Lvh4;)V

    goto :goto_2

    :goto_3
    iget-object p2, p0, Lfk2;->v0:Lone/me/chatmedia/viewer/ChatMediaViewerScreen;

...
.method public final uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    :cond_0
    sget-object p1, Lzw6;->c:Landroid/content/Context;
    ...
    :cond_1
    sget-object p2, Lzw6;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_1
    iget-object p2, p2, Lrz8;->c:Ljava/lang/Object;
    ...
    invoke-static {v2, v4, v5, v0}, Laaf;->n(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v2, p1}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, p2}, Lpu5;->h(Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    ...
    :catch_0
    invoke-static {p1}, Lzw6;->a(Ljava/io/File;)V
    ...
    invoke-static {v2, p2}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p2}, Lp0j;->a(Ljava/io/File;)V
    ...
    :cond_6
    invoke-static {p1, p2}, Lp0j;->c(Ljava/io/File;Ljava/io/File;)V
    ...
    :catch_1
    invoke-static {p2}, Lzw6;->a(Ljava/io/File;)V

    invoke-static {v1}, Lzw6;->a(Ljava/io/File;)V
    ...
    sget-object p2, Lisd;->a:Lisd;

    invoke-virtual {p2}, Lisd;->f()Lye5;

    move-result-object p2

    invoke-static {p2, p1}, Lye5;->b(Lye5;Ljava/lang/Throwable;)V

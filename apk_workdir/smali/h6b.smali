...
.method public constructor <init>(Lbp7;Lbp7;Lbp7;)V
    ...
    iput-object p3, p0, Lh6b;->a:Lbp7;

    iput-object p1, p0, Lh6b;->b:Lbp7;

    iput-object p2, p0, Lh6b;->c:Lbp7;
    ...
    iput-object p1, p0, Lh6b;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lh6b;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lh6b;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Lpr1;->c()V

    const/4 v3, 0x0

    iput-object v3, v2, Lpr1;->x0:Ln4g;

    const/4 v3, 0x0

    iput-boolean v3, v2, Lpr1;->y0:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lh6b;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final createVideoViewInstance(Landroid/content/Context;)Lru/ok/android/externcalls/sdk/ui/RendererView;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILof4;)V
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lh6b;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Ly21;->b()Z

    move-result v2

    check-cast v1, Lpr1;

    iget-object v3, v1, Lpr1;->z0:Lzig;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Lzig;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Lpr1;->c:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lh6b;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    iget-object v0, v0, Lzig;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lh6b;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lh6b;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p2, p2, Le6b;->E0:Lmoe;
    ...
    invoke-interface {p2}, Leh1;->s()Lzig;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lh6b;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lef1;

...
.method public final onGlobalLayout()V
    ...
    iget-object v1, v0, Lfye;->q0:Li99;

    invoke-virtual {v0}, Lfye;->a()Z

    move-result v2

    if-eqz v2, :cond_2

    iget-boolean v2, v1, Lg28;->H0:Z

    if-nez v2, :cond_2

    iget-object v2, v0, Lfye;->v0:Landroid/view/View;
    ...
    :cond_0
    invoke-virtual {v1}, Lg28;->f()V

    goto :goto_1

    :cond_1
    :goto_0
    invoke-virtual {v0}, Lfye;->dismiss()V
    ...
    iget-object v1, v0, Landroidx/mediarouter/app/d;->P0:Ljava/util/HashSet;
    ...
    invoke-direct {v1, v3, v0}, Lvx8;-><init>(ILjava/lang/Object;)V

    iget-object v3, v0, Landroidx/mediarouter/app/d;->M0:Landroidx/mediarouter/app/OverlayListView;
    ...
    :goto_2
    iget-object v6, v0, Landroidx/mediarouter/app/d;->M0:Landroidx/mediarouter/app/OverlayListView;
    ...
    iget-object v8, v0, Landroidx/mediarouter/app/d;->N0:Landroidx/mediarouter/app/c;
    ...
    iget-object v8, v0, Landroidx/mediarouter/app/d;->P0:Ljava/util/HashSet;
    ...
    iget v8, v0, Landroidx/mediarouter/app/d;->q1:I
    ...
    iget-object v1, v0, Lz42;->q0:Ljava/util/ArrayList;
    ...
    :cond_8
    :goto_4
    invoke-virtual {v0}, Lz42;->dismiss()V
    ...
    iget-object v2, v0, Lhp;->N0:Landroid/graphics/Rect;
    ...
    invoke-interface {v1, v2, v3}, Ljp;->m(II)V

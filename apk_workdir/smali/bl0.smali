...
.method public constructor <init>(Lkse;)V
    ...
    invoke-direct {p0, p1}, Lbk5;-><init>(Landroid/view/View;)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lbl0;->r:Landroid/graphics/Rect;

    iput-object p1, p0, Lbl0;->q:Lkse;
...
.method public final n(FF)I
    ...
    :goto_0
    iget-object v1, p0, Lbl0;->q:Lkse;

    invoke-virtual {v1}, Ldl0;->getValues()Ljava/util/List;
    ...
    iget-object v2, p0, Lbl0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, v0, v2}, Ldl0;->u(ILandroid/graphics/Rect;)V
...
.method public final s(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p1, p2}, Ldl0;->s(IF)Z
    ...
    invoke-virtual {p0, p1}, Lbk5;->p(I)V

    return v2

    :cond_3
    iget p3, v0, Ldl0;->h1:F
    ...
    :cond_7
    invoke-virtual {v0}, Ldl0;->getValues()Ljava/util/List;
    ...
    invoke-static {p2, p3, v1}, Lohi;->a(FFF)F
...
.method public final u(ILg5;)V
    ...
    invoke-virtual {v1}, Lkse;->getValueFrom()F

    move-result v5

    invoke-virtual {v1}, Lkse;->getValueTo()F
    ...
    sget v5, Lxrc;->material_slider_value:I
    ...
    sget v4, Lxrc;->material_slider_range_end:I
    ...
    sget v4, Lxrc;->material_slider_range_start:I
    ...
    iget-object p2, p0, Lbl0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, p1, p2}, Ldl0;->u(ILandroid/graphics/Rect;)V

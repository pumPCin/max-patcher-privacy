...
.method public constructor <init>(I)V
    ...
    :try_start_0
    invoke-static {p1}, Lpt;->c(I)Landroid/os/SharedMemory;

    move-result-object p1

    iput-object p1, p0, Lqt;->a:Landroid/os/SharedMemory;

    invoke-static {p1}, Lpt;->e(Landroid/os/SharedMemory;)Ljava/nio/ByteBuffer;

    move-result-object p1

    iput-object p1, p0, Lqt;->b:Ljava/nio/ByteBuffer;
    :try_end_0
...
.method public final declared-synchronized P(III[B)I
    ...
    iget-object p1, p0, Lqt;->b:Ljava/nio/ByteBuffer;
...
.method public final c(Lh79;I)V
    ...
    invoke-virtual {p0}, Lqt;->isClosed()Z
    ...
    invoke-virtual {p1}, Lqt;->isClosed()Z
    ...
    iget-object v0, p1, Lqt;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p1}, Lqt;->getSize()I
    ...
    iget-object v1, p0, Lqt;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v1, v0, v2, p2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget-object p1, p1, Lqt;->b:Ljava/nio/ByteBuffer;
...
.method public final declared-synchronized close()V
    ...
    iget-object v0, p0, Lqt;->a:Landroid/os/SharedMemory;

    if-eqz v0, :cond_0

    invoke-static {v0}, Lpt;->h(Landroid/os/SharedMemory;)V
    ...
    invoke-static {v0}, Lpt;->i(Ljava/nio/ByteBuffer;)V

    :cond_1
    const/4 v0, 0x0

    iput-object v0, p0, Lqt;->b:Ljava/nio/ByteBuffer;

    iput-object v0, p0, Lqt;->a:Landroid/os/SharedMemory;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final getSize()I
    ...
    invoke-static {v0}, Lpt;->a(Landroid/os/SharedMemory;)I

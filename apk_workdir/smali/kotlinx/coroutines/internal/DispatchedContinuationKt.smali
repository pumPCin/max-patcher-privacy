...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lkotlin/coroutines/Continuation;Ljava/lang/Object;Lxe6;)V",
        ...
        "block",
        "executeUnconfined",
        "(Lkotlinx/coroutines/internal/DispatchedContinuation;Ljava/lang/Object;IZLve6;)Z",
...
.method private static final executeUnconfined(Lkotlinx/coroutines/internal/DispatchedContinuation;Ljava/lang/Object;IZLve6;)Z
    .locals 3
    ...
    iget-object p3, v0, Lrb5;->c:Lrr;

    if-eqz p3, :cond_0

    invoke-virtual {p3}, Lrr;->isEmpty()Z
    ...
    :try_start_0
    invoke-interface {p4}, Lve6;->invoke()Ljava/lang/Object;
    ...
    :try_start_1
    invoke-virtual {p0, p1, p2}, Lhs4;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_1
...
.method public static executeUnconfined$default(Lkotlinx/coroutines/internal/DispatchedContinuation;Ljava/lang/Object;IZLve6;ILjava/lang/Object;)Z
    .locals 1
    ...
    invoke-virtual {p5, p0}, Lrb5;->n(Lhs4;)V

    return v0

    :cond_3
    invoke-virtual {p5, v0}, Lrb5;->W(Z)V

    :try_start_0
    invoke-interface {p4}, Lve6;->invoke()Ljava/lang/Object;

    :cond_4
    invoke-virtual {p5}, Lrb5;->q0()Z
    ...
    invoke-virtual {p5, v0}, Lrb5;->d(Z)V
...
.method public static final resumeCancellableWith(Lkotlin/coroutines/Continuation;Ljava/lang/Object;Lxe6;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static synthetic resumeCancellableWith$default(Lkotlin/coroutines/Continuation;Ljava/lang/Object;Lxe6;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->resumeCancellableWith(Lkotlin/coroutines/Continuation;Ljava/lang/Object;Lxe6;)V
...
.method public static final yieldUndispatched(Lkotlinx/coroutines/internal/DispatchedContinuation;)Z
    ...
    :try_start_1
    invoke-virtual {p0, v1, v3}, Lhs4;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Llth;->Y(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p2, p1}, Llth;->X(Landroid/os/Parcel;I)Z
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Llth;->W(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Lzci;->f:Ljfi;

    iget-object p1, p1, Ljfi;->a:Leyi;

    if-eqz p1, :cond_9

    iget-object p2, p3, Lzci;->e:Lrnf;

    iget-object p4, p1, Leyi;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Leyi;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Ltqi;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Leyi;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Lzci;->d:Ltt8;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Ltt8;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p4, p1, p2}, Lcvh;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Lzci;->e:Lrnf;

    invoke-virtual {p1, p4}, Lrnf;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Lnui;->f:Lovi;

    iget-object p1, p1, Lovi;->a:Lw1j;

    iget-object p2, p3, Lnui;->e:Lrnf;

    invoke-virtual {p1, p2}, Lw1j;->c(Lrnf;)V

    iget-object p1, p3, Lnui;->d:Lwv4;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lwv4;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lwv4;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lrnf;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Lnui;->g:Lovi;
    ...
    iget-object p1, p1, Lovi;->d:Lcyi;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Lcyi;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Lcyi;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lar;-><init>(I)V

    invoke-virtual {p2, p1}, Lrnf;->d(Ljava/lang/Object;)V
    ...
    :cond_1d
    invoke-virtual {p0, p1, p2, p3}, Llth;->V(ILandroid/os/Parcel;Landroid/os/Parcel;)Z

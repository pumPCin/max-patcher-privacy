...
.method public synthetic constructor <init>(Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;Landroid/content/Intent;Landroid/content/Context;ZLandroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-object p3, p0, Llbg;->o:Ljava/lang/Object;

    iput-boolean p4, p0, Llbg;->b:Z

    iput-object p5, p0, Llbg;->X:Ljava/lang/Object;

    return-void
.end method

.method public constructor <init>(Lmbg;ZLjava/io/File;Lcs5;)V
    .locals 1
    ...
    iput-object p1, p0, Llbg;->X:Ljava/lang/Object;

    iput-boolean p2, p0, Llbg;->b:Z

    iput-object p3, p0, Llbg;->c:Ljava/lang/Object;

    iput-object p4, p0, Llbg;->o:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v0, v1, Llbg;->c:Ljava/lang/Object;

    check-cast v0, Landroid/content/Intent;

    iget-object v2, v1, Llbg;->o:Ljava/lang/Object;

    check-cast v2, Landroid/content/Context;

    iget-boolean v3, v1, Llbg;->b:Z

    iget-object v4, v1, Llbg;->X:Ljava/lang/Object;
    ...
    invoke-direct {v7, v11, v12}, Lp94;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v9, v2, v5, v8}, Llq3;-><init>(Landroid/content/Context;Lt93;Ljava/util/concurrent/CountDownLatch;)V
    ...
    invoke-direct {v5, v2}, Lcz8;-><init>(Landroid/content/Context;)V

    invoke-virtual {v5, v0}, Lcz8;->B(Landroid/content/Intent;)Ld1j;
    ...
    :pswitch_0
    iget-object v0, v1, Llbg;->o:Ljava/lang/Object;
    ...
    iget-boolean v0, v1, Llbg;->b:Z

    iget-object v4, v1, Llbg;->X:Ljava/lang/Object;

    check-cast v4, Lmbg;

    iget-object v4, v4, Lwt4;->a:Ljava/io/File;
    ...
    invoke-static {v6, v7}, Ludi;->f(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v0, :cond_9

    :try_start_9
    invoke-static {v4}, Lthf;->c(Ljava/io/File;)V
    ...
    :cond_9
    :goto_8
    iget-object v7, v1, Llbg;->c:Ljava/lang/Object;

    check-cast v7, Ljava/io/File;

    const/4 v8, 0x1

    invoke-static {v7, v8, v0}, Lmbg;->i(Ljava/io/File;BZ)V
    :try_end_9
    ...
    invoke-static {v6, v0}, Ludi;->f(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2}, Lcs5;->close()V
    ...
    invoke-static {v6, v3}, Ludi;->f(Ljava/lang/String;Ljava/lang/String;)V

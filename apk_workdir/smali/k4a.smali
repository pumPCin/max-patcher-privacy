...
.method public static e(Ljava/util/ArrayList;I)Lh3a;
    .locals 19
    ...
    invoke-static {v0}, Li3a;->g(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
    ...
    invoke-static {v7}, Li3a;->h(Landroid/app/RemoteInput;)Ljava/lang/String;

    move-result-object v9

    invoke-static {v7}, Li3a;->f(Landroid/app/RemoteInput;)Ljava/lang/CharSequence;

    move-result-object v10

    invoke-static {v7}, Li3a;->b(Landroid/app/RemoteInput;)[Ljava/lang/CharSequence;

    move-result-object v11

    invoke-static {v7}, Li3a;->a(Landroid/app/RemoteInput;)Z
    ...
    invoke-static {v7}, Ln3a;->c(Landroid/app/RemoteInput;)I
    ...
    :goto_1
    invoke-static {v7}, Li3a;->d(Landroid/app/RemoteInput;)Landroid/os/Bundle;

    move-result-object v14

    const/4 v15, 0x0

    invoke-direct/range {v8 .. v15}, Luxc;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V
    ...
    invoke-static {v0}, Li3a;->c(Landroid/app/Notification$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v0}, Ll3a;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lm3a;->a(Landroid/app/Notification$Action;)I
    ...
    invoke-static {v0}, Ln3a;->e(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lo3a;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lk3a;->a(Landroid/app/Notification$Action;)Landroid/graphics/drawable/Icon;
    ...
    invoke-direct/range {v7 .. v18}, Lh3a;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Luxc;[Luxc;ZIZZZ)V
    ...
    invoke-static {v1}, Lh17;->d(Ljava/lang/Object;)I
    ...
    invoke-static {v1}, Lh17;->b(Ljava/lang/Object;)I
    ...
    :cond_b
    invoke-static {v1}, Lh17;->a(Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;

...
.method public final onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lodh;->c0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p2, p1}, Lodh;->b0(Landroid/os/Parcel;I)Z
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Lodh;->a0(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Ltih;->f:Lxih;

    iget-object p1, p1, Lxih;->a:Lvkh;

    if-eqz p1, :cond_9

    iget-object p2, p3, Ltih;->e:Lfaf;

    iget-object p4, p1, Lvkh;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Lvkh;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Lvjh;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Lvkh;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Ltih;->d:Ljuf;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Ljuf;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p4, Lafh;

    invoke-direct {p4, p1, p2}, Lafh;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Ltih;->e:Lfaf;

    invoke-virtual {p1, p4}, Lfaf;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Ljkh;->f:Lokh;

    iget-object p1, p1, Lokh;->a:Lklh;

    iget-object p2, p3, Ljkh;->e:Lfaf;

    invoke-virtual {p1, p2}, Lklh;->c(Lfaf;)V

    iget-object p1, p3, Ljkh;->d:Lxs4;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lxs4;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, v6}, Lbk7;->e(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, p4, v2}, Lxs4;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lfaf;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Ljkh;->g:Lokh;
    ...
    iget-object p1, p1, Lokh;->d:Ltkh;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Ltkh;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Ltkh;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lpq;-><init>(I)V

    invoke-virtual {p2, p1}, Lfaf;->d(Ljava/lang/Object;)V
    ...
    :cond_1d
    invoke-virtual {p0, p1, p2, p3}, Lodh;->Z(ILandroid/os/Parcel;Landroid/os/Parcel;)Z

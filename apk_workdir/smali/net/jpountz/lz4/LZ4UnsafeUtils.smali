...
.method public static commonBytes([BIII)I
    ...
    invoke-static {p2, p0}, Lwxf;->d(I[B)J

    move-result-wide v1

    invoke-static {p1, p0}, Lwxf;->d(I[B)J
    ...
    :cond_0
    sget-object p3, Lh3g;->a:Ljava/nio/ByteOrder;
    ...
    invoke-static {p1, p0}, Lwxf;->a(I[B)B

    move-result p1

    add-int/lit8 v2, p2, 0x1

    invoke-static {p2, p0}, Lwxf;->a(I[B)B
...
.method public static readIntEquals([BII)Z
    ...
    invoke-static {p1, p0}, Lwxf;->b(I[B)I

    move-result p1

    invoke-static {p2, p0}, Lwxf;->b(I[B)I
...
.method public static readShortLittleEndian([BI)I
    ...
    invoke-static {p1, p0}, Lwxf;->f(I[B)S

    move-result p0

    sget-object p1, Lh3g;->a:Ljava/nio/ByteOrder;
...
.method public static safeArraycopy([BI[BII)V
    ...
    invoke-static {v3, p0}, Lwxf;->a(I[B)B

    move-result v3

    invoke-static {p2, v2, v3}, Lwxf;->g([BIB)V
...
.method public static safeIncrementalCopy([BIII)V
    ...
    invoke-static {v2, p0}, Lwxf;->a(I[B)B

    move-result v2

    invoke-static {p0, v1, v2}, Lwxf;->g([BIB)V
...
.method public static wildArraycopy([BI[BII)V
    ...
    invoke-static {v2, p0}, Lwxf;->d(I[B)J

    move-result-wide v2

    invoke-static {v1, p2, v2, v3}, Lwxf;->j(I[BJ)V
...
.method public static wildIncrementalCopy([BIII)V
    ...
    invoke-static {v5, p0}, Lwxf;->a(I[B)B

    move-result v5

    invoke-static {p0, v4, v5}, Lwxf;->g([BIB)V
    ...
    :goto_1
    invoke-static {v3, p0}, Lwxf;->b(I[B)I

    move-result p1

    invoke-static {v2, p0, p1}, Lwxf;->i(I[BI)V
    ...
    invoke-static {p2, p0, v2, v3}, Lwxf;->j(I[BJ)V
...
.method public static writeLen(I[BI)I
    ...
    invoke-static {p1, p2, v0}, Lwxf;->g([BIB)V
    ...
    invoke-static {p1, p2, p0}, Lwxf;->g([BIB)V
...
.method public static writeShortLittleEndian([BII)V
    ...
    sget-object v0, Lh3g;->a:Ljava/nio/ByteOrder;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lwxf;->k([BIS)V

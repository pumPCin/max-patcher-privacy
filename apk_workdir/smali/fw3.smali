...
.method public constructor <init>(Landroid/content/Context;Ljv3;)V
    ...
    invoke-direct {v1, p1}, Lqpa;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v1}, Luvc;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lfw3;->E0:Ljv3;

    iput-object v0, p0, Lfw3;->F0:Loh0;
    ...
    invoke-virtual {v1, p1}, Lqpa;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Lpj1;

    const/4 p2, 0x1

    invoke-direct {p1, p2, p0}, Lpj1;-><init>(ILjava/lang/Object;)V

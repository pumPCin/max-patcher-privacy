...
# direct methods
.method public constructor <init>(Lh3b;Lru/ok/android/externcalls/sdk/api/delegate/StartConversationDelegate$Params;Lkotlin/coroutines/Continuation;)V
    .locals 0

    iput-object p1, p0, Lg3b;->Y:Lh3b;

    iput-object p2, p0, Lg3b;->Z:Lru/ok/android/externcalls/sdk/api/delegate/StartConversationDelegate$Params;
...
.method public final m(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v0, p0, Lg3b;->Y:Lh3b;

    iget-object v1, p0, Lg3b;->Z:Lru/ok/android/externcalls/sdk/api/delegate/StartConversationDelegate$Params;

    invoke-direct {p1, v0, v1, p2}, Lg3b;-><init>(Lh3b;Lru/ok/android/externcalls/sdk/api/delegate/StartConversationDelegate$Params;Lkotlin/coroutines/Continuation;)V
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lg3b;->Z:Lru/ok/android/externcalls/sdk/api/delegate/StartConversationDelegate$Params;
    ...
    iget-object p1, p0, Lg3b;->Y:Lh3b;

    iget-object p1, p1, Lh3b;->a:Llt7;
    ...
    sget-object v7, Lk7b;->D1:Lk7b;

    const/4 v8, 0x0

    invoke-direct {v1, v7, v8}, Lalg;-><init>(Lk7b;I)V

    const-string v7, "conversationId"

    invoke-virtual {v1, v7, v0}, Lhlf;->x(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, v4}, Lhlf;->o(Ljava/lang/String;Ljava/util/List;)V

    :cond_3
    if-eqz v3, :cond_4

    iget-object v0, v1, Lhlf;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0, v5}, Lhlf;->i(Ljava/lang/String;Z)V

    const-string v0, "internalParams"

    invoke-virtual {v1, v0, v6}, Lhlf;->x(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p1, Lblg;->X:Ljava/util/List;
    ...
    iget-object v1, v0, Lzkg;->a:Ljava/lang/Long;
    ...
    iget-object v0, v0, Lzkg;->b:Ljava/lang/String;

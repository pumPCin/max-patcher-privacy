...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lh5f;->C0:Ljava/util/ArrayList;
    ...
    sput-object v1, Lh5f;->D0:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Lsq8;)V
    ...
    invoke-direct {v0, v2, v1}, Lw9h;-><init>(ILjava/lang/Object;)V
    ...
    iput-object v0, p0, Lh5f;->A0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lh5f;->B0:Ljava/util/ArrayList;

    iput-object p2, p0, Lh5f;->s0:Li5f;
    ...
    iput-object p2, p0, Lh5f;->t0:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lbr8;-><init>(Lh5f;)V

    iput-object v1, p0, Lh5f;->u0:Ljava/lang/Object;

    new-instance v0, Lzq8;

    invoke-direct {v0, p0}, Lzq8;-><init>(Lyq8;)V

    iput-object v0, p0, Lh5f;->v0:Lzq8;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lhic;->mr_user_route_category_name:I
    ...
    iput-object p1, p0, Lh5f;->w0:Landroid/media/MediaRouter$RouteCategory;

    invoke-virtual {p0}, Lh5f;->v()V

    return-void
.end method

.method public static n(Ljava/lang/Object;)Lg5f;
    .locals 1
...
.method public final a(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-static {p1}, Lh5f;->n(Ljava/lang/Object;)Lg5f;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object p1, p1, Lg5f;->a:Lvq8;

    invoke-virtual {p1, p2}, Lvq8;->j(I)V
...
.method public final b(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p1, p2}, Lvq8;->k(I)V
...
.method public final d(Ljava/lang/String;)Llq8;
    ...
    invoke-virtual {p0, p1}, Lh5f;->k(Ljava/lang/String;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object v0, p0, Lh5f;->A0:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, p1}, Le5f;-><init>(Ljava/lang/Object;)V
...
.method public final f(Lup8;)V
    ...
    iget-object v1, p1, Lup8;->b:Loq8;

    invoke-virtual {v1}, Loq8;->b()Ljava/util/ArrayList;
    ...
    :goto_2
    iget v1, p0, Lh5f;->x0:I

    if-ne v1, v0, :cond_5

    iget-boolean v1, p0, Lh5f;->y0:Z
    ...
    :cond_5
    :goto_3
    iput v0, p0, Lh5f;->x0:I

    iput-boolean p1, p0, Lh5f;->y0:Z
...
.method public final i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lh5f;->j(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_5

    invoke-virtual {p0}, Lh5f;->m()Landroid/media/MediaRouter$RouteInfo;

    move-result-object v0

    const-string v1, ""

    iget-object v2, p0, Lmq8;->a:Landroid/content/Context;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lh5f;->k(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v4}, Lh5f;->k(Ljava/lang/String;)I
    ...
    invoke-direct {v3, p1, v0}, Lf5f;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {v4, v0, v1}, Lx08;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v3, v4}, Lh5f;->o(Lf5f;Lx08;)V

    invoke-virtual {v4}, Lx08;->n()Lsp8;

    move-result-object p1

    iput-object p1, v3, Lf5f;->c:Lsp8;

    iget-object p1, p0, Lh5f;->A0:Ljava/util/ArrayList;
...
.method public final j(Ljava/lang/Object;)I
    ...
    iget-object v3, v3, Lf5f;->a:Ljava/lang/Object;
...
.method public final k(Ljava/lang/String;)I
    ...
    iget-object v3, v3, Lf5f;->b:Ljava/lang/String;
...
.method public final l(Lvq8;)I
    .locals 4

    iget-object v0, p0, Lh5f;->B0:Ljava/util/ArrayList;
...
.method public o(Lf5f;Lx08;)V
    .locals 3

    iget-object v0, p2, Lx08;->a:Ljava/lang/Object;
    ...
    sget-object v2, Lh5f;->C0:Ljava/util/ArrayList;

    invoke-virtual {p2, v2}, Lx08;->k(Ljava/util/List;)V
    ...
    sget-object v1, Lh5f;->D0:Ljava/util/ArrayList;

    invoke-virtual {p2, v1}, Lx08;->k(Ljava/util/List;)V
...
.method public final p(Lvq8;)V
    ...
    iget-object v1, p0, Lh5f;->t0:Ljava/lang/Object;

    if-eq v0, p0, :cond_0

    check-cast v1, Landroid/media/MediaRouter;

    iget-object v0, p0, Lh5f;->w0:Landroid/media/MediaRouter$RouteCategory;
    ...
    invoke-direct {v2, p1, v0}, Lg5f;-><init>(Lvq8;Landroid/media/MediaRouter$UserRouteInfo;)V

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter$RouteInfo;->setTag(Ljava/lang/Object;)V

    iget-object p1, p0, Lh5f;->v0:Lzq8;
    ...
    invoke-virtual {p0, v2}, Lh5f;->w(Lg5f;)V

    iget-object p1, p0, Lh5f;->B0:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lh5f;->j(Ljava/lang/Object;)I

    move-result v0

    if-ltz v0, :cond_1

    iget-object v1, p0, Lh5f;->A0:Ljava/util/ArrayList;
...
.method public final q(Lvq8;)V
    ...
    invoke-virtual {p0, p1}, Lh5f;->l(Lvq8;)I
    ...
    iget-object p1, p1, Lg5f;->b:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lh5f;->t0:Ljava/lang/Object;
...
.method public final r(Lvq8;)V
    ...
    invoke-virtual {p0, p1}, Lh5f;->t(Ljava/lang/Object;)V
...
.method public final s()V
    ...
    invoke-direct {v0, v2, v3}, Lnq8;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final v()V
    ...
    invoke-virtual {p0, v1}, Lh5f;->i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lh5f;->s()V

    :cond_2
    return-void
.end method

.method public w(Lg5f;)V
    .locals 3

    iget-object v0, p1, Lg5f;->b:Ljava/lang/Object;

    iget-object v1, p1, Lg5f;->a:Lvq8;

    iget-object v2, v1, Lvq8;->d:Ljava/lang/String;

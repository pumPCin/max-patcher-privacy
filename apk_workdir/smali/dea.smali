...
.method public final a(Lgi5;)Z
    ...
    invoke-virtual {v0, p1, v1}, Lhea;->a(Lgi5;Z)Z
    ...
    invoke-direct {v2, v0}, Lg5g;-><init>(I)V

    iget-object v4, v2, Lg5g;->a:[B

    invoke-interface {p1, v3, v4, v0}, Lgi5;->d(I[BI)V
    ...
    :try_start_0
    invoke-static {v1, v2, v1}, Lud6;->J(ILg5g;Z)Z
    ...
    sget-object p1, Lt1b;->o:[B

    invoke-static {v2, p1}, Lt1b;->g(Lg5g;[B)Z
...
.method public final d(JJ)V
    ...
    invoke-virtual {v2, v3}, Lg5g;->B(I)V
    ...
    invoke-interface {p3, p1, p2}, Liea;->b(J)V
...
.method public final h(Lgi5;)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Ldea;->a(Lgi5;)Z
...
.method public final i(Lgi5;Lc7;)I
    ...
    iget-object v2, v0, Ldea;->a:Lii5;

    invoke-static {v2}, Lyhh;->h(Ljava/lang/Object;)V

    iget-object v2, v0, Ldea;->b:Ldxe;

    const/4 v3, 0x0

    if-nez v2, :cond_1

    invoke-virtual/range {p0 .. p1}, Ldea;->a(Lgi5;)Z
    ...
    invoke-interface {v2, v3, v4}, Lii5;->A(II)Lbof;

    move-result-object v2

    iget-object v5, v0, Ldea;->a:Lii5;

    invoke-interface {v5}, Lii5;->v()V

    iget-object v5, v0, Ldea;->b:Ldxe;

    iget-object v6, v0, Ldea;->a:Lii5;
    ...
    iput-boolean v4, v0, Ldea;->c:Z

    :cond_2
    iget-object v8, v0, Ldea;->b:Ldxe;
    ...
    invoke-interface {v5, v1}, Liea;->e(Lgi5;)J
    ...
    invoke-interface {v5}, Liea;->a()Ldnd;
    ...
    invoke-interface {v11, v5}, Lii5;->L(Ldnd;)V
    ...
    invoke-virtual {v2, v1}, Lgea;->b(Lgi5;)Z
    ...
    invoke-virtual {v8, v1}, Ldxe;->c(Lg5g;)J
    ...
    invoke-interface {v2, v9, v1}, Lbof;->c(ILg5g;)V
    ...
    invoke-interface/range {v13 .. v19}, Lbof;->b(JIIILznf;)V
    ...
    invoke-virtual {v8, v12, v6, v7, v5}, Ldxe;->e(Lg5g;JLw7b;)Z
    ...
    iget-object v5, v5, Lw7b;->b:Ljava/lang/Object;
    ...
    iget-object v5, v5, Lw7b;->c:Ljava/lang/Object;
    ...
    invoke-direct {v1, v2}, Loid;-><init>(I)V
    ...
    :cond_11
    iget-object v1, v2, Lgea;->e:Ljava/lang/Object;
    ...
    invoke-direct/range {v7 .. v17}, Lhj4;-><init>(Ldxe;JJJJZ)V

...
# instance fields
.field public final c:Lp4e;


# direct methods
.method public constructor <init>(Lp4e;)V
    .locals 0

    invoke-direct {p0}, Ls4e;-><init>()V

    iput-object p1, p0, Ln4e;->c:Lp4e;
...
.method public final a(Landroid/graphics/Matrix;Li4e;ILandroid/graphics/Canvas;)V
    ...
    iget v10, v4, Lp4e;->d:F

    iget v4, v4, Lp4e;->e:F

    invoke-direct {v7, v8, v9, v10, v4}, Landroid/graphics/RectF;-><init>(FFFF)V

    iget-object v8, v0, Li4e;->b:Landroid/graphics/Paint;
    ...
    :goto_0
    iget-object v12, v0, Li4e;->g:Landroid/graphics/Path;

    const/4 v13, 0x3

    const/4 v14, 0x2

    sget-object v19, Li4e;->k:[I

    if-eqz v9, :cond_1

    aput v11, v19, v11

    iget v11, v0, Li4e;->f:I

    aput v11, v19, v10

    iget v11, v0, Li4e;->e:I

    aput v11, v19, v14

    iget v11, v0, Li4e;->d:I
    ...
    iget-object v0, v0, Li4e;->h:Landroid/graphics/Paint;

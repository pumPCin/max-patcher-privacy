...
.method public constructor <init>(Landroid/content/Context;Lzv3;)V
    ...
    invoke-direct {v1, p1}, Lyqa;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v1}, Lnxc;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lvw3;->J0:Lzv3;

    iput-object v0, p0, Lvw3;->K0:Lwh0;
    ...
    invoke-virtual {v1, p1}, Lyqa;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Loj1;

    const/4 p2, 0x1

    invoke-direct {p1, p2, p0}, Loj1;-><init>(ILjava/lang/Object;)V

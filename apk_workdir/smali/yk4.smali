...
.field public final q0:Lzgd;

.field public final r0:Lzgd;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILzgd;)V
    .locals 1
    ...
    iput-object p4, p0, Lyk4;->q0:Lzgd;

    new-instance p1, Lzgd;

    const/16 p2, 0x11

    invoke-direct {p1, p2}, Lzgd;-><init>(I)V

    iput-object p1, p0, Lyk4;->r0:Lzgd;
...
.method public final H(Lmc4;)J
    ...
    iput-object v0, v1, Lyk4;->s0:Lmc4;

    const-wide/16 v12, 0x0

    iput-wide v12, v1, Lyk4;->y0:J

    iput-wide v12, v1, Lyk4;->x0:J

    invoke-virtual/range {p0 .. p1}, Loj0;->e(Lmc4;)V
    ...
    iget-object v3, v0, Lmc4;->a:Landroid/net/Uri;
    ...
    iget-object v4, v0, Lmc4;->d:[B

    iget-wide v5, v0, Lmc4;->f:J

    iget-wide v7, v0, Lmc4;->g:J
    ...
    :goto_0
    iget-object v11, v0, Lmc4;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Lyk4;->h(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Lmc4;->f:J

    iget-wide v5, v0, Lmc4;->g:J

    iput-object v2, v1, Lyk4;->t0:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, Lyk4;->w0:I
    ...
    sget-object v8, Lb67;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v9}, Luyh;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v9, Lb67;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v5}, Luyh;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v10, v5}, Luyh;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v1, Lyk4;->u0:Ljava/io/InputStream;

    if-eqz v7, :cond_a

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Lyk4;->u0:Ljava/io/InputStream;
    ...
    :goto_6
    iput-boolean v9, v1, Lyk4;->v0:Z

    invoke-virtual/range {p0 .. p1}, Loj0;->f(Lmc4;)V

    :try_start_5
    invoke-virtual {v1, v3, v4}, Lyk4;->i(J)V
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_4

    iget-wide v2, v1, Lyk4;->x0:J
    ...
    :cond_c
    sget-object v8, Lb67;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lyk4;->u0:Ljava/io/InputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Lyk4;->u0:Ljava/io/InputStream;

    invoke-virtual {p0}, Lyk4;->g()V

    iget-boolean v2, p0, Lyk4;->v0:Z

    if-eqz v2, :cond_1

    iput-boolean v0, p0, Lyk4;->v0:Z

    invoke-virtual {p0}, Loj0;->c()V

    :cond_1
    iput-object v1, p0, Lyk4;->t0:Ljava/net/HttpURLConnection;

    iput-object v1, p0, Lyk4;->s0:Lmc4;
...
.method public final g()V
    ...
    iget-object v0, p0, Lyk4;->t0:Ljava/net/HttpURLConnection;
...
.method public final getUri()Landroid/net/Uri;
    ...
    :cond_0
    iget-object v0, p0, Lyk4;->s0:Lmc4;
...
.method public final h(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lyk4;->q0:Lzgd;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lzgd;->r()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Lyk4;->r0:Lzgd;
    ...
    :cond_1
    sget-object p10, Lb67;->a:Ljava/util/regex/Pattern;
    ...
    :cond_4
    iget-object p4, p0, Lyk4;->Z:Ljava/lang/String;
    ...
    invoke-static {p2}, Lmc4;->b(I)Ljava/lang/String;
...
.method public final i(J)V
    ...
    iget-object v5, p0, Lyk4;->u0:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Loj0;->b(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lyk4;->u0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lyk4;->y0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lyk4;->y0:J

...
.method public static final a(Lone/me/android/root/RootController;Landroid/content/Intent;)V
    ...
    sget-object p0, Lxfd;->T:Lwfd;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object p0, Lwfd;->b:Ljava/util/Set;

    invoke-virtual {p1}, Landroid/content/Intent;->getAction()Ljava/lang/String;

    move-result-object p1

    invoke-static {p0, p1}, Lab3;->v(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    sget-object p1, Lgd8;->e:Ljf4;

    iget-object p1, p1, Ljf4;->a:Landroid/net/Uri;

    invoke-static {p1}, Lsf4;->a(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object p1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Llf4;->b(Ljava/lang/String;Landroid/os/Bundle;)Z

    :cond_2
    return-void
.end method

.method public static b(Lqb4;)V
    .locals 0

    if-eqz p0, :cond_0

    :try_start_0
    invoke-interface {p0}, Lqb4;->close()V
    :try_end_0
...
.method public static final c(Lh6;)Lone/me/android/root/RootController;
    .locals 3

    check-cast p0, Lxfd;

    invoke-interface {p0}, Lxfd;->b()Ljhd;
    ...
    invoke-virtual {v0, v1}, Ljhd;->g(Ljava/lang/String;)Lx14;
    ...
    invoke-virtual {p0, v2}, Ljhd;->R(Lmhd;)V

    return-object v0
.end method

.method public static final d(Lh6;Landroid/content/Intent;)V
    .locals 16
    ...
    invoke-virtual {v2}, Lroa;->a()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v2}, Lroa;->b()V
    ...
    sget-object v6, Lxfd;->T:Lwfd;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lwfd;->b:Ljava/util/Set;

    invoke-static {v6, v2}, Lab3;->v(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    invoke-static {v2}, Lz9f;->g(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v0, v2}, Llf4;->b(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-static {v0, v7, v6}, Lvzh;->d(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    sget-object v4, Lgw1;->a:Ljava/lang/Object;
    ...
    invoke-static {v9, v8, v3}, Ls9f;->q(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    :cond_8
    invoke-static {v2}, Ln8a;->j(Ljava/lang/String;)Lhc1;

    move-result-object v2

    instance-of v8, v2, Ldc1;

    if-nez v8, :cond_12

    instance-of v8, v2, Lyb1;
    ...
    :cond_9
    instance-of v8, v2, Lec1;

    const-string v9, ""

    if-eqz v8, :cond_c

    invoke-static {v1}, Lgw1;->b(Ljhd;)Z
    ...
    sget-object v10, Ldd8;->c:Ldd8;

    invoke-virtual/range {v10 .. v15}, Ldd8;->V0(JLjava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v2, v9, v3}, Lkf4;->c(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v2}, Lkf4;->a()Landroid/net/Uri;

    move-result-object v2

    invoke-virtual {v1, v2, v5}, Llf4;->c(Landroid/net/Uri;Landroid/os/Bundle;)Z

    goto :goto_1

    :cond_e
    instance-of v1, v2, Lfc1;
    ...
    invoke-static {v8}, Ljt;->C([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lqci;->q0()Llf4;
    ...
    invoke-virtual {v3, v1, v5}, Llf4;->c(Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {v3, v2, v4}, Ldd8;->U0(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v1, v6}, Lu9d;->j(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v3, v4, v2, v1, v5}, Lkwa;->c(Lf88;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v1, v2}, Lvzh;->d(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {v2, v6, v1}, Lndi;->x(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1}, Lsfa;->e()Ltfa;

    move-result-object v1

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v2, Ltfa;->d:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v6}, Lndi;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v3, v0, Lrec;->b:Ljava/lang/String;
    ...
    :cond_1d
    :try_start_1
    invoke-virtual {v1}, Ltfa;->b()Lhd;

    move-result-object v6

    const-string v7, "trid"

    iget-wide v8, v0, Lrec;->a:J
    ...
    invoke-direct {v8, v7, v0}, Lqbb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    const-string v0, "eKey"

    new-instance v7, Lqbb;

    invoke-direct {v7, v0, v3}, Lqbb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    filled-new-array {v8, v7, v3}, [Lqbb;
...
.method public static final e(Lh6;Lz2b;)V
    .locals 13

    iget-object v0, p1, Lz2b;->X:Li2b;
    ...
    invoke-static {p0, v3}, Lndi;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v1}, La2b;-><init>(Lone/me/sdk/arch/Widget;)V

    new-instance v10, Li2b;
    ...
    invoke-direct {v10, v4, v4, p0, v0}, Li2b;-><init>(IIII)V
    ...
    invoke-static/range {v5 .. v12}, Lz2b;->a(Lz2b;Ls2b;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ly2b;Li2b;Lm2b;I)Lz2b;

    move-result-object p0

    iput-object p0, v2, La2b;->b:Lz2b;
...
.method public static final f(Lh6;Landroid/content/Intent;)V
    ...
    invoke-static {p1, v0, v1}, Lvzh;->d(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;

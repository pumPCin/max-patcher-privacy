...
.method public constructor <init>(Lykh;)V
    ...
    iput-object v0, p0, Lmf4;->a:Landroid/content/Context;

    iget-object v0, p1, Lykh;->c:Ljava/lang/Object;

    check-cast v0, Lnd4;

    iput-object v0, p0, Lmf4;->b:Lnd4;
    ...
    iput-object p1, p0, Lmf4;->o:Lai8;

    return-void
.end method

.method public static d(Lw66;Ljava/lang/String;)Landroidx/media3/transformer/ExportException;
    .locals 4
...
# virtual methods
.method public final a(Lw66;Landroid/view/Surface;Z)Lze4;
    .locals 7
    ...
    invoke-static {p1, p2}, Lmf4;->d(Lw66;Ljava/lang/String;)Landroidx/media3/transformer/ExportException;
    ...
    invoke-direct {v3, p1}, Lw66;-><init>(Lt66;)V
    ...
    iget-object v5, p0, Lmf4;->a:Landroid/content/Context;
    ...
    invoke-static {v3, v2, v1}, Lhq;->y(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    invoke-static {v3, v1, p3}, Lhq;->y(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    invoke-static {p3, v0}, Ltvf;->w(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_e
    invoke-virtual {p0, v3, p1, p2, v4}, Lmf4;->c(Landroid/media/MediaFormat;Lw66;Landroid/view/Surface;Z)Lze4;
...
.method public final b(Lw66;)Lze4;
    .locals 3
    ...
    invoke-virtual {p0, v0, p1, v1, v2}, Lmf4;->c(Landroid/media/MediaFormat;Lw66;Landroid/view/Surface;Z)Lze4;
...
.method public final c(Landroid/media/MediaFormat;Lw66;Landroid/view/Surface;Z)Lze4;
    .locals 10
    ...
    :try_start_0
    iget-object v0, p0, Lmf4;->o:Lai8;

    const/4 v1, 0x0

    invoke-static {v0, p2, v1, v1}, Lli8;->f(Lbi8;Lw66;ZZ)Lexc;
    ...
    invoke-direct {v0, v1, p2}, Lci8;-><init>(ILw66;)V
    ...
    iget-object p4, p4, Lvh8;->c:Ljava/lang/String;
    ...
    iget-object v4, p0, Lmf4;->a:Landroid/content/Context;
    ...
    iget-object v3, v0, Lvh8;->c:Ljava/lang/String;
    ...
    iget-object v7, v0, Lvh8;->a:Ljava/lang/String;
    :try_end_1
    ...
    :try_start_2
    invoke-direct/range {v3 .. v9}, Lze4;-><init>(Landroid/content/Context;Lw66;Landroid/media/MediaFormat;Ljava/lang/String;ZLandroid/view/Surface;)V
    :try_end_2
    .catch Landroidx/media3/transformer/ExportException; {:try_start_2 .. :try_end_2} :catch_0

    invoke-virtual {v3}, Lze4;->c()Ljava/lang/String;

    iget-object p1, p0, Lmf4;->b:Lnd4;
    ...
    invoke-static {v5, p1}, Lmf4;->d(Lw66;Ljava/lang/String;)Landroidx/media3/transformer/ExportException;

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkif;->X:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lrnh;)V
    ...
    invoke-direct {v1, p1}, Ljif;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lkif;->a:Landroid/content/Context;

    iput-object p2, p0, Lkif;->c:Lrnh;

    iput-object v0, p0, Lkif;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lkif;->o:Ljif;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lkif;->X:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lwxh;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v2, v3, p1}, Lwxh;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lknh;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lknh;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lkif;->a:Landroid/content/Context;

    iget-object v1, p0, Lkif;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lkif;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lkif;->f(Landroid/app/job/JobInfo;)Lknh;
    ...
    invoke-static {v1, v2}, Lkif;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lkif;->c:Lrnh;

    iget-object v0, v0, Lrnh;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->u()Liif;
...
.method public final varargs e([Lgoh;)V
    ...
    invoke-direct {v2, v1}, Ltui;-><init>(Ljava/lang/Object;)V
    ...
    iget-object v7, v5, Lgoh;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lioh;->p(Ljava/lang/String;)Lgoh;
    ...
    sget-object v9, Lkif;->X:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lwxh;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lkei;->a(Lgoh;)Lknh;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->u()Liif;

    move-result-object v7

    invoke-virtual {v7, v6}, Liif;->r(Lknh;)Lhif;
    ...
    iget-object v9, v2, Ltui;->a:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Ll77;

    invoke-direct {v10, v2, v8}, Ll77;-><init>(Ltui;I)V

    invoke-virtual {v9, v10}, Lyed;->o(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lknh;->a:Ljava/lang/String;

    iget v6, v6, Lknh;->b:I

    invoke-direct {v7, v9, v6, v8}, Lhif;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lrnh;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->u()Liif;

    move-result-object v6

    invoke-virtual {v6, v7}, Liif;->u(Lhif;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lkif;->g(Lgoh;I)V
...
.method public final g(Lgoh;I)V
    .locals 18
    ...
    iget-object v3, v1, Lkif;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Lkif;->o:Ljif;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lgoh;->j:Lzq3;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lgoh;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Lzod;->k(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Ljif;->b:Ljava/lang/String;

    invoke-static {v6}, Lyy8;->j(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Lwxh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, v2, Lgoh;->l:Lxf0;

    sget-object v8, Lxf0;->b:Lxf0;
    ...
    :cond_7
    iget-boolean v10, v2, Lgoh;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Lzod;->j(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-boolean v11, v10, Lyq3;->b:Z

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v10, v10, Lyq3;->a:Landroid/net/Uri;
    ...
    invoke-static {v4}, Lot8;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Lwxh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Lwxh;->m(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lgoh;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lgoh;->r:Lf9b;

    sget-object v5, Lf9b;->a:Lf9b;
    :try_end_0
    ...
    invoke-virtual {v5, v9, v4}, Lwxh;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Lkif;->g(Lgoh;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Lwxh;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Lkif;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lkif;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Lkif;->c:Lrnh;

    iget-object v5, v4, Lrnh;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->x()Lioh;

    move-result-object v5

    invoke-virtual {v5}, Lioh;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Lwxh;->c(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lrnh;->b:Lul3;

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lz4f;->X:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lz7h;)V
    .locals 2
    ...
    invoke-direct {v1, p1}, Ly4f;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lz4f;->a:Landroid/content/Context;

    iput-object p2, p0, Lz4f;->c:Lz7h;

    iput-object v0, p0, Lz4f;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lz4f;->o:Ly4f;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lz4f;->X:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Ldt;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Lz4f;->X:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Ldt;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lr7h;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lr7h;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lz4f;->a:Landroid/content/Context;

    iget-object v1, p0, Lz4f;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lz4f;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lz4f;->f(Landroid/app/job/JobInfo;)Lr7h;
    ...
    invoke-static {v1, v2}, Lz4f;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object v0, p0, Lz4f;->c:Lz7h;
...
.method public final varargs e([Lo8h;)V
    ...
    invoke-direct {v2, v3, v1}, Lw9h;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v7, v5, Lo8h;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lq8h;->p(Ljava/lang/String;)Lo8h;
    ...
    sget-object v9, Lz4f;->X:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Ldt;->P(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lbv0;->p(Lo8h;)Lr7h;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->u()Lx4f;

    move-result-object v7

    invoke-virtual {v7, v6}, Lx4f;->w(Lr7h;)Lw4f;
    ...
    iget-object v9, v2, Lw9h;->b:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Lk27;

    invoke-direct {v10, v2, v8}, Lk27;-><init>(Lw9h;I)V

    invoke-virtual {v9, v10}, Lc4d;->o(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lr7h;->a:Ljava/lang/String;

    iget v6, v6, Lr7h;->b:I

    invoke-direct {v7, v9, v6, v8}, Lw4f;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lz7h;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->u()Lx4f;

    move-result-object v6

    invoke-virtual {v6, v7}, Lx4f;->y(Lw4f;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lz4f;->g(Lo8h;I)V
...
.method public final g(Lo8h;I)V
    ...
    iget-object v3, v1, Lz4f;->b:Landroid/app/job/JobScheduler;

    iget-object v4, v1, Lz4f;->o:Ly4f;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v5, v2, Lo8h;->j:Lio3;

    new-instance v6, Landroid/os/PersistableBundle;

    invoke-direct {v6}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v7, v2, Lo8h;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v6}, Lzdd;->k(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)V
    ...
    sget-object v14, Ly4f;->b:Ljava/lang/String;

    invoke-static {v6}, Ln29;->t(I)Ljava/lang/String;
    ...
    invoke-virtual {v11, v14, v6}, Ldt;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_7
    iget-boolean v10, v2, Lo8h;->q:Z

    if-nez v10, :cond_8

    invoke-static {v4}, Lzdd;->j(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-boolean v11, v10, Lho3;->b:Z

    new-instance v6, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v10, v10, Lho3;->a:Landroid/net/Uri;
    ...
    invoke-static {v4}, Lbn8;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    invoke-virtual {v5, v9, v8}, Ldt;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v9, v5}, Ldt;->P(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v2, Lo8h;->q:Z

    if-eqz v4, :cond_e

    iget-object v4, v2, Lo8h;->r:Lw0b;

    sget-object v5, Lw0b;->a:Lw0b;
    :try_end_0
    ...
    invoke-virtual {v5, v9, v4}, Ldt;->l(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual/range {p0 .. p2}, Lz4f;->g(Lo8h;I)V
    :try_end_1
    ...
    invoke-virtual {v3, v9, v2, v0}, Ldt;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object v2, v1, Lz4f;->a:Landroid/content/Context;

    invoke-static {v2, v3}, Lz4f;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Lz4f;->c:Lz7h;

    iget-object v5, v4, Lz7h;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->x()Lq8h;

    move-result-object v5

    invoke-virtual {v5}, Lq8h;->m()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v9, v2}, Ldt;->n(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/lang/IllegalStateException;

    invoke-direct {v3, v2, v0}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v4, Lz7h;->b:Llj3;

...
.method public constructor <init>(Landroid/content/Context;Lsoh;)V
    ...
    iput-object p2, p0, Lsa6;->b:Lsoh;

    iget-object p1, p2, Lsoh;->g:Lp95;

    iput-object p1, p0, Lsa6;->c:Lp95;
...
.method public final a()V
    ...
    iget-object v3, v1, Lsa6;->c:Lp95;

    sget-object v0, Lojf;->X:Ljava/lang/String;

    const-string v0, "jobscheduler"

    iget-object v4, v1, Lsa6;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v0}, Lojf;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;

    move-result-object v5

    iget-object v6, v1, Lsa6;->b:Lsoh;

    iget-object v7, v6, Lsoh;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v7}, Landroidx/work/impl/WorkDatabase;->u()Lmjf;
    ...
    invoke-static {v8, v9}, Lvgd;->c(ILjava/lang/String;)Lvgd;

    move-result-object v9

    iget-object v7, v7, Lmjf;->a:Ljava/lang/Object;

    check-cast v7, Landroidx/work/impl/WorkDatabase_Impl;

    invoke-virtual {v7}, Lfgd;->b()V

    invoke-virtual {v7, v9}, Lfgd;->n(Llff;)Landroid/database/Cursor;
    ...
    invoke-static {v7}, Lojf;->f(Landroid/app/job/JobInfo;)Lloh;

    move-result-object v11

    if-eqz v11, :cond_3

    iget-object v7, v11, Lloh;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v7}, Lojf;->a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v5, Lojf;->X:Ljava/lang/String;

    const-string v9, "Reconciling jobs"

    invoke-virtual {v0, v5, v9}, Lxyh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v5, v6, Lsoh;->c:Landroidx/work/impl/WorkDatabase;
    ...
    invoke-virtual {v9, v11, v12, v13}, Ljph;->r(JLjava/lang/String;)V
    ...
    :try_start_2
    invoke-virtual {v9}, Ljph;->l()Ljava/util/ArrayList;
    ...
    iget-object v8, v15, Lhph;->a:Ljava/lang/String;

    invoke-virtual {v9, v7, v8}, Ljph;->v(Lmoh;Ljava/lang/String;)V

    iget-object v7, v15, Lhph;->a:Ljava/lang/String;

    invoke-virtual {v9, v11, v12, v7}, Ljph;->r(JLjava/lang/String;)V
    ...
    :cond_9
    iget-object v7, v10, Laph;->a:Ljava/lang/Object;

    check-cast v7, Landroidx/work/impl/WorkDatabase_Impl;

    invoke-virtual {v7}, Lfgd;->b()V

    iget-object v8, v10, Laph;->o:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v5}, Lkxb;->x(Ljava/lang/String;)Ljava/lang/Long;

    move-result-object v0

    const-wide/16 v8, 0x0

    sget-object v10, Lsa6;->X:Ljava/lang/String;
    ...
    invoke-virtual {v0, v10, v2}, Lxyh;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v6}, Lsoh;->g()V
    ...
    invoke-direct {v2, v5, v3}, Ljxb;-><init>(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    invoke-virtual {v0, v2}, Lkxb;->A(Ljxb;)V
    ...
    invoke-virtual {v4}, Landroidx/work/impl/WorkDatabase;->t()Lkxb;

    move-result-object v4

    invoke-virtual {v4, v2}, Lkxb;->x(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-static {v4}, Lsa6;->c(Landroid/content/Context;)V
    :try_end_5
    ...
    iget-object v0, v6, Lsoh;->b:Lhm3;

    iget-object v2, v6, Lsoh;->c:Landroidx/work/impl/WorkDatabase;

    iget-object v3, v6, Lsoh;->e:Ljava/util/List;

    invoke-static {v0, v2, v3}, Llpd;->a(Lhm3;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    invoke-virtual {v4, v10, v5, v0}, Lxyh;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/RuntimeException;)V
    ...
    invoke-virtual {v0, v10, v4}, Lxyh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2, v4}, Ljxb;-><init>(Ljava/lang/String;Ljava/lang/Long;)V

    iget-object v2, v3, Lp95;->b:Ljava/lang/Object;

    check-cast v2, Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->t()Lkxb;

    move-result-object v2

    invoke-virtual {v2, v0}, Lkxb;->A(Ljxb;)V
...
.method public final b()Z
    ...
    sget-object v1, Lsa6;->X:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lsa6;->a:Landroid/content/Context;
...
.method public final run()V
    ...
    sget-object v0, Lsa6;->X:Ljava/lang/String;

    iget-object v1, p0, Lsa6;->b:Lsoh;

    :try_start_0
    invoke-virtual {p0}, Lsa6;->b()Z
    ...
    :goto_0
    :try_start_1
    iget-object v2, p0, Lsa6;->a:Landroid/content/Context;

    invoke-static {v2}, Lofi;->c(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-virtual {v2, v0, v3}, Lxyh;->a(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    :try_start_3
    invoke-virtual {p0}, Lsa6;->a()V
    :try_end_3
    ...
    invoke-virtual {v7, v0, v3, v2}, Lxyh;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v4, v0, v3, v2}, Lxyh;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    invoke-direct {v0, v3, v2}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v2, v1, Lsoh;->b:Lhm3;
    ...
    invoke-virtual {v4, v0, v3}, Lxyh;->c(Ljava/lang/String;Ljava/lang/String;)V

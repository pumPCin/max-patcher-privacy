...
# static fields
.field public static final d1:Lt62;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->d1:Lt62;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v8, p0, Landroidx/appcompat/widget/SwitchCompat;->q0:Z

    iput-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->s0:Landroid/content/res/ColorStateList;

    iput-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->t0:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v8, p0, Landroidx/appcompat/widget/SwitchCompat;->u0:Z
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->J0:Landroid/view/VelocityTracker;

    const/4 v9, 0x1

    iput-boolean v9, p0, Landroidx/appcompat/widget/SwitchCompat;->T0:Z

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {p0, v0}, Lltf;->a(Landroid/view/View;Landroid/content/Context;)V

    new-instance v10, Landroid/text/TextPaint;

    invoke-direct {v10, v9}, Landroid/text/TextPaint;-><init>(I)V

    iput-object v10, p0, Landroidx/appcompat/widget/SwitchCompat;->U0:Landroid/text/TextPaint;
    ...
    invoke-static {p1, p2, v0, v5}, Ldgd;->r(Landroid/content/Context;Landroid/util/AttributeSet;[II)Ldgd;

    move-result-object v11

    iget-object v0, v11, Ldgd;->b:Ljava/lang/Object;

    move-object v4, v0

    check-cast v4, Landroid/content/res/TypedArray;

    sget-object v2, Lvvc;->SwitchCompat:[I
    ...
    sget p1, Lvvc;->SwitchCompat_android_thumb:I

    invoke-virtual {v11, p1}, Ldgd;->k(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p1, Lvvc;->SwitchCompat_track:I

    invoke-virtual {v11, p1}, Ldgd;->k(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->r0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget p1, Lvvc;->SwitchCompat_android_textOn:I
    ...
    sget p1, Lvvc;->SwitchCompat_android_textOff:I
    ...
    sget p1, Lvvc;->SwitchCompat_showText:I

    invoke-virtual {v4, p1, v9}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v0, Landroidx/appcompat/widget/SwitchCompat;->E0:Z

    sget p1, Lvvc;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v4, p1, v8}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p1

    iput p1, v0, Landroidx/appcompat/widget/SwitchCompat;->w0:I

    sget p1, Lvvc;->SwitchCompat_switchMinWidth:I
    ...
    sget p1, Lvvc;->SwitchCompat_switchPadding:I
    ...
    sget p1, Lvvc;->SwitchCompat_splitTrack:I

    invoke-virtual {v4, p1, v8}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p1

    iput-boolean p1, v0, Landroidx/appcompat/widget/SwitchCompat;->z0:Z

    sget p1, Lvvc;->SwitchCompat_thumbTint:I

    invoke-virtual {v11, p1}, Ldgd;->i(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget p1, Lvvc;->SwitchCompat_thumbTintMode:I
    ...
    invoke-static {p1, v7}, Lf15;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    iput-boolean v9, v0, Landroidx/appcompat/widget/SwitchCompat;->q0:Z
    ...
    iget-boolean p1, v0, Landroidx/appcompat/widget/SwitchCompat;->q0:Z
    ...
    :cond_5
    sget p1, Lvvc;->SwitchCompat_trackTint:I
    ...
    iput-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->s0:Landroid/content/res/ColorStateList;

    iput-boolean v9, v0, Landroidx/appcompat/widget/SwitchCompat;->u0:Z

    :cond_6
    sget p1, Lvvc;->SwitchCompat_trackTintMode:I
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->t0:Landroid/graphics/PorterDuff$Mode;

    if-eq v2, p1, :cond_7

    iput-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->t0:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v9, v0, Landroidx/appcompat/widget/SwitchCompat;->v0:Z

    :cond_7
    iget-boolean p1, v0, Landroidx/appcompat/widget/SwitchCompat;->u0:Z
    ...
    :cond_9
    sget p1, Lvvc;->SwitchCompat_switchTextAppearance:I
    ...
    sget v2, Lvvc;->TextAppearance_android_textColor:I
    ...
    invoke-static {v1, v4}, Lc8;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v4, v0, Landroidx/appcompat/widget/SwitchCompat;->V0:Landroid/content/res/ColorStateList;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->V0:Landroid/content/res/ColorStateList;
    ...
    :cond_c
    sget v2, Lvvc;->TextAppearance_android_typeface:I

    invoke-virtual {p1, v2, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    sget v4, Lvvc;->TextAppearance_android_textStyle:I
    ...
    :goto_6
    sget p2, Lvvc;->TextAppearance_textAllCaps:I
    ...
    iput-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->Y0:Lbd;

    goto :goto_7

    :cond_15
    iput-object v7, v0, Landroidx/appcompat/widget/SwitchCompat;->Y0:Lbd;

    :goto_7
    iget-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->A0:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v3, v5}, Lrp;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v11}, Ldgd;->s()V
    ...
    iput p2, v0, Landroidx/appcompat/widget/SwitchCompat;->G0:I

    invoke-virtual {p1}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result p1

    iput p1, v0, Landroidx/appcompat/widget/SwitchCompat;->K0:I

    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lso;

    move-result-object p1

    invoke-virtual {p1, v3, v5}, Lso;->c(Landroid/util/AttributeSet;I)V
...
.method private getEmojiTextViewHelper()Lso;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a1:Lso;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->a1:Lso;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Lf15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lf15;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Lso;->b:Ltvi;

    iget-object v0, v0, Ltvi;->a:Ljava/lang/Object;

    check-cast v0, Li0j;

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->Y0:Lbd;

    invoke-virtual {v0, v1}, Li0j;->L(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Lf15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lf15;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v2, v0, v1, v4, v3}, Lv05;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Ll95;
    ...
    invoke-direct {v1, p0}, Ll95;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Ll95;

    invoke-virtual {v0, v1}, Lv75;->h(Lt75;)V
...
.method public getThumbTextPadding()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/SwitchCompat;->w0:I
...
.method public getTrackTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->s0:Landroid/content/res/ColorStateList;
...
.method public getTrackTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->t0:Landroid/graphics/PorterDuff$Mode;
...
.method public final onCreateDrawableState(I)[I
    ...
    sget-object v0, Landroidx/appcompat/widget/SwitchCompat;->e1:[I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lf15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p1, Landroidx/appcompat/widget/SwitchCompat;->r0:Landroid/graphics/drawable/Drawable;

    iget-object p4, p1, Landroidx/appcompat/widget/SwitchCompat;->c1:Landroid/graphics/Rect;
    ...
    invoke-static {p2}, Lf15;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget p4, p1, Landroidx/appcompat/widget/SwitchCompat;->M0:I
    ...
    iget p2, p1, Landroidx/appcompat/widget/SwitchCompat;->M0:I
    ...
    iget p5, p1, Landroidx/appcompat/widget/SwitchCompat;->N0:I
    ...
    iget p3, p1, Landroidx/appcompat/widget/SwitchCompat;->N0:I
    ...
    :goto_3
    iput p2, p1, Landroidx/appcompat/widget/SwitchCompat;->P0:I

    iput p3, p1, Landroidx/appcompat/widget/SwitchCompat;->Q0:I

    iput p5, p1, Landroidx/appcompat/widget/SwitchCompat;->S0:I

    iput p4, p1, Landroidx/appcompat/widget/SwitchCompat;->R0:I
...
.method public final onMeasure(II)V
    ...
    iget v4, p0, Landroidx/appcompat/widget/SwitchCompat;->x0:I
    ...
    iput v1, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I
...
.method public setChecked(Z)V
    ...
    invoke-virtual {v0, p0, v6}, Lsf8;->f(Landroid/view/View;Ljava/lang/Object;)V
    ...
    sget v1, Louc;->abc_capital_off:I
    ...
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->d1:Lt62;
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    sget v0, Louc;->abc_capital_off:I

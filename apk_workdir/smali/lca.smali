...
.method public static e(Ljava/util/ArrayList;I)Liba;
    .locals 19
    ...
    invoke-static {v0}, Ljba;->g(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
    ...
    invoke-static {v7}, Ljba;->h(Landroid/app/RemoteInput;)Ljava/lang/String;

    move-result-object v9

    invoke-static {v7}, Ljba;->f(Landroid/app/RemoteInput;)Ljava/lang/CharSequence;

    move-result-object v10

    invoke-static {v7}, Ljba;->b(Landroid/app/RemoteInput;)[Ljava/lang/CharSequence;

    move-result-object v11

    invoke-static {v7}, Ljba;->a(Landroid/app/RemoteInput;)Z
    ...
    invoke-static {v7}, Loba;->c(Landroid/app/RemoteInput;)I
    ...
    :goto_1
    invoke-static {v7}, Ljba;->d(Landroid/app/RemoteInput;)Landroid/os/Bundle;

    move-result-object v14

    const/4 v15, 0x0

    invoke-direct/range {v8 .. v15}, Li8d;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V
    ...
    invoke-static {v0}, Ljba;->c(Landroid/app/Notification$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v0}, Lmba;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lnba;->a(Landroid/app/Notification$Action;)I
    ...
    invoke-static {v0}, Loba;->e(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lpba;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Llba;->a(Landroid/app/Notification$Action;)Landroid/graphics/drawable/Icon;
    ...
    invoke-direct/range {v7 .. v18}, Liba;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Li8d;[Li8d;ZIZZZ)V
    ...
    invoke-static {v1}, Li67;->d(Ljava/lang/Object;)I
    ...
    invoke-static {v1}, Li67;->b(Ljava/lang/Object;)I

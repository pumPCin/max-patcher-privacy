...
# direct methods
.method public synthetic constructor <init>(Lby5;Lhdb;I)V
    .locals 0

    iput p3, p0, Lvcb;->a:I

    iput-object p1, p0, Lvcb;->b:Lby5;

    iput-object p2, p0, Lvcb;->c:Lhdb;
...
.method public final a(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Ladb;-><init>(Lvcb;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p2, v0, Ladb;->o:Ljava/lang/Object;
    ...
    iget-object v3, v3, Ltcb;->c:Ljava/util/Map;
    ...
    iget-wide v5, v5, Lei1;->a:J

    invoke-virtual {v2, v5, v6}, Lqz9;->d(J)Z
    ...
    invoke-direct {v5, p0, p2}, Lxcb;-><init>(Lvcb;Lkotlin/coroutines/Continuation;)V

    :goto_3
    iget-object p2, v5, Lxcb;->o:Ljava/lang/Object;
    ...
    iget-object v6, p0, Lvcb;->c:Lhdb;

    sget-object v7, Lhdb;->A0:[Lwq7;

    iget-object v7, v6, Lhdb;->a:Lwu1;

    iget-object v8, v6, Lhdb;->s0:Lrhf;
    ...
    invoke-direct {v9, v6, p1, v2, v1}, Lgdb;-><init>(Lhdb;Ljava/util/List;Lgi1;Lkotlin/coroutines/Continuation;)V

    const/4 p1, 0x2

    invoke-static {v7, v8, v1, v9, p1}, Lrji;->d(Lb54;Lt44;Le54;Lei6;I)Lwwe;

    iput v4, v5, Lxcb;->X:I

    invoke-interface {p2, v0, v5}, Lby5;->a(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Lucb;-><init>(Lvcb;Lkotlin/coroutines/Continuation;)V

    :goto_5
    iget-object p2, v0, Lucb;->o:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v5, v7, v6, v1}, Lkwa;->c(Lf88;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Lvcb;->c:Lhdb;

    iget-object v2, v2, Lhdb;->c:Lze1;

    invoke-virtual {v2, p1, v1, v4, v4}, Lze1;->a(Lru/ok/android/externcalls/sdk/Conversation;Lru/ok/android/externcalls/sdk/ConversationParticipant;ZZ)Lfi1;

    move-result-object v2

    iget-object v5, p0, Lvcb;->c:Lhdb;

    iget-object v5, v5, Lhdb;->z0:Lsze;
    ...
    invoke-static {v8}, Lqcb;->a(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lei1;
    ...
    :cond_12
    iget-object v8, v8, Ljcb;->a:Lgi1;

    invoke-interface {v8}, Lgi1;->n()Z

    move-result v8

    :goto_9
    iget-object v9, p0, Lvcb;->c:Lhdb;

    iget-object v9, v9, Lhdb;->c:Lze1;

    const/4 v10, 0x0

    invoke-virtual {v9, p1, v7, v10, v8}, Lze1;->a(Lru/ok/android/externcalls/sdk/Conversation;Lru/ok/android/externcalls/sdk/ConversationParticipant;ZZ)Lfi1;
    ...
    invoke-direct {v2, p1, v1}, Lqbb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

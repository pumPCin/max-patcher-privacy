...
.method public constructor <init>(Luxe;)V
    ...
    iput-object p1, p0, Lewe;->a:Luxe;

    new-instance p1, Lpy;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lewe;->b:Lpy;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object p1, p0, Lewe;->c:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lewe;->o:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object p1, p0, Lewe;->X:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final b()V
    ...
    iget-object v0, p0, Lewe;->a:Luxe;

    iget-object v1, p0, Lewe;->b:Lpy;
    ...
    invoke-virtual {v1, v0}, Lpy;->e(Luxe;)V
...
.method public final cancel()V
    ...
    iget-object v0, p0, Lewe;->o:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final d(Lwxe;)V
    ...
    iget-object v2, p0, Lewe;->X:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lewe;->c:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-virtual {p0}, Lewe;->cancel()V
    ...
    invoke-virtual {p0, p1}, Lewe;->onError(Ljava/lang/Throwable;)V
...
.method public final h(J)V
    ...
    invoke-virtual {p0, v0}, Lewe;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Lewe;->c:Ljava/util/concurrent/atomic/AtomicLong;

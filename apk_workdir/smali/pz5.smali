...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpz5;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    return-void
.end method

.method public constructor <init>(Lkw1;Lgr6;Llqd;Lxce;)V
    .locals 4
    ...
    iput-boolean v0, p0, Lpz5;->d:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lpz5;->e:Landroid/util/Rational;

    iput-boolean v0, p0, Lpz5;->g:Z

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iput-object v2, p0, Lpz5;->h:Ljava/lang/Integer;

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lpz5;->k:J

    iput-boolean v0, p0, Lpz5;->l:Z

    iput-boolean v0, p0, Lpz5;->m:Z

    const/4 v2, 0x1

    iput v2, p0, Lpz5;->n:I

    iput-object v1, p0, Lpz5;->o:Lnz5;

    sget-object v2, Lpz5;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Lpz5;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Lpz5;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Lpz5;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lpz5;->s:Lvs1;

    iput-boolean v0, p0, Lpz5;->t:Z

    iput-object v1, p0, Lpz5;->u:Lmz5;

    iput-object p1, p0, Lpz5;->a:Lkw1;

    iput-object p3, p0, Lpz5;->b:Llqd;

    iput-object p2, p0, Lpz5;->c:Lgr6;

    new-instance p1, Ln12;

    const/16 p2, 0x16

    invoke-direct {p1, p2, p4}, Ln12;-><init>(ILjava/lang/Object;)V

    iput-object p1, p0, Lpz5;->f:Ln12;
...
.method public final a(ZZ)V
    ...
    invoke-direct {v1}, Lq30;-><init>()V

    const/4 v2, 0x1

    iput-boolean v2, v1, Lq30;->b:Z
    ...
    invoke-virtual {v2, p1, v0}, Lbs9;->o(Le90;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, p2}, Lood;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v1, p1}, Lq30;->c(Lth3;)V

    iget-object p1, p0, Lpz5;->a:Lkw1;

    invoke-virtual {v1}, Lq30;->d()Lt22;
    ...
    invoke-virtual {p1, p2}, Lkw1;->z(Ljava/util/List;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lpz5;->a:Lkw1;

    iget-object v1, v0, Lkw1;->b:Liw1;

    iget-object v1, v1, Liw1;->b:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lpz5;->o:Lnz5;

    iget-object v2, v0, Lkw1;->b:Liw1;

    iget-object v2, v2, Liw1;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/HashSet;

    invoke-virtual {v2, v1}, Ljava/util/HashSet;->remove(Ljava/lang/Object;)Z

    iget-object v1, p0, Lpz5;->s:Lvs1;
    ...
    invoke-virtual {v1, v3}, Lvs1;->d(Ljava/lang/Throwable;)Z

    iput-object v2, p0, Lpz5;->s:Lvs1;

    :cond_0
    iget-object v1, p0, Lpz5;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v2, p0, Lpz5;->i:Ljava/util/concurrent/ScheduledFuture;

    :cond_1
    iget-object v1, p0, Lpz5;->j:Ljava/util/concurrent/ScheduledFuture;

    if-eqz v1, :cond_2

    invoke-interface {v1, v3}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v2, p0, Lpz5;->j:Ljava/util/concurrent/ScheduledFuture;

    :cond_2
    iget-object v1, p0, Lpz5;->p:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    invoke-virtual {p0, v3, v2}, Lpz5;->a(ZZ)V

    :cond_3
    sget-object v1, Lpz5;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lpz5;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lpz5;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lpz5;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-boolean v2, p0, Lpz5;->g:Z
...
.method public final c(Z)Lbw7;
    ...
    invoke-static {v0, p1, v3}, Lc85;->n(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lkw1;->e:Lcz1;

    const/4 v1, 0x5

    invoke-static {v0, v1}, Lkw1;->t(Lcz1;I)I
    ...
    invoke-direct {v0, p0, p1, v1}, Lhk4;-><init>(Ljava/lang/Object;ZI)V
...
.method public final d(Ljava/util/List;ILandroid/util/Rational;Landroid/graphics/Rect;I)Ljava/util/List;
    ...
    iget-object v5, v5, Lfj9;->d:Landroid/util/Rational;
    ...
    iget-object v12, v8, Lpz5;->f:Ln12;
    ...
    invoke-virtual {v12, v13}, Lxce;->i(Ljava/lang/Class;)Z
...
.method public final e(Lvs1;)V
    ...
    invoke-static {v3}, Lyx1;->Y(Landroid/hardware/camera2/CaptureRequest$Key;)Le90;

    move-result-object v3

    invoke-virtual {v2, v3, v1}, Lbs9;->o(Le90;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v2}, Lood;-><init>(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Lkw1;->z(Ljava/util/List;)V
...
.method public final f(Z)V
    ...
    iget-object v3, p0, Lpz5;->a:Lkw1;

    iget-object v3, v3, Lkw1;->e:Lcz1;

    invoke-static {v3, v1}, Lkw1;->t(Lcz1;I)I
    ...
    sget-object v3, Lsh3;->b:Lsh3;

    invoke-static {p1}, Lyx1;->Y(Landroid/hardware/camera2/CaptureRequest$Key;)Le90;

    move-result-object p1

    invoke-virtual {v2, p1, v3, v1}, Lbs9;->m(Le90;Lsh3;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v1}, Lood;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v1}, Lz22;-><init>(I)V

...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-direct {v0, p2}, Le5;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    sget-object v1, Lijg;->a:Ljava/util/WeakHashMap;

    sget v1, Lgdc;->tag_screen_reader_focusable:I
    ...
    invoke-static {p1}, Lbjg;->d(Landroid/view/View;)Z
    ...
    invoke-static {p2, v1}, Lt4;->w(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    :cond_4
    :goto_2
    sget v1, Lgdc;->tag_accessibility_heading:I

    sget v9, Landroid/os/Build$VERSION;->SDK_INT:I

    if-lt v9, v4, :cond_5

    invoke-static {p1}, Lbjg;->c(Landroid/view/View;)Z
    ...
    invoke-static {p2, v6}, Lt4;->D(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    :cond_a
    :goto_6
    invoke-static {p1}, Lijg;->e(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    if-lt v7, v4, :cond_b

    invoke-static {p2, v1}, Lt4;->v(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1}, Ldjg;->b(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    invoke-static {p2, v3}, Lz4;->c(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v1, p1, v0}, Lr4;->d(Landroid/view/View;Le5;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    sget p2, Lgdc;->tag_accessibility_actions:I
    ...
    invoke-virtual {v0, p2}, Le5;->b(Ly4;)V
...
.method public final performAccessibilityAction(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Lr4;->g(Landroid/view/View;ILandroid/os/Bundle;)Z

...
.method public constructor <init>(Lsng;)V
    ...
    iput-object v0, p0, Lung;->o:Ljava/util/HashSet;

    iput-object p1, p0, Lung;->a:Lsng;

    invoke-interface {p1}, Lsng;->H()I
    ...
    iput-object v1, p0, Lung;->b:Landroid/util/Range;

    invoke-interface {p1}, Lsng;->V()I
    ...
    iput-object p1, p0, Lung;->c:Landroid/util/Range;
...
.method public static a(Lsng;Landroid/util/Size;)Lsng;
    .locals 4
    ...
    invoke-interface {p0, v0, v1}, Lsng;->b(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Lsng;->W()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Lsng;->Z()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Lung;-><init>(Lsng;)V
    ...
    iget-object v0, v0, Lung;->o:Ljava/util/HashSet;
...
.method public final R(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lung;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lung;->a:Lsng;
    ...
    invoke-static {p1, v0}, Ldvi;->a(Ljava/lang/String;Z)V

    iget-object p1, p0, Lung;->b:Landroid/util/Range;
...
.method public final U(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lung;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Lung;->c:Landroid/util/Range;
...
.method public final W()Landroid/util/Range;
    ...
    iget-object v0, p0, Lung;->b:Landroid/util/Range;
...
.method public final X(II)Z
    ...
    invoke-interface {v0, p1, p2}, Lsng;->X(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lung;->o:Ljava/util/HashSet;
...
.method public final Z()Landroid/util/Range;
    ...
    iget-object v0, p0, Lung;->c:Landroid/util/Range;

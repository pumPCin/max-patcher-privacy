...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Lkob;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p1, p2}, Lkob;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Lkob;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object v2, p0, Lkob;->b:Landroid/graphics/Rect;
...
.method public final c(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Lkob;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p1, v1, v0}, Leof;->c(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    invoke-static {v6, v5}, Lnc6;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lkob;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p1, p2, v0, v1}, Leof;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Lkob;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Lkob;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Lkob;->c:I

    invoke-static {p2}, Leof;->b(I)Z
    ...
    iget-object p2, p0, Lkob;->b:Landroid/graphics/Rect;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lkob;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Lkob;->a:Landroid/util/Size;
    ...
    invoke-static {v0, v0, v1, v2}, Leof;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lkob;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Lkob;->b:Landroid/graphics/Rect;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lkob;->a:Landroid/util/Size;

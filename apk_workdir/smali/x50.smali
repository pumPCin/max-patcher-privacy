...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lx50;->m:J

    return-void
.end method

.method public constructor <init>(Lr80;Landroid/content/Context;)V
    .locals 9
    ...
    iput-object v0, p0, Lx50;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lx50;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lx50;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Lx50;->l:Z
    ...
    invoke-static {v0, p1, p2}, Lx50;->b(ILr80;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Lx50;->a:Landroid/media/AudioRecord;
...
.method public static b(ILr80;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
    ...
    invoke-static {v2, p2}, Lgl;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lx50;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lx50;->i:Llqd;

    iget-object v1, p0, Lx50;->h:Lwka;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Lx50;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v1, p1, v3}, Lpi;-><init>(Ljava/lang/Object;ZI)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lx50;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, Lx50;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Lx50;->j:J

    iput-boolean v4, p0, Lx50;->l:Z

    iget-object v0, p0, Lx50;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, p0, Lx50;->a:Landroid/media/AudioRecord;

    invoke-static {v0}, Lfl;->b(Landroid/media/AudioRecord;)Landroid/media/AudioRecordingConfiguration;
    ...
    :cond_4
    invoke-virtual {p0, v4}, Lx50;->c(Z)V
...
.method public final read(Ljava/nio/ByteBuffer;)Lu80;
    ...
    iget-object v5, p0, Lx50;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Lx50;->b:Lr80;

    iget v5, v5, Lr80;->b:I

    iget-wide v7, p0, Lx50;->j:J
    ...
    invoke-static {v11, v9}, Lnjg;->f(Ljava/lang/String;Z)V
    ...
    invoke-static {v5, v7, v8}, Ldt;->q(IJ)J
    ...
    sget-wide v7, Lx50;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_5

    iput-boolean v10, p0, Lx50;->l:Z
    ...
    invoke-static {p1, v1}, Lnc6;->H(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    iget-wide v3, p0, Lx50;->j:J

    int-to-long v5, v0

    iget p1, p0, Lx50;->g:I

    invoke-static {p1, v5, v6}, Ldt;->G(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Lx50;->j:J

    :cond_7
    new-instance p1, Lu80;

    invoke-direct {p1, v0, v1, v2}, Lu80;-><init>(IJ)V

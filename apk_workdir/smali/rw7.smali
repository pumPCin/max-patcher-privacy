...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Ltfi;->d(II)I

    move-result p3

    iget-object p4, p0, Lz05;->a:Lmk0;
    ...
    invoke-virtual/range {v1 .. v7}, Lrw7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;Ly05;I)V
    .locals 9

    iget v0, p3, Ly05;->c:I

    invoke-static {v0, p4}, Ltfi;->d(II)I
    ...
    invoke-virtual/range {v1 .. v8}, Lrw7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Ltfi;->d(II)I
    ...
    invoke-virtual/range {v0 .. v7}, Lrw7;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p3, v0, v1}, Lggi;->a(FFF)F

    move-result p3

    move/from16 v2, p4

    invoke-static {v2, v0, v1}, Lggi;->a(FFF)F
    ...
    invoke-static {v3, v1, p3}, Legi;->c(FFF)F
    ...
    invoke-static {v3, v1, v2}, Legi;->c(FFF)F
    ...
    invoke-static {p3, v0, v4}, Lggi;->a(FFF)F
    ...
    invoke-static {v2, v6, v1}, Lggi;->a(FFF)F
    ...
    invoke-virtual/range {v5 .. v11}, Lrw7;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

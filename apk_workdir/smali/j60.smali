...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lj60;->m:J

    return-void
.end method

.method public constructor <init>(Ld90;Landroid/content/Context;)V
    .locals 9
    ...
    iput-object v0, p0, Lj60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lj60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lj60;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Lj60;->l:Z
    ...
    invoke-static {v0, p1, p2}, Lj60;->b(ILd90;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Lj60;->a:Landroid/media/AudioRecord;
...
.method public static b(ILd90;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 4
    ...
    invoke-static {v2, p2}, Lpl;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lj60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lj60;->i:Lt1e;

    iget-object v1, p0, Lj60;->h:Ldsb;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Lj60;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v3, v1, p1}, Lyi;-><init>(ILjava/lang/Object;Z)V
...
.method public final d()V
    ...
    invoke-virtual {p0}, Lj60;->a()V

    iget-object v0, p0, Lj60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, Lj60;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Lj60;->j:J

    iput-boolean v4, p0, Lj60;->l:Z

    iget-object v0, p0, Lj60;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, p0, Lj60;->a:Landroid/media/AudioRecord;

    invoke-static {v0}, Lol;->b(Landroid/media/AudioRecord;)Landroid/media/AudioRecordingConfiguration;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-static {v0}, Lol;->c(Landroid/media/AudioRecordingConfiguration;)Z
    ...
    :cond_4
    invoke-virtual {p0, v4}, Lj60;->c(Z)V
...
.method public final read(Ljava/nio/ByteBuffer;)Lg90;
    ...
    iget-object v5, p0, Lj60;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Lj60;->b:Ld90;

    iget v5, v5, Ld90;->b:I

    iget-wide v7, p0, Lj60;->j:J
    ...
    invoke-static {v11, v9}, Lbui;->a(Ljava/lang/String;Z)V
    ...
    invoke-static {v5, v7, v8}, Lggi;->c(IJ)J
    ...
    sget-wide v7, Lj60;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_5

    iput-boolean v10, p0, Lj60;->l:Z
    ...
    invoke-static {p1, v1}, Lgth;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    iget-wide v3, p0, Lj60;->j:J

    int-to-long v5, v0

    iget p1, p0, Lj60;->g:I

    invoke-static {p1, v5, v6}, Lggi;->d(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Lj60;->j:J

    :cond_7
    new-instance p1, Lg90;

    invoke-direct {p1, v0, v1, v2}, Lg90;-><init>(IJ)V

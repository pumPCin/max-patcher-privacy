...
.method public final uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    :cond_0
    sget-object p1, Lrs6;->c:Landroid/content/Context;
    ...
    :cond_1
    sget-object p2, Lrs6;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_1
    iget-object p2, p2, Lgs8;->c:Ljava/lang/Object;
    ...
    invoke-static {v2, v4, v5, v0}, Lxwe;->m0(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v2, p1}, Lzq5;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object p1

    const-string v0, "dump-tmp-meta.json"

    invoke-static {v2, v0}, Lzq5;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, p2}, Lzq5;->S(Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    ...
    :catch_0
    invoke-static {p1}, Lrs6;->a(Ljava/io/File;)V
    ...
    invoke-static {v2, p2}, Lzq5;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p2}, Le88;->k(Ljava/io/File;)V
    ...
    :cond_6
    invoke-static {p1, p2}, Le88;->N(Ljava/io/File;Ljava/io/File;)V
    ...
    :catch_1
    invoke-static {p2}, Lrs6;->a(Ljava/io/File;)V

    invoke-static {v1}, Lrs6;->a(Ljava/io/File;)V
    ...
    sget-object p2, Lhhd;->a:Lhhd;

    invoke-virtual {p2}, Lhhd;->f()Ltb5;

    move-result-object p2

    invoke-static {p2, p1}, Ltb5;->b(Ltb5;Ljava/lang/Throwable;)V

...
# static fields
.field public static final d:Ljj3;

.field public static final e:Lpkd;

.field public static final f:I

.field public static final g:Lkj3;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lpkd;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lw8a;-><init>(Ljava/util/concurrent/ThreadFactory;)V

    sput-object v0, Llj3;->g:Lkj3;
    ...
    invoke-direct {v3, v4, v0, v1}, Lpkd;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Llj3;->e:Lpkd;

    new-instance v0, Ljj3;

    invoke-direct {v0, v2, v3}, Ljj3;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Llj3;->d:Ljj3;

    iget-object v0, v0, Ljj3;->b:[Lkj3;
...
.method public constructor <init>()V
    ...
    sget-object v1, Llj3;->d:Ljj3;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Llj3;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v2, Ljj3;

    sget v3, Llj3;->f:I

    sget-object v4, Llj3;->e:Lpkd;

    invoke-direct {v2, v3, v4}, Ljj3;-><init>(ILjava/util/concurrent/ThreadFactory;)V
...
.method public final a()Lvod;
    ...
    iget-object v1, p0, Llj3;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lij3;-><init>(Lkj3;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lvv4;
    ...
    iget-object v0, p0, Llj3;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lvv4;
    ...
    iget-object v1, v0, Lw8a;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    new-instance p4, Lli7;

    invoke-direct {p4, p1, v1}, Lli7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lli7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0

...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lej5;->b:Ljava/lang/CharSequence;

    sget-object p1, Ldag;->M:Lpqf;

    new-instance v0, Lsk;

    const/4 v1, 0x7

    invoke-direct {v0, v1, p0, p1}, Lsk;-><init>(ILandroid/view/View;Ljava/lang/Object;)V

    iput-object v0, p0, Lej5;->c:Lsk;
    ...
    invoke-virtual {p0}, Lej5;->getTypography()Lpqf;
    ...
    iput-object p1, p0, Lej5;->o:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lej5;->s0:I

    invoke-virtual {v0, p0}, Lc82;->g(Landroid/view/View;)Lu4b;

    move-result-object p1

    invoke-virtual {p0, p1}, Lej5;->onThemeChanged(Lu4b;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Leh2;->n(Ljava/lang/CharSequence;)Lgue;
    ...
    iget-object v1, p0, Lej5;->a:Lit7;

    iget-object v3, p0, Lej5;->o:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lej5;->r0:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lej5;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lej5;->v0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lej5;->s0:I

    if-gt v1, v2, :cond_1

    iget-object p1, p0, Lej5;->v0:Landroid/text/Layout;
    ...
    iget-object v3, p0, Lej5;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lej5;->o:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Ls9f;->X(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v4, p0}, Lsg7;-><init>(ILjava/lang/Object;)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Lefi;->l(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lej5;->u0:Landroid/text/Layout;

    iget-boolean v0, p0, Lej5;->y0:Z
    ...
    :cond_8
    iput-object p1, p0, Lej5;->t0:Landroid/text/Layout;
...
.method public final c()V
    ...
    invoke-virtual {p0, v0}, Lej5;->b(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lej5;->w0:Z
    ...
    :cond_0
    iget-object v0, p0, Lej5;->A0:Lsq0;
    ...
    iput-object v0, p0, Lej5;->A0:Lsq0;

    invoke-virtual {p0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Lej5;->A0:Lsq0;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object v0, p0, Lej5;->t0:Landroid/text/Layout;

    return-object v0
.end method

.method public final getTypography()Lpqf;
    .locals 2

    sget-object v0, Lej5;->B0:[Lwq7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lej5;->c:Lsk;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lej5;->z0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lej5;->t0:Landroid/text/Layout;
...
.method public final onThemeChanged(Lu4b;)V
    ...
    iget-object v0, p0, Lej5;->o:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lej5;->r0:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v1, p0, Lej5;->t0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Ld15;->c(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    .line 1
    iput-object p1, p0, Lej5;->r0:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v0, v1}, Lg93;->r(Ljava/lang/CharSequence;II)Landroid/text/Spannable;
    ...
    .line 6
    iput-boolean p1, p0, Lej5;->y0:Z

    .line 7
    iput-boolean p1, p0, Lej5;->w0:Z

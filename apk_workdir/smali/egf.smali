...
# instance fields
.field public A0:Landroid/graphics/LinearGradient;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Ldgf;-><init>(Ljava/lang/Object;Legf;I)V

    iput-object v0, p0, Legf;->a:Ldgf;
    ...
    invoke-direct {p0}, Legf;->getTheme()Luxa;
    ...
    iput-object p1, p0, Legf;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    iget-object v2, v2, Ljye;->b:Loye;

    iget v2, v2, Loye;->b:I

    invoke-virtual {v0, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object v0, p0, Legf;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Legf;->w0:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Legf;->x0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Legf;->y0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Legf;)Luxa;
    .locals 0
...
.method private final getTheme()Luxa;
    .locals 3
    ...
    invoke-virtual {p0}, Legf;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lwxa;->a(Ljava/lang/String;)Lloa;
    ...
    invoke-virtual {v0, v2}, Lloa;->a(Z)Luxa;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Legf;->getIncomingColors()[I
    ...
    iput-object v3, v0, Legf;->z0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Legf;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Legf;->A0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Legf;->B0:[Ltm7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Legf;->c:Ldgf;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v9, p0, Legf;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Legf;->x0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v1, v5, v7}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Legf;->z0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Legf;->w0:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Legf;->y0:Landroid/graphics/RectF;

    invoke-virtual {v3, p1, v7, v5, v4}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Legf;->A0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v2, v3, p1, v4, v1}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final onThemeChanged(Luxa;)V
    ...
    iget-object v0, p0, Legf;->o:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Legf;->b:Landroid/graphics/drawable/GradientDrawable;

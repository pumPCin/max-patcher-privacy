...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Lesf;-><init>(Ljava/lang/Object;Lfsf;I)V
    ...
    invoke-direct {p0}, Lfsf;->getTheme()Lu4b;
    ...
    iget-object v2, v2, Ldaf;->b:Liaf;

    iget v2, v2, Liaf;->b:I

    invoke-virtual {v0, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object v0, p0, Lfsf;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lfsf;->r0:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lfsf;->s0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lfsf;->t0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lfsf;)Lu4b;
    .locals 0
...
.method private final getTheme()Lu4b;
    .locals 3
    ...
    invoke-virtual {p0}, Lfsf;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lw4b;->a(Ljava/lang/String;)Lcva;
    ...
    invoke-virtual {v0, v2}, Lcva;->a(Z)Lu4b;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lfsf;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lfsf;->u0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lfsf;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lfsf;->v0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lfsf;->w0:[Lwq7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lfsf;->c:Lesf;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v9, p0, Lfsf;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lfsf;->s0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v1, v5, v7}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lfsf;->u0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lfsf;->r0:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lfsf;->t0:Landroid/graphics/RectF;

    invoke-virtual {v3, p1, v7, v5, v4}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lfsf;->v0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Lu4b;)V
    ...
    iget-object v0, p0, Lfsf;->o:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lfsf;->b:Landroid/graphics/drawable/GradientDrawable;

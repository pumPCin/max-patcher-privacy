...
.field public static final o:Lfpd;

.field public static final p:Lgbi;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbk5;->n:Landroid/graphics/Rect;

    new-instance v0, Lfpd;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lbk5;->o:Lfpd;

    new-instance v0, Lgbi;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lbk5;->p:Lgbi;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lbk5;->d:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lbk5;->e:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lbk5;->f:Landroid/graphics/Rect;

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, Lbk5;->g:[I
    ...
    iput-object p1, p0, Lbk5;->i:Landroid/view/View;
    ...
    iput-object v0, p0, Lbk5;->h:Landroid/view/accessibility/AccessibilityManager;
...
.method public final d(Landroid/view/View;Lg5;)V
    ...
    invoke-virtual {p0, p2}, Lbk5;->t(Lg5;)V
...
.method public final j(I)Z
    ...
    invoke-virtual {p0, p1, v1}, Lbk5;->v(IZ)V

    const/16 v0, 0x8

    invoke-virtual {p0, p1, v0}, Lbk5;->x(II)V
...
.method public final k(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    iget-object v1, p0, Lbk5;->i:Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Lbk5;->r(I)Lg5;
...
.method public final l(I)Lg5;
    ...
    sget-object v3, Lbk5;->n:Landroid/graphics/Rect;

    invoke-virtual {v0, v3}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInParent(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v3}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInScreen(Landroid/graphics/Rect;)V

    iget-object v4, p0, Lbk5;->i:Landroid/view/View;

    invoke-virtual {v0, v4}, Landroid/view/accessibility/AccessibilityNodeInfo;->setParent(Landroid/view/View;)V

    invoke-virtual {p0, p1, v1}, Lbk5;->u(ILg5;)V
    ...
    :cond_1
    :goto_0
    iget-object v5, p0, Lbk5;->e:Landroid/graphics/Rect;
    ...
    iget-object p1, p0, Lbk5;->g:[I

    invoke-virtual {v4, p1}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v5, p0, Lbk5;->d:Landroid/graphics/Rect;
    ...
    :cond_6
    iget-object v3, p0, Lbk5;->f:Landroid/graphics/Rect;
...
.method public final m(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lbk5;->h:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual {p0, v5, v3}, Lbk5;->x(II)V

    invoke-virtual {p0, p1, v2}, Lbk5;->x(II)V
    ...
    invoke-virtual {p0, v0, p1}, Lbk5;->n(FF)I
    ...
    invoke-virtual {p0, p1, v3}, Lbk5;->x(II)V

    invoke-virtual {p0, v0, v2}, Lbk5;->x(II)V
...
.method public final p(I)V
    ...
    iget-object v0, p0, Lbk5;->i:Landroid/view/View;
    ...
    invoke-virtual {p0, p1, v2}, Lbk5;->k(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method public final q(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v3}, Lbk5;->o(Ljava/util/ArrayList;)V

    new-instance v4, Lsve;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Lsve;-><init>(I)V
    ...
    invoke-virtual {v0, v7}, Lbk5;->l(I)Lg5;
    ...
    invoke-virtual {v4, v8, v7}, Lsve;->c(ILjava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v4, v3}, Lsve;->b(I)Ljava/lang/Object;
    ...
    :goto_1
    sget-object v8, Lbk5;->o:Lfpd;

    sget-object v9, Lbk5;->p:Lgbi;

    iget-object v10, v0, Lbk5;->i:Landroid/view/View;
    ...
    invoke-virtual {v0, v5}, Lbk5;->r(I)Lg5;
    ...
    iget-object v11, v4, Lsve;->b:[Ljava/lang/Object;
    ...
    invoke-static {v1, v13, v6}, Lwv0;->d(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_f
    invoke-static {v1, v13, v2}, Lwv0;->d(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_10
    invoke-static {v1, v13, v6, v2}, Lwv0;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v13, v2, v6}, Lwv0;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v13, v6}, Lwv0;->e(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v13, v6}, Lwv0;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v13, v2}, Lwv0;->e(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v13, v2}, Lwv0;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    iget-object v12, v4, Lsve;->b:[Ljava/lang/Object;
    ...
    invoke-direct {v6, v5, v8}, Lh46;-><init>(ZLfpd;)V
    ...
    iget-object v6, v4, Lsve;->b:[Ljava/lang/Object;
    ...
    :goto_12
    iget-object v1, v4, Lsve;->a:[I

    aget v7, v1, v12

    :goto_13
    invoke-virtual {v0, v7}, Lbk5;->w(I)Z
...
.method public final r(I)Lg5;
    ...
    iget-object p1, p0, Lbk5;->i:Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Lbk5;->o(Ljava/util/ArrayList;)V
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lbk5;->l(I)Lg5;
...
.method public final w(I)Z
    ...
    invoke-virtual {p0, v0}, Lbk5;->j(I)Z
    ...
    invoke-virtual {p0, p1, v0}, Lbk5;->v(IZ)V

    const/16 v1, 0x8

    invoke-virtual {p0, p1, v1}, Lbk5;->x(II)V
...
.method public final x(II)V
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lbk5;->k(II)Landroid/view/accessibility/AccessibilityEvent;

...
.field public final r0:Lxjf;

.field public final s0:Ljava/lang/Object;

.field public final t0:Ljava/lang/Object;

.field public final u0:Lkz8;

.field public final v0:Landroid/media/MediaRouter$RouteCategory;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lwjf;->B0:Ljava/util/ArrayList;
    ...
    sput-object v1, Lwjf;->C0:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Ldz8;)V
    ...
    iput-object v0, p0, Lwjf;->z0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lwjf;->A0:Ljava/util/ArrayList;

    iput-object p2, p0, Lwjf;->r0:Lxjf;
    ...
    iput-object p2, p0, Lwjf;->s0:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lmz8;-><init>(Lwjf;)V

    iput-object v1, p0, Lwjf;->t0:Ljava/lang/Object;

    new-instance v0, Lkz8;

    invoke-direct {v0, p0}, Lkz8;-><init>(Ljz8;)V

    iput-object v0, p0, Lwjf;->u0:Lkz8;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lotc;->mr_user_route_category_name:I
    ...
    iput-object p1, p0, Lwjf;->v0:Landroid/media/MediaRouter$RouteCategory;

    invoke-virtual {p0}, Lwjf;->v()V

    return-void
.end method

.method public static n(Ljava/lang/Object;)Lvjf;
    .locals 1
...
.method public final a(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-static {p1}, Lwjf;->n(Ljava/lang/Object;)Lvjf;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object p1, p1, Lvjf;->a:Lgz8;
...
.method public final b(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p1, p2}, Lgz8;->k(I)V
...
.method public final d(Ljava/lang/String;)Lwy8;
    ...
    invoke-virtual {p0, p1}, Lwjf;->k(Ljava/lang/String;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object v0, p0, Lwjf;->z0:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lujf;->a:Ljava/lang/Object;
...
.method public final f(Lfy8;)V
    ...
    iget-object v1, p1, Lfy8;->b:Lzy8;

    invoke-virtual {v1}, Lzy8;->b()Ljava/util/ArrayList;
    ...
    :goto_2
    iget v1, p0, Lwjf;->w0:I

    if-ne v1, v0, :cond_5

    iget-boolean v1, p0, Lwjf;->x0:Z
    ...
    :cond_5
    :goto_3
    iput v0, p0, Lwjf;->w0:I

    iput-boolean p1, p0, Lwjf;->x0:Z
...
.method public final i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lwjf;->j(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_5

    invoke-virtual {p0}, Lwjf;->m()Landroid/media/MediaRouter$RouteInfo;

    move-result-object v0

    const-string v1, ""

    iget-object v2, p0, Lxy8;->a:Landroid/content/Context;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lwjf;->k(Ljava/lang/String;)I
    ...
    invoke-static {v3, v0, v4}, Lfd0;->d(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0, v4}, Lwjf;->k(Ljava/lang/String;)I
    ...
    invoke-direct {v3, p1, v0}, Lujf;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {v4, v0, v1}, Lt2c;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v3, v4}, Lwjf;->o(Lujf;Lt2c;)V

    invoke-virtual {v4}, Lt2c;->l()Ldy8;

    move-result-object p1

    iput-object p1, v3, Lujf;->c:Ldy8;

    iget-object p1, p0, Lwjf;->z0:Ljava/util/ArrayList;
...
.method public final j(Ljava/lang/Object;)I
    ...
    iget-object v3, v3, Lujf;->a:Ljava/lang/Object;
...
.method public final k(Ljava/lang/String;)I
    ...
    iget-object v3, v3, Lujf;->b:Ljava/lang/String;
...
.method public final l(Lgz8;)I
    .locals 4

    iget-object v0, p0, Lwjf;->A0:Ljava/util/ArrayList;
...
.method public o(Lujf;Lt2c;)V
    .locals 3

    iget-object v0, p2, Lt2c;->a:Ljava/lang/Object;
    ...
    sget-object v2, Lwjf;->B0:Ljava/util/ArrayList;

    invoke-virtual {p2, v2}, Lt2c;->j(Ljava/util/List;)V
    ...
    sget-object v1, Lwjf;->C0:Ljava/util/ArrayList;

    invoke-virtual {p2, v1}, Lt2c;->j(Ljava/util/List;)V
...
.method public final p(Lgz8;)V
    ...
    iget-object v1, p0, Lwjf;->s0:Ljava/lang/Object;

    if-eq v0, p0, :cond_0

    check-cast v1, Landroid/media/MediaRouter;

    iget-object v0, p0, Lwjf;->v0:Landroid/media/MediaRouter$RouteCategory;
    ...
    invoke-direct {v2, p1, v0}, Lvjf;-><init>(Lgz8;Landroid/media/MediaRouter$UserRouteInfo;)V

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter$RouteInfo;->setTag(Ljava/lang/Object;)V

    iget-object p1, p0, Lwjf;->u0:Lkz8;
    ...
    invoke-virtual {p0, v2}, Lwjf;->w(Lvjf;)V

    iget-object p1, p0, Lwjf;->A0:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lwjf;->j(Ljava/lang/Object;)I

    move-result v0

    if-ltz v0, :cond_1

    iget-object v1, p0, Lwjf;->z0:Ljava/util/ArrayList;
...
.method public final q(Lgz8;)V
    ...
    invoke-virtual {p0, p1}, Lwjf;->l(Lgz8;)I
    ...
    iget-object p1, p1, Lvjf;->b:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lwjf;->s0:Ljava/lang/Object;
...
.method public final r(Lgz8;)V
    ...
    invoke-virtual {p0, p1}, Lwjf;->t(Ljava/lang/Object;)V
...
.method public final s()V
    ...
    invoke-direct {v0, v2, v3}, Lyy8;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final v()V
    ...
    invoke-virtual {p0, v1}, Lwjf;->i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lwjf;->s()V

    :cond_2
    return-void
.end method

.method public w(Lvjf;)V
    .locals 3

    iget-object v0, p1, Lvjf;->b:Ljava/lang/Object;

    iget-object v1, p1, Lvjf;->a:Lgz8;

    iget-object v2, v1, Lgz8;->d:Ljava/lang/String;

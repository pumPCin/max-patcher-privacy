...
.method public constructor <init>(Lcfe;)V
    ...
    invoke-direct {p0, p1}, Lzf5;-><init>(Landroid/view/View;)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lzj0;->r:Landroid/graphics/Rect;

    iput-object p1, p0, Lzj0;->q:Lcfe;
...
.method public final n(FF)I
    ...
    :goto_0
    iget-object v1, p0, Lzj0;->q:Lcfe;

    invoke-virtual {v1}, Lbk0;->getValues()Ljava/util/List;
    ...
    iget-object v2, p0, Lzj0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, v0, v2}, Lbk0;->u(ILandroid/graphics/Rect;)V
...
.method public final s(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lbk0;->s(IF)Z
    ...
    invoke-virtual {p0, p1}, Lzf5;->p(I)V

    return v2

    :cond_3
    iget p3, v0, Lbk0;->i1:F
    ...
    :cond_7
    invoke-virtual {v0}, Lbk0;->getValues()Ljava/util/List;
    ...
    invoke-static {p2, p3, v1}, Lxff;->i(FFF)F
...
.method public final u(ILe5;)V
    .locals 8

    iget-object v0, p2, Le5;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    sget-object v1, Ly4;->m:Ly4;

    invoke-virtual {p2, v1}, Le5;->b(Ly4;)V
    ...
    invoke-virtual {v1}, Lcfe;->getValueFrom()F

    move-result v5

    invoke-virtual {v1}, Lcfe;->getValueTo()F
    ...
    invoke-virtual {p2, v7}, Le5;->a(I)V
    ...
    invoke-virtual {p2, v5}, Le5;->h(Ljava/lang/CharSequence;)V
    ...
    sget v5, Lqgc;->material_slider_value:I
    ...
    sget v4, Lqgc;->material_slider_range_end:I
    ...
    sget v4, Lqgc;->material_slider_range_start:I
    ...
    iget-object p2, p0, Lzj0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, p1, p2}, Lbk0;->u(ILandroid/graphics/Rect;)V

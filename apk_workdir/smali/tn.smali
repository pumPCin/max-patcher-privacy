...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v6, Lbjc;->checkedTextViewStyle:I
    ...
    iput-object p1, p0, Ltn;->c:Lqp;

    invoke-virtual {p1, p2, v6}, Lqp;->f(Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Ltn;->b:Ld9;

    invoke-virtual {p1, p2, v6}, Ld9;->H(Landroid/util/AttributeSet;I)V

    new-instance p1, Lun;

    invoke-direct {p1, p0}, Lun;-><init>(Landroid/widget/TextView;)V
    ...
    invoke-static {p1, p2, v0, v6}, Lq8c;->q(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lq8c;
    ...
    sget-object v3, Louc;->CheckedTextView:[I

    iget-object v1, p1, Lq8c;->b:Ljava/lang/Object;
    ...
    :try_start_0
    sget p2, Louc;->CheckedTextView_checkMarkCompat:I
    ...
    invoke-static {v3, p2}, Lkei;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Ltn;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    sget p2, Louc;->CheckedTextView_android_checkMark:I
    ...
    invoke-static {v2, p2}, Lkei;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :goto_0
    sget p2, Louc;->CheckedTextView_checkMarkTint:I
    ...
    :cond_2
    sget p2, Louc;->CheckedTextView_checkMarkTintMode:I
    ...
    invoke-static {p2, v0}, Lm05;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {p0}, Ltn;->getEmojiTextViewHelper()Lro;

    move-result-object p1

    invoke-virtual {p1, v4, v6}, Lro;->c(Landroid/util/AttributeSet;I)V
...
.method public getSupportCheckMarkTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lun;->a:Landroid/os/Parcelable;
...
.method public getSupportCheckMarkTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lun;->b:Ljava/lang/Object;
...
.method public setCheckMarkDrawable(I)V
    ...
    invoke-virtual {p0, p1}, Ltn;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 2
    iget-object p1, p0, Ltn;->a:Lun;

    if-eqz p1, :cond_1

    .line 3
    iget-boolean v0, p1, Lun;->e:Z
...
.method public setSupportCheckMarkTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Lun;->b:Ljava/lang/Object;

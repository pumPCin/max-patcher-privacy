...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnpd;->c:Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lmpd;-><init>(I)V

    new-instance v1, Lmpd;

    const/4 v2, 0x1

    invoke-direct {v1, v2}, Lmpd;-><init>(I)V

    new-instance v2, Lmpd;

    const/4 v3, 0x2

    invoke-direct {v2, v3}, Lmpd;-><init>(I)V

    new-instance v3, Lmpd;

    const/4 v4, 0x3

    invoke-direct {v3, v4}, Lmpd;-><init>(I)V

    new-instance v4, Lmpd;

    const/4 v5, 0x4

    invoke-direct {v4, v5}, Lmpd;-><init>(I)V

    filled-new-array {v0, v1, v2, v3, v4}, [Lmpd;
    ...
    sput-object v0, Lnpd;->X:Ljava/util/List;
...
.method public static c(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    sget-object v0, Lnpd;->X:Ljava/util/List;
    ...
    sget-object v1, Lnpd;->c:Ljava/lang/String;
...
.method public final onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget-boolean v0, p0, Lnpd;->b:Z

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lnpd;->onConfigure(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1, v0, v1}, Lnpd;->c(Landroid/database/sqlite/SQLiteDatabase;II)V
...
.method public final onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-static {p1, p2, p3}, Lnpd;->c(Landroid/database/sqlite/SQLiteDatabase;II)V

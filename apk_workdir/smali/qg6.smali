...
.field public static final q0:Lz8d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqg6;->Y:Ljava/lang/String;
...
.method public constructor <init>(Landroid/media/MediaMuxer;)V
    ...
    iput-object p1, p0, Lqg6;->a:Landroid/media/MediaMuxer;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lqg6;->b:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lqg6;->c:Landroid/util/SparseArray;
...
.method public final J(ILjava/nio/ByteBuffer;Lwu0;)V
    ...
    iget-wide v3, v2, Lwu0;->b:J

    iget-boolean v5, v1, Lqg6;->o:Z

    iget-object v6, v1, Lqg6;->a:Landroid/media/MediaMuxer;

    const/4 v7, 0x1

    iget-object v8, v1, Lqg6;->c:Landroid/util/SparseArray;
    ...
    iget-object v3, v1, Lqg6;->b:Landroid/util/SparseArray;

    invoke-static {v3, v0}, Lnig;->k(Landroid/util/SparseArray;I)Z
    ...
    invoke-static {v8, v9, v5, v12}, Ldy1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4, v6, v7}, Ldy1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final c0(Lmb6;)I
    ...
    iget-object v5, p0, Lqg6;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v6, p1, Lmb6;->D:Lyb3;

    invoke-static {v4, v6}, Liji;->e(Landroid/media/MediaFormat;Lyb3;)V
    ...
    :cond_10
    :goto_2
    iget-object v0, p1, Lmb6;->q:Ljava/util/List;

    invoke-static {v4, v0}, Liji;->h(Landroid/media/MediaFormat;Ljava/util/List;)V
...
.method public final close()V
    ...
    :cond_0
    iget-boolean v0, p0, Lqg6;->o:Z

    const/4 v1, 0x1

    iget-object v2, p0, Lqg6;->a:Landroid/media/MediaMuxer;
    ...
    iput-boolean v0, p0, Lqg6;->o:Z

    :try_start_1
    invoke-static {v2}, Lqg6;->c(Landroid/media/MediaMuxer;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public final l(Lzq9;)V
    ...
    iget-object v1, p0, Lqg6;->a:Landroid/media/MediaMuxer;

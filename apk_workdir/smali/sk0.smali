...
.method public constructor <init>(Lcre;)V
    ...
    invoke-direct {p0, p1}, Lhj5;-><init>(Landroid/view/View;)V
...
.method public final s(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, p1}, Lhj5;->p(I)V

    return v2

    :cond_3
    iget p3, v0, Luk0;->i1:F
    ...
    invoke-static {p2, p3, v1}, Lggi;->a(FFF)F
...
.method public final u(ILg5;)V
    ...
    invoke-virtual {v1}, Lcre;->getValueFrom()F

    move-result v5

    invoke-virtual {v1}, Lcre;->getValueTo()F
    ...
    sget v5, Lqqc;->material_slider_value:I
    ...
    sget v4, Lqqc;->material_slider_range_end:I
    ...
    sget v4, Lqqc;->material_slider_range_start:I
    ...
    iget-object p2, p0, Lsk0;->r:Landroid/graphics/Rect;

    invoke-virtual {v1, p1, p2}, Luk0;->u(ILandroid/graphics/Rect;)V

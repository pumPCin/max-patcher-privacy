...
# direct methods
.method public static a(Landroid/net/Uri;Landroid/content/Context;Ltt5;)Landroid/net/Uri;
    .locals 7
    ...
    invoke-virtual {p2, v3}, Liv5;->p(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_2
    invoke-static {v4, v3}, Ll1j;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static b(Landroid/widget/EdgeEffect;)F
    ...
    invoke-static {p0}, Ll55;->b(Landroid/widget/EdgeEffect;)F
...
.method public static c(Landroid/content/Intent;)I
    ...
    invoke-static {v0, v3, v1}, Lhbf;->w(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, p0, v1}, Lzaf;->x(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method public static d(Landroid/content/Intent;Landroid/content/Context;Lsf5;Ltt5;)Ljava/util/ArrayList;
    .locals 3
    ...
    invoke-static {v1, p1, p2}, Ldei;->j(Landroid/net/Uri;Landroid/content/Context;Lsf5;)Z
    ...
    invoke-static {v1, p1, p3}, Lwzi;->a(Landroid/net/Uri;Landroid/content/Context;Ltt5;)Landroid/net/Uri;
...
.method public static e(Landroid/content/Intent;Landroid/content/Context;Lsf5;Ltt5;)Ljava/util/ArrayList;
    .locals 3
    ...
    :cond_3
    invoke-static {p0, p1, p2}, Ldei;->j(Landroid/net/Uri;Landroid/content/Context;Lsf5;)Z
    ...
    invoke-static {p0, p1, p3}, Lwzi;->a(Landroid/net/Uri;Landroid/content/Context;Ltt5;)Landroid/net/Uri;
...
.method public static f(Landroid/widget/EdgeEffect;FF)F
    ...
    invoke-static {p0, p1, p2}, Ll55;->c(Landroid/widget/EdgeEffect;FF)F
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lk55;->a(Landroid/widget/EdgeEffect;FF)V

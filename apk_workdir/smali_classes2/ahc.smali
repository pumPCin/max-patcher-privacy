...
.method public constructor <init>(Lgjg;)V
    ...
    .line 2
    iput-object p1, p0, Lahc;->a:Lgjg;

    .line 3
    new-instance p1, Lm3g;

    invoke-direct {p1}, Lm3g;-><init>()V

    iput-object p1, p0, Lahc;->d:Lm3g;

    return-void
.end method

.method public constructor <init>(Lgjg;Lm3g;)V
    .locals 0
...
.method public static c(IJLjava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, p3}, Loai;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {p1, p2, p3}, Loai;->c(JLjava/nio/ByteBuffer;)I
...
.method public static d(ILjava/nio/ByteBuffer;[B)V
    ...
    invoke-static {p0, p1}, Loai;->b(ILjava/nio/ByteBuffer;)I
...
.method public final a()[B
    ...
    iget-object v3, p0, Lahc;->a:Lgjg;

    invoke-virtual {v3, v2}, Lgjg;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual {v3}, Lgjg;->b()Z
    ...
    iget-object v4, p0, Lahc;->d:Lm3g;

    if-ne v3, v2, :cond_2

    iget-object v5, v4, Lm3g;->a:[B

    invoke-static {v0, v1, v5}, Lahc;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_2
    iget-wide v5, v4, Lm3g;->b:J

    const/4 v7, 0x1

    invoke-static {v7, v5, v6, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V

    if-ne v3, v2, :cond_3

    iget-object v5, v4, Lm3g;->q:[B

    if-eqz v5, :cond_3

    invoke-static {v2, v1, v5}, Lahc;->d(ILjava/nio/ByteBuffer;[B)V
    ...
    iget-wide v5, v4, Lm3g;->c:J

    const/4 v7, 0x4

    invoke-static {v7, v5, v6, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lm3g;->d:J

    const/4 v8, 0x5

    invoke-static {v8, v5, v6, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lm3g;->e:J

    const/4 v8, 0x6

    invoke-static {v8, v5, v6, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lm3g;->f:J

    const/4 v8, 0x7

    invoke-static {v8, v5, v6, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lm3g;->g:J

    const/16 v8, 0x8

    invoke-static {v8, v5, v6, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V

    iget-wide v5, v4, Lm3g;->h:J
    ...
    iget-boolean v5, v4, Lm3g;->j:Z

    if-eqz v5, :cond_4

    const/16 v5, 0xc

    invoke-static {v5, v1}, Loai;->b(ILjava/nio/ByteBuffer;)I

    invoke-static {v0, v1}, Loai;->b(ILjava/nio/ByteBuffer;)I
    ...
    invoke-static {v0, v5, v6, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V

    iget-object v0, v4, Lm3g;->n:[B

    const/16 v5, 0xf

    invoke-static {v5, v1, v0}, Lahc;->d(ILjava/nio/ByteBuffer;[B)V

    if-ne v3, v2, :cond_5

    iget-object v0, v4, Lm3g;->o:[B

    if-eqz v0, :cond_5

    const/16 v3, 0x10

    invoke-static {v3, v1, v0}, Lahc;->d(ILjava/nio/ByteBuffer;[B)V

    :cond_5
    iget-object v0, v4, Lm3g;->r:Lipe;
    ...
    invoke-static {v0, v3, v4, v1}, Lahc;->c(IJLjava/nio/ByteBuffer;)V
...
.method public final e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lt88;)V
    .locals 11
    ...
    invoke-static {p1}, Loai;->f(Ljava/nio/ByteBuffer;)I
    ...
    invoke-interface {p3, v1, v0}, Lt88;->debug(Ljava/lang/String;[B)V

    iput-object v0, v6, Lm3g;->a:[B
    ...
    invoke-interface {p3, v2}, Lt88;->debug(Ljava/lang/String;)V

    iput-wide v0, v6, Lm3g;->b:J
    ...
    invoke-interface {p3, v1}, Lt88;->debug(Ljava/lang/String;)V

    iput-object v0, v6, Lm3g;->q:[B
    ...
    iput-object v0, p3, Ly38;->a:Ljava/lang/Object;
    ...
    iput-object v0, p3, Ly38;->b:Ljava/lang/Object;
    ...
    iget-object v0, p3, Ly38;->a:Ljava/lang/Object;

    check-cast v0, Ljava/net/InetAddress;

    if-nez v0, :cond_14

    iget-object v0, p3, Ly38;->b:Ljava/lang/Object;
    ...
    iput-object v0, p3, Ly38;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, v1}, Lgjg;-><init>(I)V
    ...
    invoke-direct {v2, p3}, Lgjg;-><init>(I)V

    const/4 p3, 0x4

    invoke-direct {v1, v2, p3, v0}, Lipe;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v1, v6, Lm3g;->r:Lipe;
    ...
    :goto_a
    invoke-interface {p3, v0}, Lt88;->warn(Ljava/lang/String;)V

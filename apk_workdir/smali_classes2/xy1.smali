...
# direct methods
.method public constructor <init>(Lg8a;Lorg/webrtc/CameraVideoCapturer;Lv7f;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLwkc;)V
    .locals 4
    ...
    iput-object v0, p0, Lxy1;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lxy1;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lxy1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lxy1;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Lxy1;->h:Ljava/lang/String;

    iput-object p7, p0, Lxy1;->e:Lwkc;

    check-cast p1, Lqe4;

    new-instance p7, Lvm6;

    new-instance v2, Le5b;

    new-instance v3, La12;

    iget-object p1, p1, Lqe4;->a:Lwkc;

    invoke-direct {v3, p1}, La12;-><init>(Lwkc;)V

    invoke-direct {v2, p2, v3, p1}, Le5b;-><init>(Lorg/webrtc/CameraVideoCapturer;La12;Lwkc;)V

    const/16 p1, 0x17

    invoke-direct {p7, p1, v2}, Lvm6;-><init>(ILjava/lang/Object;)V

    iput-object p7, p0, Lxy1;->c:Lvm6;

    iput-object p3, p0, Lxy1;->d:Lv7f;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Lxy1;->i:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Lxy1;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lxy1;->i:Z

    if-eqz v1, :cond_0

    iget-object v2, p0, Lxy1;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Lxy1;->b:Ljava/util/ArrayList;
    ...
    invoke-static {v6, v7, v8, v2, v9}, Ljl3;->l(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Lwkc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lbk7;->f(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Lxy1;->e:Lwkc;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Lwkc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lxy1;->e:Lwkc;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Lxw1;->i(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Lwkc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lxy1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lm08;->r:Lxy1;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lm08;->n:Lwkc;
    ...
    invoke-interface {v8, v10, v11, v9}, Lwkc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lm08;->y:Lqgg;

    iget-object v8, v7, Lco3;->c:Ljava/lang/Object;
    ...
    invoke-static {v10, v2, v0, v5}, Lbk7;->f(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Lwkc;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lqgg;->k:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Lqgg;->u()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Lxy1;->k:Z
    ...
    iget-object v4, p0, Lxy1;->c:Lvm6;

    iget-object v4, v4, Lvm6;->b:Ljava/lang/Object;

    check-cast v4, Le5b;

    invoke-virtual {v4, v2, v0, v3}, Le5b;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Le5b;->startCapture(III)V

    iput-boolean v1, p0, Lxy1;->k:Z
    :try_end_1
...
.method public final b()V
    ...
    invoke-virtual {v0}, Le5b;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lxy1;->k:Z
    :try_end_0

...
.method public synthetic constructor <init>(Lyz0;Z)V
    .locals 0
...
.method public final run()V
    ...
    iget-object v0, p0, Lbz0;->b:Lyz0;

    iget-object v1, v0, Lyz0;->t0:Luz9;

    iget-boolean v2, v0, Lyz0;->t:Z

    if-nez v2, :cond_4

    iget-object v2, v0, Lyz0;->f0:Ljie;

    invoke-virtual {v2}, Ljie;->c()I
    ...
    iget-boolean v1, v1, Luz9;->f:Z

    const-string v3, ") != camera video enabled state ("

    const-string v5, "). Let us update media settings"

    invoke-static {v3, v5, v2, v1, v4}, Lwc0;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;ZZ)Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lyz0;->n(Z)V
    ...
    invoke-interface {v2, v1, v3}, Lyuc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Lyz0;->k:Landroid/os/Handler;

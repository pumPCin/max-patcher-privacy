...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmqd;->w0:Landroid/view/animation/AccelerateDecelerateInterpolator;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lmqd;->a:Loh6;

    new-instance v0, Leqd;

    const/4 v1, 0x0

    invoke-direct {v0, p1, p0, v1}, Leqd;-><init>(Landroid/content/Context;Lmqd;I)V
    ...
    iput-object v0, p0, Lmqd;->b:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lmqd;->c:Loh6;

    new-instance v0, Leqd;

    const/4 v2, 0x1

    invoke-direct {v0, p1, p0, v2}, Leqd;-><init>(Landroid/content/Context;Lmqd;I)V

    invoke-static {v1, v0}, Lmbi;->b(ILoh6;)Llt7;

    move-result-object v0

    iput-object v0, p0, Lmqd;->o:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lmqd;->r0:Loh6;
    ...
    iput-object p1, p0, Lmqd;->s0:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lmqd;->t0:Ljava/util/EnumMap;

    new-instance p1, Ljava/util/EnumMap;

    invoke-direct {p1, v0}, Ljava/util/EnumMap;-><init>(Ljava/lang/Class;)V

    iput-object p1, p0, Lmqd;->u0:Ljava/util/EnumMap;

    new-instance p1, Ljava/util/EnumMap;

    invoke-direct {p1, v0}, Ljava/util/EnumMap;-><init>(Ljava/lang/Class;)V

    iput-object p1, p0, Lmqd;->v0:Ljava/util/EnumMap;
...
.method public static a(Lgqd;Ljava/util/EnumMap;Ljava/util/EnumMap;Lqh6;)V
    .locals 2
...
.method private final getMentionButton()Lcqd;
    .locals 1

    iget-object v0, p0, Lmqd;->o:Ljava/lang/Object;
...
.method private final getReactionButton()Lcqd;
    .locals 1

    iget-object v0, p0, Lmqd;->s0:Ljava/lang/Object;
...
.method private final getScrollToBottomButton()Lcqd;
    .locals 1
...
# virtual methods
.method public final b(Lgqd;)V
    .locals 9

    invoke-virtual {p0, p1}, Lmqd;->d(Lgqd;)Lcqd;

    move-result-object v0

    iget-object v1, p0, Lmqd;->u0:Ljava/util/EnumMap;
    ...
    iget-object v2, p0, Lmqd;->t0:Ljava/util/EnumMap;
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Lmqd;->v0:Ljava/util/EnumMap;
    ...
    invoke-static {v3}, Lsdi;->a(Landroid/animation/Animator;)V
    ...
    invoke-static {v4}, Lsdi;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v1, p0, v2, p1}, Lpd1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {p0, v1}, Lo0h;->b(Landroid/view/ViewGroup;Loh6;)Lm0h;
    ...
    invoke-direct/range {v3 .. v8}, Lkqd;-><init>(Lcqd;Lmqd;Lgqd;Lmqd;Lcqd;)V

    invoke-static {v6, v1, v2, v3}, Lmqd;->a(Lgqd;Ljava/util/EnumMap;Ljava/util/EnumMap;Lqh6;)V
...
.method public final c(Lgqd;)V
    ...
    iget-object v1, p0, Lmqd;->t0:Ljava/util/EnumMap;
    ...
    iget-object v3, p0, Lmqd;->u0:Ljava/util/EnumMap;
    ...
    :cond_2
    :goto_0
    iget-object v2, p0, Lmqd;->v0:Ljava/util/EnumMap;
    ...
    invoke-static {v5}, Lsdi;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v2, v0, p0, p1, v4}, Lyu1;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-static {p1, v1, v3, v2}, Lmqd;->a(Lgqd;Ljava/util/EnumMap;Ljava/util/EnumMap;Lqh6;)V

    return-void
.end method

.method public final d(Lgqd;)Lcqd;
    .locals 1

    sget-object v0, Lhqd;->$EnumSwitchMapping$0:[I
    ...
    invoke-direct {p0}, Lmqd;->getReactionButton()Lcqd;
    ...
    :cond_1
    invoke-direct {p0}, Lmqd;->getMentionButton()Lcqd;
    ...
    :cond_2
    invoke-direct {p0}, Lmqd;->getScrollToBottomButton()Lcqd;
...
.method public final onThemeChanged(Lu4b;)V
    ...
    invoke-virtual {v0, p1}, Lcqd;->onThemeChanged(Lu4b;)V
...
.method public final setOnClickListener(Lqh6;)V
    ...
    invoke-direct {v0, v1, p1}, Lfqd;-><init>(ILqh6;)V

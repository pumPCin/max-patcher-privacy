...
# direct methods
.method public constructor <init>(Lorg/webrtc/DataChannel;Lyuc;)V
    .locals 1
    ...
    iput-object v0, p0, Lab4;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lab4;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lab4;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Lab4;->a:Lorg/webrtc/DataChannel;

    iput-object p2, p0, Lab4;->b:Lyuc;

    new-instance p2, Lar8;

    const/16 v0, 0xb

    invoke-direct {p2, p0, v0, p1}, Lar8;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final a(Leid;)V
    ...
    iget-object v0, p0, Lab4;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()Z
    ...
    iget-object v0, p0, Lab4;->a:Lorg/webrtc/DataChannel;
...
.method public final varargs d([Ljava/nio/ByteBuffer;)V
    ...
    iget-object v4, p0, Lab4;->b:Lyuc;

    invoke-interface {v4, v1, v3, v2}, Lyuc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final e(I[B)Z
    ...
    iget-object p1, p0, Lab4;->a:Lorg/webrtc/DataChannel;

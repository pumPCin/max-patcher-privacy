...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;ZLp61;Lxg1;Lwkc;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p5, p0, Lh5b;->a:Lwkc;

    if-eqz p2, :cond_0

    new-instance p2, Lj5b;

    invoke-direct {p2, p0, p3, p4, p5}, Lj5b;-><init>(Lh5b;Lp61;Lxg1;Lwkc;)V
    ...
    :goto_0
    iput-object p2, p0, Lh5b;->b:Lj5b;

    new-instance p2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p2, p0, Lh5b;->d:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p2, Lig5;

    const/4 p3, 0x5

    invoke-direct {p2, p1, p3, p0}, Lig5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p1, Lh4f;

    invoke-direct {p1, p2}, Lh4f;-><init>(Ltd6;)V

    iput-object p1, p0, Lh5b;->e:Lh4f;
...
.method public final createEncoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoEncoder;
    ...
    invoke-static {v7, v2, v4, v5, v6}, Lnd0;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v3, p0, Lh5b;->a:Lwkc;

    const-string v4, "PatchedVideoEncoderFactory"

    invoke-interface {v3, v4, v2}, Lwkc;->log(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Lh5b;->c:Lorg/webrtc/VideoCodecInfo;

    iget-object p1, p0, Lh5b;->d:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    new-instance v3, Lz5b;

    const/4 v4, 0x0

    invoke-direct {v3, v2, v4}, Lz5b;-><init>(Lo6b;I)V

    new-instance v4, Lc;

    const/4 v5, 0x0

    invoke-direct {v4, v2, v3, v5}, Lc;-><init>(Lo6b;Loo3;I)V

    const-string v3, "onNewCodecIsCreating"

    invoke-virtual {v2, v3, v4}, Lo6b;->j(Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-static {v0, v1}, Lc93;->R(Ljava/util/AbstractCollection;[Ljava/lang/Object;)V
...
.method public final n(Lqd8;)V
    ...
    invoke-virtual {v0, p1}, Lj5b;->n(Lqd8;)V

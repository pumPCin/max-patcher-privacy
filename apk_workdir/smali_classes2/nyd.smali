...
.field public final synthetic t0:Lpyd;

.field public final synthetic u0:Landroid/net/Uri;


# direct methods
.method public constructor <init>(Lpyd;Landroid/net/Uri;Lkotlin/coroutines/Continuation;)V
    .locals 0

    iput-object p1, p0, Lnyd;->t0:Lpyd;

    iput-object p2, p0, Lnyd;->u0:Landroid/net/Uri;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lnyd;->m(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    invoke-virtual {p1, p2}, Lnyd;->n(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final m(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lnyd;->t0:Lpyd;

    iget-object v2, p0, Lnyd;->u0:Landroid/net/Uri;

    invoke-direct {v0, v1, v2, p2}, Lnyd;-><init>(Lpyd;Landroid/net/Uri;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lnyd;->s0:Ljava/lang/Object;
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, v1, Lnyd;->t0:Lpyd;

    iget-object v0, v2, Lpyd;->t0:Lya5;

    iget-object v3, v2, Lpyd;->o:Lyn7;

    iget v4, v1, Lnyd;->r0:I
    ...
    iget-object v2, v1, Lnyd;->Z:Ljava/io/InputStream;

    iget-object v0, v1, Lnyd;->Y:Lpyd;

    iget-object v3, v1, Lnyd;->X:Ljava/io/File;

    iget-object v4, v1, Lnyd;->s0:Ljava/lang/Object;
    ...
    sget-object v9, Lpyd;->z0:[Lpl7;

    invoke-virtual {v2}, Lpyd;->s()Landroid/content/Context;

    move-result-object v9

    iget-object v10, v1, Lnyd;->u0:Landroid/net/Uri;
    ...
    iget-object v12, v12, Lyq5;->b:Lw9h;

    invoke-static {v9, v11, v12}, Lnc6;->n(Landroid/content/Context;Ljava/lang/String;Lw9h;)Lxx3;
    ...
    invoke-direct {v2, v3, v4}, Lf3e;-><init>(ILxcf;)V
    ...
    invoke-direct {v3, v4, v6}, Lf3e;-><init>(ILxcf;)V
    ...
    :try_start_3
    invoke-static {v11, v8}, Lpu0;->f(Ljava/lang/AutoCloseable;Ljava/lang/Throwable;)V
    ...
    :try_start_7
    invoke-static {v11, v3}, Lpu0;->f(Ljava/lang/AutoCloseable;Ljava/lang/Throwable;)V
    ...
    iget-object v3, v9, Lxx3;->c:Ljava/lang/String;
    ...
    invoke-static {v0, v9}, Lyq5;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    new-instance v9, Ljava/io/File;

    invoke-static {v3}, Lnc6;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_b
    sget-object v0, Lxgd;->Y:Lxgd;

    iput-object v4, v1, Lnyd;->s0:Ljava/lang/Object;

    iput-object v9, v1, Lnyd;->X:Ljava/io/File;

    iput-object v2, v1, Lnyd;->Y:Lpyd;

    iput-object v3, v1, Lnyd;->Z:Ljava/io/InputStream;

    iput v6, v1, Lnyd;->r0:I

    invoke-virtual {v0, v9, v3, v1}, Lxgd;->r(Ljava/io/File;Ljava/io/InputStream;Lwy3;)Ljava/lang/Object;
    ...
    :goto_7
    :try_start_c
    invoke-static {v2, v8}, Lrkc;->g(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_c
    ...
    :cond_f
    :goto_9
    iget-object v0, v2, Lpyd;->u0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v0, v3}, Ly2d;-><init>(Ljava/lang/String;)V

    invoke-virtual {v2, v0}, Lpyd;->v(Lb3d;)V
    :try_end_e
    ...
    :try_start_12
    invoke-static {v3, v0}, Lpr0;->b(Ljava/lang/Throwable;Ljava/lang/Throwable;)V

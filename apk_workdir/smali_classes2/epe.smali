...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Lgt8;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lepe;->v0:Ljmg;

    new-instance v1, Lik8;

    invoke-direct {v1, p1}, Lik8;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lepe;->w0:Lik8;
    ...
    iput-object v2, p0, Lepe;->x0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    new-instance v3, Ldpe;

    const/4 v4, 0x0

    invoke-direct {v3, p1, v4}, Ldpe;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v3, p0, Lepe;->y0:Ljava/lang/Object;

    new-instance v3, Ldpe;

    const/4 v5, 0x1

    invoke-direct {v3, p1, v5}, Ldpe;-><init>(Landroid/content/Context;I)V

    invoke-static {v4, v3}, Lmbi;->b(ILoh6;)Llt7;

    move-result-object p1

    iput-object p1, p0, Lepe;->A0:Ljava/lang/Object;
...
.method private final getBlurPostProcessor()Luq0;
    ...
    iget-object v0, p0, Lepe;->y0:Ljava/lang/Object;
...
.method private final getMediaType()Lm39;
    .locals 1

    iget-object v0, p0, Lepe;->A0:Ljava/lang/Object;
...
.method public final b(Z)V
    ...
    iget-object v0, p0, Lepe;->v0:Ljmg;
...
.method public final c(II)I
    ...
    iget-object v0, p0, Lepe;->w0:Lik8;

    invoke-virtual {v0}, Lik8;->k()Z

    move-result v1

    iget-object v2, p0, Lepe;->x0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    iget-object p1, p0, Lepe;->v0:Ljmg;
    ...
    invoke-virtual {p1, v3, v1}, Lhlf;->U(II)V

    :cond_3
    iget-object p1, p0, Lepe;->A0:Ljava/lang/Object;
    ...
    invoke-static {v1, v3, p2}, Ld15;->c(FFI)I
    ...
    invoke-direct {p0}, Lepe;->getMediaType()Lm39;
    ...
    invoke-static {p1, p2, v3, v6, v5}, Lcdi;->k(Landroid/view/View;IIII)V

    :cond_4
    iget-boolean p1, p0, Lepe;->z0:Z
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v0, p0, Lepe;->x0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    if-ne p2, v0, :cond_0

    iget-boolean v1, p0, Lepe;->z0:Z
    ...
    :cond_0
    iget-object v1, p0, Lepe;->w0:Lik8;
...
.method public final k()Z
    ...
    invoke-virtual {v0}, Lik8;->getImageAttach()Lj87;
...
.method public final u(IIII)J
    ...
    iget-object p2, p0, Lepe;->A0:Ljava/lang/Object;
    ...
    :cond_0
    iget-object p3, p0, Lepe;->v0:Ljmg;
    ...
    invoke-virtual {p3, p4, v2}, Lhlf;->V(II)V

    :cond_1
    invoke-virtual {v0}, Lik8;->getBlurOffset()I
    ...
    iget-object v3, p0, Lepe;->x0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    :cond_3
    iget p3, v0, Lik8;->D0:I

    if-lez p3, :cond_5

    iput-boolean v2, p0, Lepe;->z0:Z
    ...
    :goto_1
    invoke-static {p2}, Lqbi;->j(Llt7;)I

    move-result p3

    invoke-virtual {p0}, Lgt8;->getDate()Lic4;
    ...
    invoke-static {p2}, Lqbi;->i(Llt7;)I
...
.method public final w(Ljk8;)V
    ...
    iget-object p1, p1, Lbpe;->c:Lj87;

    iget-object v0, p0, Lepe;->w0:Lik8;

    invoke-virtual {v0, p1}, Lik8;->setImageAttach(Lj87;)V

    iget-object v0, p1, Lj87;->b:Landroid/net/Uri;

    invoke-static {v0}, Lea7;->d(Landroid/net/Uri;)Lea7;

    move-result-object v0

    iget-object v1, p1, Lj87;->i:Lobd;

    iput-object v1, v0, Lea7;->d:Lobd;

    invoke-direct {p0}, Lepe;->getBlurPostProcessor()Luq0;
    ...
    invoke-virtual {v2, v0, v1}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->h(Lda7;Lda7;)V
    ...
    invoke-static {p0, p1, v0}, Lsbi;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

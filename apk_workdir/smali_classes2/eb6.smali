...
.field public final o:Lbz3;

.field public final r0:Lrgf;

.field public s0:Z

.field public t0:Z

.field public final u0:Lexd;


# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;Landroid/content/Context;Lexd;Lwkc;)V
    .locals 0

    invoke-direct {p0}, Landroid/media/projection/MediaProjection$Callback;-><init>()V

    iput-object p1, p0, Leb6;->a:Lorg/webrtc/EglBase$Context;

    iput-object p2, p0, Leb6;->b:Landroid/content/Context;

    iput-object p4, p0, Leb6;->c:Lwkc;

    iput-object p3, p0, Leb6;->u0:Lexd;
    ...
    iput-object p1, p0, Leb6;->o:Lbz3;

    new-instance p1, Lrgf;

    invoke-direct {p1}, Lrgf;-><init>()V

    iput-object p1, p0, Leb6;->r0:Lrgf;
...
.method public final b(Lorg/webrtc/Size;I)V
    ...
    iget-boolean v2, p0, Leb6;->s0:Z

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Leb6;->t0:Z

    if-nez v2, :cond_1

    :try_start_0
    iget-object v2, p0, Leb6;->Y:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    :goto_0
    iget-object p2, p0, Leb6;->c:Lwkc;

    invoke-interface {p2, v1, v0, p1}, Lwkc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p2, p0, v0}, Ldb6;-><init>(Leb6;I)V

    invoke-virtual {p1, p2}, Lbz3;->c(Ljava/lang/Runnable;)V

    goto :goto_2

    :goto_1
    iget-object v3, p0, Leb6;->c:Lwkc;

    invoke-interface {v3, v1, v0, v2}, Lwkc;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    const/16 v0, 0xa

    if-le p2, v0, :cond_0

    iget-object p1, p0, Leb6;->c:Lwkc;

    const-string v0, "Error: "

    const-string v3, "times of restart screen capture did fail"

    invoke-static {p2, v0, v3}, Lxw1;->f(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    invoke-interface {p1, v1, p2, v2}, Lwkc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object p1, v0, Lbz3;->b:Ljava/lang/Object;
...
.method public final onCapturerStopped()V
    ...
    iget-object v0, p0, Leb6;->u0:Lexd;
...
.method public final onFrameCaptured(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Leb6;->r0:Lrgf;

    invoke-virtual {v0}, Lrgf;->a()V

    iget-object v0, p0, Leb6;->Z:Lorg/webrtc/VideoSink;
...
.method public final onStop()V
    ...
    invoke-direct {v0, p0, v1}, Ldb6;-><init>(Leb6;I)V

    iget-object v1, p0, Leb6;->o:Lbz3;

    invoke-virtual {v1, v0}, Lbz3;->c(Ljava/lang/Runnable;)V

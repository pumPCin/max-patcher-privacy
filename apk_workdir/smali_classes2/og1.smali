...
# direct methods
.method public constructor <init>(Lfwc;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    .locals 11

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Log1;->a:Lfwc;

    iput-object p2, p0, Log1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Ley1;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Log1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lmg1;-><init>(Lfwc;Landroid/opengl/EGLContext;[ILoh9;Ljava/lang/String;)V

    iput-object v1, p0, Log1;->e:Lmg1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Log1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Log1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Log1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Log1;->i:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Lmg1;->j:Ljava/lang/String;

    const-string v4, "OpenGL tread died, is it fine?"

    iget-object v1, v1, Lmg1;->a:Lfwc;

    invoke-interface {v1, v3, v4, v0}, Lfwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v2, p0, Log1;->c:Lxe;
...
.method public final a()V
    ...
    iget-object v0, p0, Log1;->e:Lmg1;

    iget-object v1, v0, Lmg1;->a:Lfwc;

    iget-object v2, v0, Lmg1;->j:Ljava/lang/String;
    ...
    iget-object v2, v0, Lmg1;->h:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-boolean v3, v0, Lmg1;->i:Z

    if-nez v3, :cond_0

    iget-object v3, v0, Lmg1;->a:Lfwc;

    iget-object v0, v0, Lmg1;->j:Ljava/lang/String;
    ...
    :try_start_1
    iput-boolean v3, v0, Lmg1;->i:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v2

    iget-object v2, v0, Lmg1;->k:Lgd8;
    ...
    iget-object v2, v0, Lmg1;->a:Lfwc;

    iget-object v0, v0, Lmg1;->j:Ljava/lang/String;

    const-string v3, "Release action submitted"

    invoke-interface {v2, v0, v3}, Lfwc;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lmg1;Lws1;Lorg/webrtc/VideoFrame;Lmk1;)V
    .locals 16
    ...
    iget-object v4, v2, Lng1;->a:Landroid/opengl/EGLSurface;
    ...
    invoke-virtual {v1, v4}, Lmg1;->b(Landroid/opengl/EGLSurface;)V

    const-string v7, "makeCurrent()"

    invoke-static {v7}, Lmg1;->a(Ljava/lang/String;)V
    ...
    iget-object v11, v0, Log1;->f:Landroid/graphics/Matrix;
    ...
    iget-object v3, v2, Lws1;->k:Lorg/webrtc/RendererCommon$GlDrawer;

    if-nez v3, :cond_3

    iget-object v3, v0, Log1;->h:Lorg/webrtc/GlRectDrawer;

    :cond_3
    move-object v10, v3

    iget-object v3, v1, Lmg1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v8, v0, Log1;->g:Lorg/webrtc/VideoFrameDrawer;
    ...
    invoke-static {v3}, Lmg1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v7

    iget-object v1, v1, Lmg1;->e:Landroid/opengl/EGLDisplay;
    ...
    invoke-static {v1}, Lmg1;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide v3

    iget-object v2, v2, Lws1;->l:Lxs1;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v2, Lxs1;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v2, Lxs1;->h:J

    iget-wide v5, v2, Lxs1;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v2, Lxs1;->i:J

...
# direct methods
.method public constructor <init>(Lveb;Lx71;Lgi1;Lfwc;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lxeb;->a:Lveb;

    iput-object p2, p0, Lxeb;->b:Lx71;

    iput-object p3, p0, Lxeb;->c:Lgi1;

    iput-object p4, p0, Lxeb;->d:Lfwc;
    ...
    invoke-direct {p2, p3, p4, p3, p4}, Lcl8;-><init>(DD)V

    const/4 p3, 0x0

    const/4 p4, 0x1

    invoke-direct {p1, p4, p2, p3}, Lwvc;-><init>(ILcl8;Z)V

    iput-object p1, p0, Lxeb;->g:Lwvc;

    iput-boolean p4, p0, Lxeb;->h:Z

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lxeb;->i:Ljava/lang/Object;
...
.method public final a()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lxeb;->f:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_0
    iget-object v0, p0, Lxeb;->g:Lwvc;

    iget v2, v0, Lwvc;->a:I

    sget-object v3, Lweb;->$EnumSwitchMapping$0:[I
    ...
    :cond_1
    iget-boolean v0, v0, Lwvc;->c:Z

    if-eqz v0, :cond_3

    iget-object v0, p0, Lxeb;->a:Lveb;

    iget-object v0, v0, Lveb;->e:Lwif;
    ...
    invoke-static {v0, v2}, Lxeb;->b([Lorg/webrtc/VideoCodecInfo;Ljava/lang/String;)Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v2, p0, Lxeb;->d:Lfwc;

    const-string v4, "PatchedVideoEncoderFactoryCodecSelector"

    const-string v5, "Software VP8 encoder not found"

    invoke-interface {v2, v4, v5}, Lfwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    :cond_4
    :goto_0
    iget-object v2, p0, Lxeb;->e:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_9
    iget-object v5, p0, Lxeb;->d:Lfwc;

    iget-object v6, p0, Lxeb;->c:Lgi1;

    iget-object v6, v6, Lgi1;->z:Lei1;

    iget-boolean v6, v6, Lei1;->t:Z
    ...
    invoke-static {v7, v4, v8, v2, v9}, Ley1;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v5, p0, Lxeb;->c:Lgi1;

    iget-object v5, v5, Lgi1;->z:Lei1;

    iget-boolean v5, v5, Lei1;->t:Z
    ...
    :cond_a
    iget-object v5, p0, Lxeb;->i:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-boolean v6, p0, Lxeb;->h:Z
    ...
    :cond_b
    iput-boolean v3, p0, Lxeb;->h:Z

    iget-object v3, p0, Lxeb;->g:Lwvc;
    :try_end_0
    ...
    iget-object v3, p0, Lxeb;->b:Lx71;

    new-instance v5, Lorg/json/JSONObject;

    invoke-direct {v5}, Lorg/json/JSONObject;-><init>()V

    iget-object v6, p0, Lxeb;->g:Lwvc;

    iget-object v6, v6, Lwvc;->b:Lcl8;

    iget-wide v6, v6, Lcl8;->a:D
    ...
    invoke-static {v6, v7}, Lfhi;->a(D)I
    ...
    invoke-static {v3, v4, v2, v1, v5}, Lx71;->a(Lx71;Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;I)V
...
.method public final n(Lbl8;)V
    ...
    iget-object v0, p0, Lxeb;->i:Ljava/lang/Object;
    ...
    iget-object v3, p1, Lbl8;->b:Lcl8;

    iget-boolean p1, p1, Lbl8;->d:Z

    invoke-direct {v1, v2, v3, p1}, Lwvc;-><init>(ILcl8;Z)V

    iput-object v1, p0, Lxeb;->g:Lwvc;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lxeb;->h:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onAvailableBitrate(I)Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-virtual {p0}, Lxeb;->a()Lorg/webrtc/VideoCodecInfo;
...
.method public final onCurrentEncoder(Lorg/webrtc/VideoCodecInfo;)V
    ...
    iput-object p1, p0, Lxeb;->f:Lorg/webrtc/VideoCodecInfo;

    :cond_0
    iput-object p1, p0, Lxeb;->e:Lorg/webrtc/VideoCodecInfo;
...
.method public final onEncoderBroken()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Lxeb;->e:Lorg/webrtc/VideoCodecInfo;

    iget-object v1, p0, Lxeb;->f:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_0
    iput-object v1, p0, Lxeb;->f:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_2
    iput-object v1, p0, Lxeb;->e:Lorg/webrtc/VideoCodecInfo;

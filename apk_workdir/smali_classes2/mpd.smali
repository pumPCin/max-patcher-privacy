...
# instance fields
.field public final X:Ljsc;

.field public final Y:Ljava/util/concurrent/ExecutorService;


# direct methods
.method public constructor <init>(Ljsc;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lzce;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lmpd;->X:Ljsc;

    iput-object p2, p0, Lmpd;->Y:Ljava/util/concurrent/ExecutorService;
...
.method public final H(Ltde;I)V
    ...
    invoke-virtual {p1, p2}, Llpd;->F(Lph6;)V
...
.method public final t(Landroid/view/ViewGroup;I)Lnxc;
    ...
    iget-object v2, p0, Lmpd;->X:Ljsc;

    invoke-direct {p1, v2, p2, v0, v1}, Llpd;-><init>(Ljsc;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V

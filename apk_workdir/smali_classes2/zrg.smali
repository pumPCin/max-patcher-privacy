...
# direct methods
.method public constructor <init>(Landroid/util/Size;Lc45;)V
    .locals 5

    invoke-direct {p0}, Lgw4;-><init>()V

    iput-object p1, p0, Lzrg;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lzrg;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lzrg;->t:[F
    ...
    invoke-virtual {p0, p2}, Lgw4;->n(Lc45;)Lda0;
...
.method public final q()V
    ...
    iget-object v0, p0, Lzrg;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lndi;->z(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lzrg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lzrg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lzrg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lzrg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lzrg;->q:Lg1f;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lg1f;->d:Ljava/io/Serializable;

    check-cast v3, Ljava/lang/String;

    invoke-static {v3, v1}, Lndi;->z(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lg1f;->e:Ljava/lang/Object;
    ...
    iget-object v1, v2, Lg1f;->f:Ljava/lang/Object;
    ...
    :cond_2
    iput-object v0, p0, Lzrg;->q:Lg1f;

    iput-object v0, p0, Lzrg;->w:Li4f;
...
.method public final w(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v1, v0}, Lgw4;->l(Landroid/view/Surface;)Lua0;

    move-result-object v2

    sget-object v3, Ltj6;->j:Lua0;

    invoke-virtual {v2, v3}, Lua0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v1, v0}, Lgw4;->h(Landroid/view/Surface;)Lua0;
    ...
    :cond_1
    iget-object v3, v1, Lgw4;->c:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Ltj6;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V
    ...
    iget v11, v2, Lua0;->b:I

    iget v12, v2, Lua0;->c:I

    iget-object v9, v2, Lua0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v1, Lzrg;->q:Lg1f;

    if-nez v2, :cond_2

    new-instance v2, Lg1f;

    iget-object v5, v1, Lzrg;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Lg1f;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Lzrg;->q:Lg1f;

    :cond_2
    move-object v10, v2

    iget-object v2, v10, Lg1f;->f:Ljava/lang/Object;

    move-object/from16 v17, v2

    check-cast v17, Lone/me/sdk/gl/effects/objects/FrameBuffer;

    iget-object v2, v1, Lzrg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Lzrg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Lzrg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Lzrg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Lzrg;->u:J

    cmp-long v6, v13, v6

    iget-object v7, v1, Lzrg;->t:[F
    ...
    iget v6, v10, Lg1f;->a:I

    move/from16 v16, v8

    iget v8, v10, Lg1f;->b:I
    ...
    iget-object v3, v10, Lg1f;->e:Ljava/lang/Object;
    ...
    iget-object v4, v10, Lg1f;->c:Ljava/lang/Object;
    ...
    iget-object v4, v1, Lgw4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2}, Lgw4;->o(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Lgw4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v4, v11}, Li4f;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    iput-object v8, v1, Lzrg;->w:Li4f;
    ...
    :cond_9
    :goto_2
    iget-object v4, v1, Lgw4;->f:Ljava/lang/Object;
    ...
    invoke-static {v7, v4, v5}, Lyzh;->b(IJ)Ljava/lang/String;
    ...
    iget-object v4, v1, Lzrg;->p:Ljava/lang/String;

    invoke-static {v4, v2, v8}, Lndi;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v1, v0, v3}, Lgw4;->s(Landroid/view/Surface;Z)V

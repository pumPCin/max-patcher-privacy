...
# instance fields
.field public final A0:Lzpa;

.field public final B0:Lzpa;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lw7c;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lw7c;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v7, v5}, Lss6;->v(Landroid/view/View;)Llwa;

    move-result-object v10

    invoke-interface {v10}, Llwa;->getIcon()Lg17;
    ...
    iput-object v5, v0, Lw7c;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Lzpa;

    invoke-direct {v10, v1}, Lzpa;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v10, v2}, Lzpa;->setMode(Lwpa;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Lzpa;->a(FILjava/lang/String;)V

    new-instance v9, Lq7c;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lq7c;-><init>(Lw7c;I)V

    invoke-static {v10, v9}, Ljgh;->C(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lw7c;->v0:Lzpa;
    ...
    iput-object v9, v0, Lw7c;->w0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v13}, Lss6;->v(Landroid/view/View;)Llwa;
    ...
    invoke-static {v3, v6}, Lbv0;->M(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-virtual {v7, v3}, Lss6;->v(Landroid/view/View;)Llwa;
    ...
    iput-object v13, v0, Lw7c;->x0:Landroid/widget/LinearLayout;

    new-instance v3, Lzpa;

    invoke-direct {v3, v1}, Lzpa;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lzpa;->setMode(Lwpa;)V

    new-instance v6, Lq7c;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lq7c;-><init>(Lw7c;I)V

    invoke-static {v3, v6}, Ljgh;->C(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lw7c;->y0:Lzpa;

    new-instance v6, Laz1;

    invoke-direct {v6, v1}, Laz1;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lq7c;-><init>(Lw7c;I)V

    invoke-static {v6, v7}, Ljgh;->C(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lw7c;->z0:Laz1;

    new-instance v7, Lzpa;

    invoke-direct {v7, v1}, Lzpa;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lzpa;->setMode(Lwpa;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Lzpa;->a(FILjava/lang/String;)V

    new-instance v8, Lq7c;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lq7c;-><init>(Lw7c;I)V

    invoke-static {v7, v8}, Ljgh;->C(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lw7c;->A0:Lzpa;

    new-instance v8, Lzpa;

    invoke-direct {v8, v1}, Lzpa;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lzpa;->setMode(Lwpa;)V

    new-instance v2, Lq7c;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lq7c;-><init>(Lw7c;I)V

    invoke-static {v8, v2}, Ljgh;->C(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lw7c;->B0:Lzpa;
    ...
    invoke-direct {v1, v2, v2, v3}, Lcr0;-><init>(IIZ)V

    new-instance v3, Lyb7;

    invoke-direct {v3, v2, v1}, Lyb7;-><init>(ILcr0;)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lpr0;->c(Landroid/view/View;Lyb7;Lvd6;)V

    iput-object v6, v0, Lw7c;->C0:Landroid/widget/FrameLayout;

    new-instance v1, Lr7c;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lr7c;-><init>(Lw7c;I)V

    invoke-static {v2, v1}, Lwee;->u(ILtd6;)Lyn7;

    move-result-object v1

    iput-object v1, v0, Lw7c;->D0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lw7c;->E0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lw7c;->F0:Ljava/lang/Object;
...
.method public static final synthetic a(Lw7c;)Z
    .locals 0

    invoke-direct {p0}, Lw7c;->getCanRecordingVideo()Z
...
.method public static final b(Lw7c;Lcy1;)V
    .locals 6
    ...
    invoke-direct {p0}, Lw7c;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lw7c;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lw7c;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lw7c;->y0:Lzpa;

    iget-object v1, v1, Lzpa;->c:Lkta;

    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/AppCompatImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-static {v5}, Lfn7;->j(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object v0

    iput-object v0, v1, Lkta;->r0:Landroid/graphics/Path;
    ...
    invoke-virtual {p0}, Lw7c;->getCameraApi()Ldy1;
    ...
    invoke-interface {p0, p1}, Ldy1;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lw7c;FFFFF)V
    .locals 2

    iget-object v0, p0, Lw7c;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lw7c;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lw7c;->C0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lw7c;->D0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lw7c;->F0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lw7c;->E0:Ljava/lang/Object;
...
.method public final getCameraApi()Ldy1;
    .locals 1

    iget-object v0, p0, Lw7c;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;

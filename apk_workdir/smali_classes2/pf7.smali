...
.method public constructor <init>(FFI)V
    ...
    iput-object p1, p0, Lpf7;->d:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lpf7;->e:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lpf7;->f:Landroid/graphics/Path;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lpf7;->g:Landroid/graphics/Path;

    new-instance p1, Lof7;

    invoke-direct {p1, p0}, Lof7;-><init>(Lpf7;)V

    iput-object p1, p0, Lpf7;->h:Lof7;
    ...
    invoke-direct {p2, p1, p0}, Lof7;-><init>(Ljava/lang/Integer;Lpf7;)V

    iput-object p2, p0, Lpf7;->i:Lof7;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    :try_start_0
    iget-object v1, p0, Lpf7;->f:Landroid/graphics/Path;

    iget-object v2, p0, Lpf7;->d:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v2}, Landroid/graphics/Canvas;->drawPath(Landroid/graphics/Path;Landroid/graphics/Paint;)V

    iget-object v1, p0, Lpf7;->h:Lof7;

    sget-object v2, Lpf7;->j:[Lwq7;
    ...
    iget-object v2, p0, Lpf7;->g:Landroid/graphics/Path;
...
.method public final getOutline(Landroid/graphics/Outline;)V
    ...
    iget-object v0, p0, Lpf7;->g:Landroid/graphics/Path;
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lpf7;->f:Landroid/graphics/Path;
    ...
    iget-object v6, p0, Lpf7;->e:Landroid/graphics/RectF;
...
.method public final setAlpha(I)V
    ...
    iget-object v0, p0, Lpf7;->d:Landroid/graphics/Paint;

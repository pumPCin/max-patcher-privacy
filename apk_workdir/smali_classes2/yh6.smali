...
.method public synthetic constructor <init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    iput-object p1, p0, Lyh6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
...
.method public final run()V
    ...
    iget-object v0, p0, Lyh6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
    ...
    iget-object v3, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Lone/me/image/crop/view/ImageCropView;

    iget-object v3, v3, Lone/me/image/crop/view/ImageCropView;->a:Lyn6;

    invoke-virtual {v3}, Ldj7;->getInitialMatrix()Landroid/graphics/Matrix;

    move-result-object v4

    iget-object v3, v3, Lg3g;->s0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v3}, Lone/me/image/crop/view/ImageCropView;->getCropState()Ln74;
    ...
    iget-object v1, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Lone/me/image/crop/view/ImageCropView;
    ...
    :goto_1
    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->a:Lyn6;

    invoke-virtual {v1}, Lg3g;->getViewBitmap()Landroid/graphics/Bitmap;

    move-result-object v2

    invoke-virtual {v1}, Lg3g;->getImageOutputPath()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1}, Ldj7;->getCropState()Ln74;
    ...
    iget-object v5, v1, Ln74;->c:[F

    iget-object v1, v1, Ln74;->a:Landroid/graphics/RectF;
    ...
    invoke-static {v4}, Lkzh;->d(Landroid/graphics/Matrix;)F
    ...
    iget-object v2, p0, Lyh6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;

    invoke-direct {v0, v2, v1}, Lyh6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-direct {v3, v2, v4}, Lyh6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v4, Ld46;

    const/4 v5, 0x5

    invoke-direct {v4, v5, v2}, Ld46;-><init>(ILjava/lang/Object;)V

    new-instance v2, Ldu1;

    const/4 v5, 0x0

    invoke-direct {v2, v4, v5, v3}, Ldu1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    :try_start_2
    new-instance v3, Leh3;

    invoke-direct {v3, v2, v1}, Leh3;-><init>(Lgh3;Lxod;)V
    ...
    iget-object v0, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Lone/me/image/crop/view/ImageCropView;

    iget-object v0, v0, Lone/me/image/crop/view/ImageCropView;->a:Lyn6;

    const/4 v1, 0x0

    iput v1, v0, Ldj7;->D0:F

    invoke-virtual {v0}, Ldj7;->f()V
    ...
    iget-object v1, v0, Lru/ok/messages/views/fragments/base/FrgBase;->l1:Lyoh;
    ...
    iget-object v2, v1, Ldj7;->A0:Landroid/graphics/RectF;
    ...
    iget-object v2, v1, Ldj7;->B0:Landroid/graphics/Matrix;
    ...
    iget-object v3, v1, Ldj7;->C0:Landroid/graphics/RectF;

    iget-object v1, v1, Ldj7;->A0:Landroid/graphics/RectF;
    ...
    iget-object v2, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Lone/me/image/crop/view/ImageCropView;

    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->a:Lyn6;

    iget-object v3, v2, Ldj7;->A0:Landroid/graphics/RectF;
    ...
    iget-object v6, v2, Lg3g;->s0:Landroid/graphics/Matrix;

    const/high16 v7, 0x42b40000    # 90.0f

    invoke-virtual {v6, v7, v5, v3}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    invoke-virtual {v2, v6}, Lg3g;->setImageMatrix(Landroid/graphics/Matrix;)V

    iget-object v2, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Lone/me/image/crop/view/ImageCropView;

    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->b:Lhbb;

    iget v3, v2, Lhbb;->r0:F

    div-float v3, v4, v3

    iput v3, v2, Lhbb;->r0:F

    iget-object v5, v2, Lhbb;->a:Landroid/graphics/RectF;

    invoke-virtual {v2, v5, v3}, Lhbb;->a(Landroid/graphics/RectF;F)V

    invoke-virtual {v2}, Lhbb;->b()V

    iget-object v3, v2, Lhbb;->K0:Libb;
    ...
    invoke-virtual {v3, v5}, Ldj7;->setCropRect(Landroid/graphics/RectF;)V
    ...
    iget-object v3, v2, Ldj7;->B0:Landroid/graphics/Matrix;
    ...
    iget-object v4, v2, Ldj7;->C0:Landroid/graphics/RectF;

    iget-object v2, v2, Ldj7;->A0:Landroid/graphics/RectF;
    ...
    iget-object v1, v3, Lone/me/image/crop/view/ImageCropView;->a:Lyn6;

    iget-object v3, v1, Ldj7;->A0:Landroid/graphics/RectF;
    ...
    iget-object v5, v1, Lg3g;->s0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v1, v5}, Lg3g;->setImageMatrix(Landroid/graphics/Matrix;)V

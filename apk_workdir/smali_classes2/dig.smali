...
.method public constructor <init>(Lyrf;)V
    ...
    iput-object p1, p0, Ldig;->a:Lyrf;

    new-instance p1, Lwxe;

    const/16 v0, 0x15

    invoke-direct {p1, v0}, Lwxe;-><init>(I)V
    ...
    iput-object p1, p0, Ldig;->b:Ljava/lang/Object;

    new-instance p1, Lwxe;

    const/16 v1, 0x16

    invoke-direct {p1, v1}, Lwxe;-><init>(I)V

    invoke-static {v0, p1}, Lmbi;->b(ILoh6;)Llt7;

    move-result-object p1

    iput-object p1, p0, Ldig;->c:Ljava/lang/Object;
    ...
    iput-object p1, p0, Ldig;->e:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Ldig;->f:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Ldig;->g:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Ldig;->h:Ljava/util/ArrayList;
...
.method public static a(Landroid/graphics/Canvas;Ljava/util/List;Ljava/util/List;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p2}, Lab3;->E(ILjava/util/List;)Ljava/lang/Object;
...
.method public static b(Ljava/util/List;Ljava/util/List;Ljava/util/List;II)V
    ...
    invoke-direct/range {v3 .. v9}, Lcig;-><init>(FFFFF[F)V

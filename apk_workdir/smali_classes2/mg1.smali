...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmg1;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public constructor <init>(Lfwc;Landroid/opengl/EGLContext;[ILoh9;Ljava/lang/String;)V
    .locals 13

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmg1;->a:Lfwc;

    move-object/from16 v0, p4

    iput-object v0, p0, Lmg1;->b:Loh9;
    ...
    iput-object v0, p0, Lmg1;->c:Landroid/os/HandlerThread;

    sget-object v1, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v1, p0, Lmg1;->g:Landroid/opengl/EGLSurface;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lmg1;->h:Ljava/lang/Object;
    ...
    :goto_1
    iput-object v2, p0, Lmg1;->j:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, p1, v4, v5}, Lgd8;-><init>(Landroid/os/Looper;Lfwc;Ljava/lang/String;Lfx0;)V

    iput-object v3, p0, Lmg1;->k:Lgd8;
    ...
    invoke-direct {v0, p0, v5, p2, v4}, Lgj;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final b(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lmg1;->d:Landroid/opengl/EGLContext;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lmg1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v3, p0, Lmg1;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, Lmg1;->g:Landroid/opengl/EGLSurface;
    ...
    iput-object p1, p0, Lmg1;->g:Landroid/opengl/EGLSurface;
...
.method public final c(Lli6;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lmg1;->k:Lgd8;

    new-instance v1, Llg1;

    const/4 v2, 0x1

    invoke-direct {v1, p1, p0, v2}, Llg1;-><init>(Lli6;Lmg1;I)V
    ...
    iget-object v0, p0, Lmg1;->j:Ljava/lang/String;

    const-string v1, "OpenGL tread died, is it fine?"

    iget-object v2, p0, Lmg1;->a:Lfwc;

    invoke-interface {v2, v0, v1, p1}, Lfwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final d(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lmg1;->e:Landroid/opengl/EGLDisplay;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    sget-object p1, Lmg1;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lmg1;->a:Lfwc;

    iget-object v1, p0, Lmg1;->j:Ljava/lang/String;

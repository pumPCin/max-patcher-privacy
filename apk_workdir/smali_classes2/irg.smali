...
.method public constructor <init>(Landroid/util/Size;)V
    ...
    iput-object v1, p0, Lirg;->a:Ljava/lang/String;

    new-instance v2, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v2, p0, Lirg;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lirg;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/util/LinkedHashMap;

    invoke-direct {v2}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v2, p0, Lirg;->Z:Ljava/util/LinkedHashMap;

    const/16 v2, 0x10

    new-array v3, v2, [F

    iput-object v3, p0, Lirg;->r0:[F

    new-array v2, v2, [F

    iput-object v2, p0, Lirg;->s0:[F
    ...
    :cond_1
    :goto_0
    invoke-static {v0}, Lbbi;->a(Lc45;)V

    new-instance v1, Lfrg;

    invoke-direct {v1, p0, p1, v0}, Lfrg;-><init>(Lirg;Landroid/util/Size;Lc45;)V

    iput-object v1, p0, Lirg;->c:Lfrg;
    ...
    iput-object p1, p0, Lirg;->o:Landroid/os/Handler;

    iget-object v0, v1, Lfrg;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p0}, Lirg;->release()V
    ...
    invoke-direct {v0, p1}, Lgv6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lirg;->X:Lgv6;

    return-void
.end method

.method public static final a(Lirg;Landroid/util/Size;Lc45;)V
    .locals 5
    ...
    iget-boolean v0, p0, Lirg;->u0:Z

    if-nez v0, :cond_3

    iget-object v0, p0, Lirg;->t0:Lzrg;

    if-nez v0, :cond_2

    new-instance v0, Lzrg;

    invoke-direct {v0, p1, p2}, Lzrg;-><init>(Landroid/util/Size;Lc45;)V

    iput-object v0, p0, Lirg;->t0:Lzrg;
...
.method public static g(Lirg;Loh6;Loh6;I)V
    .locals 3
    ...
    :cond_0
    iget-object p3, p0, Lirg;->o:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lirg;->a:Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Lndi;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b(Lzef;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lirg;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lirg;->o:Landroid/os/Handler;

    new-instance v3, Lpkg;

    const/4 v4, 0x6

    invoke-direct {v3, p0, v4, v1}, Lpkg;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final d()V
    ...
    iget-boolean v1, p0, Lirg;->u0:Z

    if-eqz v1, :cond_2

    iget v1, p0, Lirg;->v0:I

    if-nez v1, :cond_2

    iget-object v1, p0, Lirg;->Z:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v0, v3}, Lndi;->z(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4}, Lref;->close()V
...
.method public final f(Lref;)V
    ...
    iget-object v4, p1, Lref;->o:Landroid/util/Size;
    ...
    invoke-direct {v0, p1, v1, p0}, Lyge;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p1, p0, Lirg;->o:Landroid/os/Handler;

    new-instance v1, Lpkg;

    const/4 v4, 0x6

    invoke-direct {v1, p0, v4, v0}, Lpkg;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p1, p0, Lirg;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3}, Ltna;->invoke()Ljava/lang/Object;
...
.method public final release()V
    ...
    iget-object v0, p0, Lirg;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    invoke-static {p0, v0, v1, v2}, Lirg;->g(Lirg;Loh6;Loh6;I)V

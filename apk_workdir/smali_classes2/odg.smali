...
# direct methods
.method public constructor <init>(Landroid/util/Size;La15;)V
    .locals 5

    invoke-direct {p0}, Lgt4;-><init>()V

    iput-object p1, p0, Lodg;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lodg;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lodg;->t:[F
    ...
    invoke-virtual {p0, p2}, Lgt4;->n(La15;)Lr90;
...
.method public final q()V
    ...
    iget-object v0, p0, Lodg;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lyt3;->N(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lodg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lodg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lodg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lodg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lodg;->q:Ltoe;

    if-eqz v2, :cond_2

    iget-object v3, v2, Ltoe;->d:Ljava/io/Serializable;

    check-cast v3, Ljava/lang/String;

    invoke-static {v3, v1}, Lyt3;->N(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Ltoe;->e:Ljava/lang/Object;
    ...
    iget-object v1, v2, Ltoe;->f:Ljava/lang/Object;
    ...
    :cond_2
    iput-object v0, p0, Lodg;->q:Ltoe;

    iput-object v0, p0, Lodg;->w:Ltte;

    invoke-super {p0}, Lgt4;->q()V
...
.method public final w(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v1, v0}, Lgt4;->l(Landroid/view/Surface;)Lia0;

    move-result-object v2

    sget-object v3, Lyf6;->j:Lia0;
    ...
    invoke-virtual {v1, v0}, Lgt4;->h(Landroid/view/Surface;)Lia0;
    ...
    :cond_1
    iget-object v3, v1, Lgt4;->c:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Lyf6;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V
    ...
    iget-object v2, v1, Lodg;->q:Ltoe;

    if-nez v2, :cond_2

    new-instance v2, Ltoe;

    iget-object v5, v1, Lodg;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Ltoe;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Lodg;->q:Ltoe;

    :cond_2
    move-object v10, v2

    iget-object v2, v10, Ltoe;->f:Ljava/lang/Object;

    move-object/from16 v17, v2

    check-cast v17, Lone/me/sdk/gl/effects/objects/FrameBuffer;

    iget-object v2, v1, Lodg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Lodg;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Lodg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Lodg;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Lodg;->u:J

    cmp-long v6, v13, v6

    iget-object v7, v1, Lodg;->t:[F
    ...
    iget v6, v10, Ltoe;->a:I

    move/from16 v16, v8

    iget v8, v10, Ltoe;->b:I
    ...
    iget-object v3, v10, Ltoe;->e:Ljava/lang/Object;
    ...
    iget-object v4, v10, Ltoe;->c:Ljava/lang/Object;
    ...
    iget-object v4, v1, Lgt4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2}, Lgt4;->o(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Lgt4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v4, v11}, Ltte;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    iput-object v8, v1, Lodg;->w:Ltte;
    ...
    :cond_9
    :goto_2
    iget-object v4, v1, Lgt4;->f:Ljava/lang/Object;
    ...
    invoke-static {v7, v4, v5}, Ldt;->N(IJ)Ljava/lang/String;
    ...
    iget-object v4, v1, Lodg;->p:Ljava/lang/String;

    invoke-static {v4, v2, v8}, Lyt3;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v1, v0, v3}, Lgt4;->s(Landroid/view/Surface;Z)V

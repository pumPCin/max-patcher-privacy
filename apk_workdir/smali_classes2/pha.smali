...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;Lfwc;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lpha;->a:Lorg/webrtc/EglBase$Context;

    iput-object p2, p0, Lpha;->b:Lfwc;

    new-instance p1, Lvth;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lvth;-><init>(Lpha;I)V

    new-instance p2, Lwif;

    invoke-direct {p2, p1}, Lwif;-><init>(Lji6;)V

    iput-object p2, p0, Lpha;->c:Lwif;
    ...
    iput-object p2, p0, Lpha;->d:Lwif;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lpha;->e:Z
...
# virtual methods
.method public final a(Lorg/webrtc/VideoCodecInfo;)Lkxb;
    .locals 5
    ...
    :cond_1
    iget-boolean v1, p0, Lpha;->e:Z

    if-nez v1, :cond_2

    iget-object v1, p0, Lpha;->d:Lwif;
    ...
    iget-object v2, p0, Lpha;->b:Lfwc;

    invoke-direct {v0, v1, p1, v2}, Lkxb;-><init>(Lorg/webrtc/VideoDecoder;Lorg/webrtc/VideoCodecInfo;Lfwc;)V

    return-object v0

    :cond_2
    :try_start_0
    iget-object v1, p0, Lpha;->c:Lwif;
...
.method public final createDecoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoDecoder;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lpha;->a(Lorg/webrtc/VideoCodecInfo;)Lkxb;
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    :try_start_0
    invoke-virtual {p0}, Lpha;->b()[Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v3, p0, Lpha;->b:Lfwc;

    invoke-interface {v3, v1, v2, v0}, Lfwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

...
.method public constructor <init>(Landroid/content/Context;Lms5;)V
    ...
    invoke-direct {p0, p1, p2}, Lird;-><init>(Landroid/content/Context;Lms5;)V
    ...
    iput-object p1, p0, Lchg;->n:Ljava/util/WeakHashMap;
...
.method public final r()Lxdd;
    ...
    invoke-static {v0, v4, v5}, Ls9f;->T(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    :cond_1
    invoke-static {v0, v2, v5}, Ls9f;->T(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    invoke-static {v0, v2, v6}, Ls9f;->T(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    invoke-direct {v1, v0}, Ludd;-><init>(Ljava/lang/String;)V
    ...
    :cond_3
    invoke-static {v0, v1, v5}, Ls9f;->T(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    invoke-static {v0, v1, v6}, Ls9f;->T(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
    ...
    invoke-direct {v2, v0}, Lwdd;-><init>(Ljava/lang/String;)V
    :try_end_0
...
.method public final v(Lahg;)V
    ...
    iget-object v0, p1, Lahg;->b:Ljava/lang/Long;
    ...
    :cond_0
    iget-object v0, p1, Lahg;->a:Ljava/lang/Boolean;
    ...
    :cond_1
    iget-object v0, p1, Lahg;->c:Ljava/lang/String;
    ...
    iget-object v6, p0, Lird;->k:Lim0;

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-virtual {v6, v0}, Lim0;->d(Ljava/lang/Object;)V

    :cond_4
    iget-object v0, p1, Lahg;->d:Ljava/lang/String;
    ...
    :cond_6
    :goto_1
    invoke-virtual {p0, v3}, Lird;->o(I)V

    :cond_7
    iget-object v0, p1, Lahg;->e:Ljava/lang/String;
    ...
    :cond_8
    iget-object v0, p1, Lahg;->f:Ljava/lang/String;
    ...
    :cond_9
    iget-object v0, p1, Lahg;->g:Ljava/lang/String;
    ...
    :cond_a
    iget-object v0, p1, Lahg;->i:Ljava/lang/Integer;
    ...
    :cond_b
    iget-object v0, p1, Lahg;->h:Ljava/lang/Boolean;
    ...
    :cond_c
    iget-object v0, p1, Lahg;->j:Ljava/lang/Integer;
    ...
    :cond_d
    iget-object v0, p1, Lahg;->k:Ljava/lang/Integer;
    ...
    :cond_e
    iget-object v0, p1, Lahg;->l:Ljava/lang/Boolean;
    ...
    :cond_f
    iget-object v0, p1, Lahg;->m:Ljava/lang/Boolean;
    ...
    :cond_10
    iget-object v0, p1, Lahg;->n:Ljava/lang/Boolean;
    ...
    invoke-static {v0}, Lfef;->k(I)Ljava/lang/String;
    ...
    :cond_13
    iget-object v0, p1, Lahg;->q:Lzgg;

    if-eqz v0, :cond_14

    iget-object v0, v0, Lzgg;->a:Ljava/lang/String;
    ...
    invoke-static {v0}, Lfef;->j(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lfef;->l(I)Ljava/lang/String;
    ...
    :cond_16
    iget-object v0, p1, Lahg;->t:Ljava/lang/Boolean;
    ...
    :cond_17
    iget-object v0, p1, Lahg;->u:Ljava/lang/Boolean;
    ...
    :cond_18
    iget-object v0, p1, Lahg;->v:Ljava/lang/Boolean;
    ...
    :cond_1a
    iget-object v0, p1, Lahg;->x:Ljava/lang/Boolean;

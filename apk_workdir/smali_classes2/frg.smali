...
# instance fields
.field public final synthetic X:Lirg;
...
# direct methods
.method public constructor <init>(Lirg;Landroid/util/Size;Lc45;)V
    .locals 0

    iput-object p1, p0, Lfrg;->X:Lirg;

    const-string p1, "videomsg-gl-thread"

    invoke-direct {p0, p1}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, Lfrg;->a:Landroid/util/Size;

    iput-object p3, p0, Lfrg;->b:Lc45;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide p1

    iput-wide p1, p0, Lfrg;->c:J

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lfrg;->o:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final run()V
    ...
    iget-object v1, p0, Lfrg;->a:Landroid/util/Size;

    iget-object v2, p0, Lfrg;->b:Lc45;
    ...
    invoke-static {v0, v1, v2}, Lndi;->n(Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/CancellationException;)V

    iget-object v0, p0, Lfrg;->X:Lirg;

    iget-object v0, v0, Lirg;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v3, p0, Lfrg;->b:Lc45;

    invoke-static {v0, v1, v3}, Lirg;->a(Lirg;Landroid/util/Size;Lc45;)V
    :try_end_0
    ...
    iget-object v1, p0, Lfrg;->o:Ljava/util/concurrent/atomic/AtomicReference;

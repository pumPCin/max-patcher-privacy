...
.field public final i:Lwp4;

.field public final j:Lsdb;

.field public k:I

.field public volatile l:Lws7;


# direct methods
.method public constructor <init>(Ljava/util/concurrent/ExecutorService;Lorg/webrtc/EglBase;Lyuc;Lyh1;Lwp4;Lq71;)V
    .locals 12
    ...
    iput-object p1, p0, Lmie;->a:Ljava/util/concurrent/ExecutorService;

    iput-object p3, p0, Lmie;->b:Lyuc;

    iput-object v0, p0, Lmie;->i:Lwp4;
    ...
    invoke-direct {v2, v3, p3}, Lnga;-><init>(Lorg/webrtc/EglBase$Context;Lyuc;)V

    iput-object v2, p0, Lmie;->e:Lnga;
    ...
    iget-object v2, v10, Lyh1;->s:Lo0f;
    ...
    :goto_2
    invoke-direct/range {v4 .. v9}, Lsdb;-><init>(Lorg/webrtc/EglBase$Context;ZLp71;Lyh1;Lyuc;)V

    iput-object v4, p0, Lmie;->j:Lsdb;

    invoke-virtual {v0, v4}, Lwp4;->a(Lzj8;)V

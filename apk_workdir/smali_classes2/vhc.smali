...
# instance fields
.field public final A0:Ldya;

.field public final B0:Ldya;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lvhc;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lvhc;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v7, v5}, Lc82;->g(Landroid/view/View;)Lu4b;
    ...
    iput-object v5, v0, Lvhc;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Ldya;

    invoke-direct {v10, v1}, Ldya;-><init>(Landroid/content/Context;)V
    ...
    sget-object v2, Laya;->b:Laya;

    invoke-virtual {v10, v2}, Ldya;->setMode(Laya;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Ldya;->a(FILjava/lang/String;)V

    new-instance v9, Lphc;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lphc;-><init>(Lvhc;I)V

    invoke-static {v10, v9}, Ldxi;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lvhc;->v0:Ldya;
    ...
    invoke-virtual {v7, v9}, Lc82;->g(Landroid/view/View;)Lu4b;

    move-result-object v13

    invoke-interface {v13}, Lu4b;->getText()Lapf;

    invoke-virtual {v9, v6}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v9, v0, Lvhc;->w0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v13}, Lc82;->g(Landroid/view/View;)Lu4b;
    ...
    invoke-static {v3, v6}, Lgma;->j(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {v6, v7}, Lgma;->j(Landroid/graphics/drawable/Drawable;I)V
    ...
    iput-object v13, v0, Lvhc;->x0:Landroid/widget/LinearLayout;

    new-instance v3, Ldya;

    invoke-direct {v3, v1}, Ldya;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Ldya;->setMode(Laya;)V

    new-instance v6, Lphc;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lphc;-><init>(Lvhc;I)V

    invoke-static {v3, v6}, Ldxi;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lvhc;->y0:Ldya;

    new-instance v6, Le02;

    invoke-direct {v6, v1}, Le02;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lphc;-><init>(Lvhc;I)V

    invoke-static {v6, v7}, Ldxi;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lvhc;->z0:Le02;

    new-instance v7, Ldya;

    invoke-direct {v7, v1}, Ldya;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Ldya;->setMode(Laya;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Ldya;->a(FILjava/lang/String;)V

    new-instance v8, Lphc;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lphc;-><init>(Lvhc;I)V

    invoke-static {v7, v8}, Ldxi;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lvhc;->A0:Ldya;

    new-instance v8, Ldya;

    invoke-direct {v8, v1}, Ldya;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Ldya;->setMode(Laya;)V

    new-instance v2, Lphc;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lphc;-><init>(Lvhc;I)V

    invoke-static {v8, v2}, Ldxi;->c(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lvhc;->B0:Ldya;
    ...
    invoke-direct {v3, v2, v1, v7}, Lkh7;-><init>(ILzr0;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lqzh;->b(Landroid/view/View;Lkh7;Lqh6;)V

    iput-object v6, v0, Lvhc;->C0:Landroid/widget/FrameLayout;

    new-instance v1, Lqhc;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lqhc;-><init>(Lvhc;I)V

    invoke-static {v2, v1}, Lmbi;->b(ILoh6;)Llt7;

    move-result-object v1

    iput-object v1, v0, Lvhc;->D0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lvhc;->E0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lvhc;->F0:Ljava/lang/Object;
...
.method public static final synthetic a(Lvhc;)Z
    .locals 0

    invoke-direct {p0}, Lvhc;->getCanRecordingVideo()Z
...
.method public static final b(Lvhc;Lgz1;)V
    .locals 6
    ...
    invoke-direct {p0}, Lvhc;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lvhc;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lvhc;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lvhc;->y0:Ldya;

    iget-object v1, v1, Ldya;->c:Lt1b;

    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/AppCompatImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-static {v5}, Lnoi;->e(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object v0

    iput-object v0, v1, Lt1b;->r0:Landroid/graphics/Path;
    ...
    invoke-virtual {p0}, Lvhc;->getCameraApi()Lhz1;
    ...
    invoke-interface {p0, p1}, Lhz1;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lvhc;FFFFF)V
    .locals 2

    iget-object v0, p0, Lvhc;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lvhc;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lvhc;->C0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lvhc;->D0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lvhc;->F0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lvhc;->E0:Ljava/lang/Object;
...
.method public final getCameraApi()Lhz1;
    .locals 1

    iget-object v0, p0, Lvhc;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;

...
.method public final b(Lkd2;Landroid/net/Uri;)Ljava/util/List;
    .locals 5
    ...
    invoke-direct {v0, p0, v1}, Lex6;-><init>(Ls08;I)V

    invoke-virtual {p0, p2, v0}, Ls08;->c(Landroid/net/Uri;Lzvb;)Lr08;

    move-result-object p2

    invoke-virtual {p1}, Lkd2;->e()V

    iget-object p1, p1, Lkd2;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v4, p0, v1}, Lex6;-><init>(Ls08;I)V

    invoke-virtual {p0, v3, v4}, Ls08;->c(Landroid/net/Uri;Lzvb;)Lr08;

    move-result-object v3

    invoke-virtual {p2, v3}, Lr08;->equals(Ljava/lang/Object;)Z
...
.method public final c(Landroid/net/Uri;Lzvb;)Lr08;
    .locals 5

    invoke-virtual {p0, p1}, Ls08;->e(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    :try_start_0
    invoke-interface {p2, v0}, Lzvb;->test(Ljava/lang/Object;)Z
    ...
    invoke-direct {p1, v0, p2}, Lr08;-><init>(Ljava/lang/String;Z)V

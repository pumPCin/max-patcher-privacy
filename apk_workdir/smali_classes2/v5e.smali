...
# direct methods
.method public constructor <init>(Lxc;Liv0;Lku3;Ltb5;La9h;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lv5e;->a:Lxc;

    iput-object p2, p0, Lv5e;->b:Liv0;

    iput-object p4, p0, Lv5e;->c:Ltb5;

    iput-object p5, p0, Lv5e;->d:La9h;
...
.method public final a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lv5e;->a:Lxc;

    invoke-virtual {v5, v3, v4}, Lxc;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, p1, v1}, Lgce;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v3, v4, v5, v1}, Lxsd;-><init>(JLjava/util/List;)V

    const/4 v1, 0x1

    iput-boolean v1, v3, Lxsd;->j:Z

    iput-object p2, v3, Lxsd;->h:Ljava/lang/String;

    iput-object v2, v3, Lxsd;->i:Ljava/util/List;
...
.method public final b(Lru/ok/tamtam/android/util/share/ShareData;Ljava/util/List;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v0, v12, v6, v5}, Lv5e;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v12, v13, v5}, Lv5e;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v14, v6, v5}, Lv5e;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    :cond_6
    invoke-virtual {v0, v14, v13, v5}, Lv5e;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v6, v13, v5}, Lv5e;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    sget-object v15, Lm10;->Z:Lm10;

    iput-object v15, v14, Lr00;->a:Lm10;

    new-instance v15, Li10;

    invoke-direct {v15}, Ljava/lang/Object;-><init>()V

    iput-object v10, v15, Li10;->b:Ljava/lang/String;

    new-instance v13, Li10;

    invoke-direct {v13, v15}, Li10;-><init>(Li10;)V

    iput-object v13, v14, Lr00;->g:Li10;
    ...
    invoke-direct {v14, v6, v7, v10, v13}, Lctd;-><init>(JLjava/lang/String;Lq10;)V

    iput-boolean v12, v14, Lctd;->i:Z
    ...
    invoke-direct {v8, v6, v7}, Lzsd;-><init>(J)V

    iput-object v5, v8, Ltsd;->g:Ljava/lang/String;
    ...
    invoke-static/range {v19 .. v19}, Ld40;->A(Ljava/lang/CharSequence;)Z

    move-result v6

    if-nez v6, :cond_12

    new-instance v16, Lctd;
    ...
    invoke-direct/range {v16 .. v21}, Lctd;-><init>(JLjava/lang/String;ZLjava/util/List;)V
    ...
    invoke-direct {v5, v4}, Lwi0;-><init>(Ljava/lang/String;)V

    iget-object v4, v0, Lv5e;->b:Liv0;
    ...
    invoke-direct {v7, v3, v4, v6, v8}, Lesd;-><init>(JLjava/lang/Object;I)V

    const/4 v3, 0x0

    iput-object v3, v7, Lzsd;->e:Ljava/lang/String;

    new-instance v4, Lbtd;

    invoke-direct {v4, v7}, Lbtd;-><init>(Lesd;)V

    iget-object v6, v0, Lv5e;->d:La9h;

    invoke-virtual {v6, v4}, La9h;->b(Lasd;)V

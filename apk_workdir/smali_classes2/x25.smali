...
.method private getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lx25;->o:Landroid/graphics/Matrix;

    iget-object v1, p0, Lx25;->u0:[F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lx25;->w0:Landroid/graphics/Rect;
    ...
    invoke-interface {v1, p1}, Lq25;->draw(Landroid/graphics/Canvas;)V
...
.method public getResultBounds()Landroid/graphics/Rect;
    ...
    :goto_0
    iget-boolean v1, p0, Lx25;->x0:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lx25;->y0:Lv25;
...
.method public final onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object v2, p0, Lx25;->o:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, v0, v1, p1}, Landroid/graphics/Matrix;->postScale(FFFF)Z

    iget-object v0, p0, Lx25;->s0:Ljava/lang/Float;

    if-eqz v0, :cond_0

    iget-object v3, p0, Lx25;->t0:Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lx25;->r0:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lx25;->s0:Ljava/lang/Float;

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    iput-object p1, p0, Lx25;->t0:Ljava/lang/Float;
...
.method public final onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object p1, p0, Lx25;->c:Lw25;

    if-eqz p1, :cond_1

    check-cast p1, Lt25;

    iget-object v0, p1, Lt25;->c:Ljnb;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Ljnb;->g()Lr9;

    move-result-object v0

    iget-object v1, p1, Lt25;->a:Lx25;

    invoke-virtual {v0, v1}, Lr9;->a(Ls25;)V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p1, Lt25;->c:Ljnb;
...
.method public final onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    iget-object v3, p0, Lx25;->u0:[F

    const/4 p1, 0x0

    iput-object p1, p0, Lx25;->s0:Ljava/lang/Float;

    iput-object p1, p0, Lx25;->t0:Ljava/lang/Float;

    invoke-direct {p0}, Lx25;->getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    invoke-direct {v0, p0, v4, v3, v2}, Lfh;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lx25;->x0:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_3

    iget-object v0, p0, Lx25;->y0:Lv25;
    ...
    :cond_1
    iget-object v0, p0, Lx25;->c:Lw25;

    if-eqz v0, :cond_2

    check-cast v0, Lt25;

    invoke-virtual {v0, p1}, Lt25;->c(Landroid/view/MotionEvent;)V
    ...
    :cond_3
    :goto_0
    iget-object v0, p0, Lx25;->b:Landroid/view/ScaleGestureDetector;
...
.method public setBoundingListener(Lv25;)V
    .locals 0

    iput-object p1, p0, Lx25;->y0:Lv25;
...
.method public setBounds(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Lx25;->w0:Landroid/graphics/Rect;
...
.method public setDrawStickerEnabled(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lx25;->x0:Z

    iget-object v0, p0, Lx25;->y0:Lv25;

    if-eqz v0, :cond_1

    invoke-interface {v0, p1}, Lv25;->setDrawStickerEnabled(Z)V
...
.method public setListener(Lw25;)V
    .locals 0

    iput-object p1, p0, Lx25;->c:Lw25;

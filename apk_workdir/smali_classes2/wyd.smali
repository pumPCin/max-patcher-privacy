...
# instance fields
.field public final X:Lx0d;

.field public final Y:Ljava/util/concurrent/ExecutorService;


# direct methods
.method public constructor <init>(Lx0d;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lrne;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Lwyd;->X:Lx0d;

    iput-object p2, p0, Lwyd;->Y:Ljava/util/concurrent/ExecutorService;
...
.method public final H(Lpoe;I)V
    ...
    invoke-virtual {p1, p2}, Lvyd;->G(Lik6;)V
...
.method public final t(Landroid/view/ViewGroup;I)Lj6d;
    ...
    iget-object v2, p0, Lwyd;->X:Lx0d;

    invoke-direct {p1, v2, p2, v0, v1}, Lvyd;-><init>(Lx0d;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V

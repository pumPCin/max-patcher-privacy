...
.field public static final c:Lbc5;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1}, Lbc5;-><init>(ILjava/lang/Object;)V
...
.method public synthetic constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lh44;->a:Landroid/content/Context;
...
.method public static a(Ljava/io/File;)Ld44;
    .locals 13
    ...
    invoke-static {v1, v2, v4, v3}, Lyxe;->r0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {v0}, Lvpb;->q(Ljava/lang/String;)I
    ...
    invoke-static {p0, v0}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v1}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v2}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    const-string v3, "all_stacktraces"

    invoke-static {p0, v3}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    const-string v7, "all_logs"

    invoke-static {p0, v7}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct/range {v3 .. v12}, Ld44;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public b(ILjava/lang/Throwable;Lh7f;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)Ld44;
    .locals 9
    ...
    :try_start_0
    invoke-static {p2, v1}, Lqxd;->c(Ljava/lang/Throwable;Ljava/lang/Appendable;)V
    :try_end_0
...
.method public c(I[BLh7f;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)Ld44;
    .locals 17
    ...
    iget-object v3, v10, Lh44;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v6, v7, v5}, Lgye;->Z(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v4, v0}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, v3}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_1
    :try_start_0
    invoke-static {v11}, Lq9e;->r(Ljava/io/File;)V

    const-string v0, "stacktrace"

    invoke-static {v11, v0}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v11, v3}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    invoke-static/range {p3 .. p3}, Ltp;->A0(Lh7f;)Lorg/json/JSONObject;
    ...
    invoke-static {v3, v4}, Lqr5;->J(Ljava/io/File;Ljava/lang/String;)V

    const-string v4, "tags"

    invoke-static {v11, v4}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v4, v6}, Lqr5;->J(Ljava/io/File;Ljava/lang/String;)V

    :cond_3
    const-string v6, "all_stacktraces"

    invoke-static {v11, v6}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    sget-object v7, Li82;->a:Ljava/nio/charset/Charset;
    ...
    invoke-static {v15, v13, v5, v8}, Lqxd;->e(Ljava/lang/StackTraceElement;Ljava/lang/Appendable;II)V
    :try_end_4
    ...
    :try_start_7
    invoke-static {v13, v1}, Ly6b;->h(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v11, v7}, Lqr5;->I(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v13, v9, v5}, Ls38;->a(Ljava/io/OutputStream;I)V
    :try_end_8
    ...
    invoke-direct/range {v0 .. v9}, Ld44;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_b
    ...
    :catch_1
    :goto_b
    invoke-static {v11}, Lqr5;->E(Ljava/io/File;)Z

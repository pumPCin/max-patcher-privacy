...
.method public constructor <init>(Lhic;)V
    ...
    iget-object v0, p1, Lhic;->d:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lhic;->b:Lmt0;

    invoke-virtual {p0, p1}, Liic;->c(Lmt0;)V
...
.method public final c(Lmt0;)V
    ...
    iget-object v0, p0, Liic;->a:Lhic;

    iput-object p1, v0, Lhic;->b:Lmt0;
    ...
    iget-object p1, v0, Lhic;->d:Landroid/graphics/drawable/Drawable;
...
.method public final copy()Lc44;
    ...
    invoke-direct {v0, v1}, Liic;-><init>(Lhic;)V
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object v13, v1, Liic;->a:Lhic;

    iget-object v5, v13, Lhic;->e:Ltgc;

    iget-object v6, v13, Lhic;->o:Landroid/graphics/Path;

    iget v14, v13, Lhic;->i:I

    iget v15, v13, Lhic;->f:I

    iget v7, v13, Lhic;->j:I

    iget v8, v13, Lhic;->m:F

    const/16 v16, 0x0

    if-eqz v5, :cond_1

    invoke-virtual {v5}, Ltgc;->getAsInt()I
    ...
    iget-object v10, v1, Liic;->b:Ljava/lang/String;

    const-string v11, "getSegment start&end failed"

    invoke-static {v10, v11, v6}, Lndi;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual/range {p5 .. p12}, Liic;->b(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    :try_start_5
    iget-object v5, v13, Lhic;->r:Landroid/graphics/Path;
    ...
    :cond_17
    :goto_15
    iget-object v3, v13, Lhic;->q:Landroid/graphics/Path;
    ...
    iget-object v5, v13, Lhic;->p:Landroid/graphics/Path;
    ...
    :try_start_8
    iget-object v5, v13, Lhic;->s:Landroid/graphics/Path;
    ...
    invoke-virtual/range {v1 .. v8}, Liic;->b(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    iget-object v3, v13, Lhic;->e:Ltgc;

    if-eqz v3, :cond_1c

    invoke-virtual {v3}, Ltgc;->getAsInt()I
    ...
    :cond_1d
    iget-object v0, v13, Lhic;->d:Landroid/graphics/drawable/Drawable;
...
.method public final updateDrawState(Landroid/text/TextPaint;)V
    ...
    iget-object v1, v0, Lhic;->c:Lpqf;

    iget-object v0, v0, Lhic;->a:Landroid/content/Context;

    const/4 v2, 0x0

    const/16 v3, 0xc

    invoke-static {v1, v0, p1, v2, v3}, Lpqf;->c(Lpqf;Landroid/content/Context;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;I)V

...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lbh;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Ll74;->c(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {v7}, Lfye;->R(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lbh;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lbh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-direct {v3, v1}, Ley0;-><init>(Landroid/content/res/XmlResourceParser;)V

    new-instance v7, Landroid/animation/ObjectAnimator;

    invoke-direct {v7}, Landroid/animation/ObjectAnimator;-><init>()V

    invoke-virtual {v0, v7, v3}, Lbh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lrg;->Y:Lrg;

    iget-object v12, v0, Lbh;->a:Landroid/content/Context;

    invoke-virtual {v11, v12, v3}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v13, Lrg;->w0:Lrg;

    invoke-virtual {v13, v12, v3}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljava/lang/String;

    sget-object v14, Lrg;->x0:Lrg;

    invoke-virtual {v14, v12, v3}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Ljava/lang/String;

    sget-object v15, Lrg;->B0:Lrg;

    invoke-virtual {v15, v12, v3}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lhh;

    instance-of v12, v3, Lfh;

    if-nez v12, :cond_6

    instance-of v3, v3, Lgh;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Lxkg;->l(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    :cond_12
    sget-object v0, Lrg;->Z:Lrg;

    invoke-virtual {v0, v12, v3}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    sget-object v0, Lsg;->o:Lsg;

    iget-object v1, p0, Lbh;->a:Landroid/content/Context;

    invoke-virtual {v0, v1, p2}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v2, Lug;->o:Lug;

    invoke-virtual {v2, v1, p2}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v1, p2}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lhh;

    sget-object v4, Lrg;->B0:Lrg;

    invoke-virtual {v4, v1, p2}, Li9f;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lhh;

    instance-of v1, v2, Lch;
    ...
    :cond_0
    instance-of v1, p2, Lgh;

    if-eqz v1, :cond_2

    new-instance p2, Ldh;

    invoke-direct {p2, v5}, Ldh;-><init>(F)V
    ...
    invoke-direct {p2, v4}, Lch;-><init>(I)V

    :cond_2
    :goto_1
    instance-of v1, p2, Ldh;

    instance-of v6, p2, Lfh;

    const/4 v7, 0x0

    if-eqz v6, :cond_11

    instance-of p2, v2, Lfh;
    ...
    :cond_4
    invoke-static {v1}, Lxkg;->k(Ljava/lang/String;)[Lx6b;
    ...
    iget-object v5, v5, Lfh;->a:Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v5}, Lxkg;->k(Ljava/lang/String;)[Lx6b;
    ...
    invoke-direct {v6}, Lv5c;-><init>()V

    if-eqz v5, :cond_f

    invoke-static {v1, v5}, Lxkg;->e([Lx6b;[Lx6b;)Z
    ...
    iget-object p2, v2, Lfh;->a:Ljava/lang/String;
    ...
    iget-object v7, v3, Lfh;->a:Ljava/lang/String;
    ...
    invoke-static {v0, p2, v1, v7}, Lqe0;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

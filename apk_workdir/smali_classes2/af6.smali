...
# instance fields
.field public final X:Lngd;

.field public volatile Y:Lorg/webrtc/VpxEncoderWrapper;

.field public volatile Z:Lof6;
...
.field public volatile r0:Lof6;

.field public volatile s0:J

.field public final t0:Lduf;

.field public final u0:Lduf;
...
# direct methods
.method public constructor <init>(Lyuc;Lngd;)V
    .locals 4
    ...
    iput-object v0, p0, Laf6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Laf6;->o:Lyuc;

    iput-object p2, p0, Laf6;->X:Lngd;
    ...
    iput-object p1, p0, Laf6;->c:Lp14;

    new-instance p1, Lduf;

    invoke-direct {p1}, Lduf;-><init>()V

    iput-object p1, p0, Laf6;->t0:Lduf;

    new-instance p1, Lduf;

    invoke-direct {p1}, Lduf;-><init>()V

    iput-object p1, p0, Laf6;->u0:Lduf;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Laf6;->w0:Z

    iget-object v0, p0, Laf6;->Y:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Laf6;->Y:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Laf6;->t0:Lduf;
    ...
    iput-wide v2, p0, Laf6;->s0:J

    :cond_0
    iget-object v0, p0, Laf6;->Z:Lof6;

    if-eqz v0, :cond_3

    iget-object v0, p0, Laf6;->Z:Lof6;

    iget-boolean v2, v0, Lof6;->a:Z
    ...
    iput-boolean v1, v0, Lof6;->h:Z

    :cond_2
    iget-object v1, v0, Lof6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Lof6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Lof6;->g:Larh;

    invoke-static {p1}, Lof6;->b(Larh;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Laf6;->r0:Lof6;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Laf6;->x0:J

    iget-wide v7, p0, Laf6;->b:J
    ...
    iget-object v5, v2, Lof6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lof6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Laf6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lyuc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Laf6;->x0:J

    iget-object p1, p0, Laf6;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Laf6;->c:Lp14;

    new-instance v0, Lv55;

    const/16 v3, 0xe

    invoke-direct {v0, p0, v2, v1, v3}, Lv55;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Laf6;->u0:Lduf;

    invoke-virtual {p1}, Lduf;->a()V

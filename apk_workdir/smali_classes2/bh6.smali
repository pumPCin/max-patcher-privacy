...
.method public constructor <init>(Lmj6;)V
    ...
    sget-object v0, Lqa4;->g:Lqa4;

    invoke-direct {p0, v0}, Lpw7;-><init>(Lsx9;)V

    iput-object p1, p0, Lbh6;->X:Lmj6;
...
.method public final r(Lnxc;I)V
    ...
    iget-object v3, v2, Lhi6;->c:Lh18;

    iget-object v4, v1, Lmi6;->M0:Lone/me/sdk/gallery/view/VideoInfoTextView;

    iget-object v5, v3, Lh18;->A0:Lg18;

    sget-object v6, Lg18;->o:Lg18;

    const/4 v7, 0x0

    sget-object v8, Lg18;->c:Lg18;
    ...
    iget-object v3, v3, Lh18;->A0:Lg18;
    ...
    invoke-static {v6, v8, v3}, Lv4b;->o(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v6, v3, v5}, Lo89;-><init>(Landroid/graphics/drawable/Drawable;I)V
    ...
    :cond_6
    :goto_3
    iget-object v3, v1, Lmi6;->L0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    iget-object v6, v2, Lhi6;->g:Landroid/net/Uri;

    iget-object v8, v2, Lhi6;->l:Landroid/net/Uri;

    invoke-static {v8}, Lc67;->d(Landroid/net/Uri;)Lc67;

    move-result-object v8

    iput-boolean v7, v8, Lc67;->h:Z

    sget-object v10, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    iput-object v10, v8, Lc67;->m:Ljava/lang/Boolean;

    iget-object v10, v2, Lhi6;->d:Lo2d;

    iput-object v10, v8, Lc67;->d:Lo2d;

    iget v10, v2, Lhi6;->k:I

    if-eqz v10, :cond_7

    new-instance v11, Llcb;

    invoke-direct {v11, v10, v5}, Llcb;-><init>(II)V

    iput-object v11, v8, Lc67;->k:Lznb;
    ...
    invoke-direct {v10, v4, v6}, Le3b;-><init>(Landroid/content/Context;Landroid/net/Uri;)V

    iput-object v10, v8, Lc67;->k:Lznb;

    :cond_8
    invoke-virtual {v8}, Lc67;->a()Lb67;

    move-result-object v4

    sget v6, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->F0:I

    invoke-virtual {v3, v4, v9}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->o(Lb67;Lb67;)V

    iget-object v3, v1, Lmi6;->K0:Lone/me/sdk/gallery/view/NumericCheckButton;

    if-eqz v3, :cond_a

    iget-boolean v4, v2, Lhi6;->i:Z
    ...
    invoke-direct {v2, v4, v1}, Lt16;-><init>(ILjava/lang/Object;)V

    invoke-static {v3, v2}, Lbv0;->Q(Landroid/view/View;Landroid/view/View$OnClickListener;)V
...
.method public final t(Landroid/view/ViewGroup;I)Lnxc;
    ...
    iget-object v0, p0, Lbh6;->X:Lmj6;

    invoke-direct {p2, p1, v0}, Lmi6;-><init>(Landroid/view/View;Lmj6;)V

...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput v0, p0, Lgsh;->alpha:F

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lgsh;->customParams:Ljava/util/HashMap;

    const-string v0, "precision mediump float;\nuniform mat4 mvpMatrix;\nuniform mat4 texMatrix;\nattribute vec4 aVertexCoord;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n    gl_Position = mvpMatrix * aVertexCoord;\n   vTextureCoord = (texMatrix * aTextureCoord).xy;\n}\n"

    const v1, 0x8b31

    invoke-static {v1, v0}, Ltfi;->c(ILjava/lang/String;)I
    ...
    invoke-static {v1, p1}, Ltfi;->c(ILjava/lang/String;)I
    ...
    iput v0, p0, Lgsh;->aVertexCoordLoc:I

    invoke-static {v0, p1}, Ltfi;->a(ILjava/lang/String;)V
    ...
    iput v2, p0, Lgsh;->aTextureCoordLoc:I

    invoke-static {v2, p1}, Ltfi;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Lgsh;->mvpMatrixLoc:I

    invoke-static {v3, p1}, Ltfi;->a(ILjava/lang/String;)V
    ...
    iput v3, p0, Lgsh;->texMatrixLoc:I
    ...
    iput v3, p0, Lgsh;->textureLocation:I
    ...
    iput v1, p0, Lgsh;->alphaLocation:I

    invoke-static {v3, p1}, Ltfi;->a(ILjava/lang/String;)V

    new-instance p1, Lyrh;

    invoke-direct {p1, v0, v2}, Lyrh;-><init>(II)V

    iput-object p1, p0, Lgsh;->frame:Lyrh;
...
.method public getTextureCoordLoc()I
    ...
    iget v0, p0, Lgsh;->aTextureCoordLoc:I
...
.method public getVertexCoordLoc()I
    ...
    iget v0, p0, Lgsh;->aVertexCoordLoc:I
...
.method public registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lgsh;->firstFreeTexture:I
    ...
    invoke-static {p1}, Ltfi;->b(Ljava/lang/String;)V

    iget p1, p0, Lgsh;->firstFreeTexture:I

    add-int/lit8 p2, p1, 0x1

    iput p2, p0, Lgsh;->firstFreeTexture:I
...
.method public release()V
    ...
    iget-object v0, p0, Lgsh;->frame:Lyrh;

    iget-object v0, v0, Lyrh;->a:Lesh;

    invoke-interface {v0}, Lesh;->a()V

    iget v0, p0, Lgsh;->programId:I
...
.method public render()V
    ...
    invoke-virtual {p0}, Lgsh;->unUse()V
...
.method public setCustomParameter(Ljava/lang/String;F)V
    ...
    .line 2
    iget-object v0, p0, Lgsh;->customParams:Ljava/util/HashMap;
...
.method public setMVPMat([F)V
    ...
    iput-object p1, p0, Lgsh;->mvpMat:[F
...
.method public setTexMat([F)V
    ...
    iput-object p1, p0, Lgsh;->texMat:[F
...
.method public use()V
    ...
    iput v0, p0, Lgsh;->firstFreeTexture:I

    iget-object v1, p0, Lgsh;->mvpMat:[F
    ...
    iput-object v1, p0, Lgsh;->mvpMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_0
    iget-object v1, p0, Lgsh;->texMat:[F

    if-nez v1, :cond_1

    new-array v1, v2, [F

    iput-object v1, p0, Lgsh;->texMat:[F

    invoke-static {v1, v0}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    :cond_1
    iget v1, p0, Lgsh;->programId:I
    ...
    iget v1, p0, Lgsh;->mvpMatrixLoc:I

    iget-object v2, p0, Lgsh;->mvpMat:[F
    ...
    iget v2, p0, Lgsh;->texMatrixLoc:I

    iget-object v4, p0, Lgsh;->texMat:[F

    invoke-static {v2, v3, v0, v4, v0}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v1}, Ltfi;->b(Ljava/lang/String;)V

    iget v0, p0, Lgsh;->textureLocation:I

    invoke-virtual {p0}, Lgsh;->getTarget()I

    move-result v1

    iget v2, p0, Lgsh;->textureId:I

    const-string v3, "textureId"

    invoke-virtual {p0, v1, v2, v3}, Lgsh;->registerTexture(IILjava/lang/String;)I
    ...
    iget v0, p0, Lgsh;->alphaLocation:I

    iget v1, p0, Lgsh;->alpha:F
    ...
    iget-object v3, p0, Lgsh;->customParams:Ljava/util/HashMap;

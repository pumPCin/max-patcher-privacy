...
# direct methods
.method public constructor <init>(ILuxa;)V
    .locals 2
    ...
    iput-object p1, p0, Lpy8;->b:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lpy8;->c:Landroid/graphics/Rect;

    new-instance p1, Llh7;

    invoke-direct {p1}, Llh7;-><init>()V

    iput-object p1, p0, Lpy8;->o:Ljava/lang/Object;

    invoke-virtual {p0, p2}, Lpy8;->onThemeChanged(Luxa;)V
...
.method public static i(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z
    ...
    :cond_2
    invoke-virtual {p1, p0}, Lzce;->l(I)I

    move-result v4

    invoke-virtual {p1, v3}, Lzce;->l(I)I

    move-result p1

    iget-object v5, v2, Lru;->f:Ljava/util/List;

    invoke-static {p0, v5}, Le93;->o0(ILjava/util/List;)Ljava/lang/Object;

    move-result-object p0

    instance-of v5, p0, Ley8;
...
.method public final f(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Ljxc;)V
    ...
    iget-object p3, p4, Ljxc;->b:Landroid/util/SparseArray;
    ...
    iput-object p3, p4, Ljxc;->b:Landroid/util/SparseArray;
    ...
    invoke-static {p2, p3}, Lpy8;->i(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z
    ...
    :cond_5
    iget-object p4, p0, Lpy8;->o:Ljava/lang/Object;
...
.method public g(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Ljxc;)V
    ...
    invoke-virtual {p2, v4}, Landroidx/recyclerview/widget/RecyclerView;->S(Landroid/view/View;)Lnxc;

    move-result-object v6

    instance-of v6, v6, Lqv2;

    if-eqz v6, :cond_5

    iget-object v6, p3, Ljxc;->b:Landroid/util/SparseArray;
    ...
    iget-object v6, p0, Lpy8;->c:Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v4, p0, Lpy8;->b:Landroid/graphics/Paint;
...
.method public h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-static {v1, p2}, Lpy8;->i(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z
    ...
    :cond_1
    iget-object v3, p0, Lpy8;->o:Ljava/lang/Object;
    ...
    iget-object v5, p0, Lpy8;->c:Landroid/graphics/Rect;

    invoke-virtual {v3, v5, v1, v4}, Llh7;->b(Landroid/graphics/Rect;Landroid/view/View;I)V
    ...
    iget-object v11, p0, Lpy8;->b:Landroid/graphics/Paint;
...
.method public final onThemeChanged(Luxa;)V
    ...
    iget-object v0, p0, Lpy8;->b:Landroid/graphics/Paint;

...
.method public final b()V
    ...
    invoke-virtual {p0}, Lr70;->k()Ljava/util/LinkedHashMap;

    move-result-object v0

    invoke-super {p0}, Lh3;->b()V

    invoke-virtual {p0, v0}, Lr70;->m(Ljava/util/LinkedHashMap;)V
...
.method public final k()Ljava/util/LinkedHashMap;
    ...
    :goto_1
    iget-object v2, p0, Lh3;->e:Ljava/lang/String;
...
.method public final l(Landroid/accounts/Account;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v0, p1}, Lh3;->j(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    const-string p1, "auth.token"

    invoke-virtual {p0, p1, p2}, Lh3;->j(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "auth.account.external"

    invoke-virtual {p0, p1, p3}, Lh3;->g(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p1, v0, p3}, Lep7;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p3}, Lr70;->m(Ljava/util/LinkedHashMap;)V

    return-void

    :cond_3
    :goto_0
    iget-object p1, p0, Lh3;->e:Ljava/lang/String;
...
.method public final m(Ljava/util/LinkedHashMap;)V
    ...
    :goto_1
    iget-object v0, p0, Lh3;->e:Ljava/lang/String;

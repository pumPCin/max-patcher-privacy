...
.field public final v0:Lnkg;

.field public final w0:Lnkg;

.field public final x0:Lnkg;
...
.method static constructor <clinit>()V
    ...
    sput-object v3, Lokg;->C0:[Lwq7;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    sput-object v0, Lokg;->D0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lokg;->t0:Ljava/lang/Object;
    ...
    iput v2, p0, Lokg;->u0:I

    new-instance v2, Lnkg;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lnkg;-><init>(Lokg;I)V

    iput-object v2, p0, Lokg;->v0:Lnkg;
    ...
    iput-object v2, p0, Lokg;->w0:Lnkg;
    ...
    iput-object v2, p0, Lokg;->x0:Lnkg;

    new-instance v3, Lwxe;

    const/16 v4, 0x1a

    invoke-direct {v3, v4}, Lwxe;-><init>(I)V

    invoke-static {v1, v3}, Lmbi;->b(ILoh6;)Llt7;

    move-result-object v1

    iput-object v1, p0, Lokg;->A0:Ljava/lang/Object;

    new-instance v1, Lnkg;

    const/4 v3, 0x0

    invoke-direct {v1, p0, v3}, Lnkg;-><init>(Lokg;I)V

    iput-object v1, p0, Lokg;->B0:Lnkg;
    ...
    sget-object v3, Lokg;->D0:Landroid/text/TextPaint;

    invoke-virtual {v3, v1}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    sget-object v1, Lrw2;->d:Lpqf;

    sget-object v4, Lb45;->b:Lb45;

    invoke-virtual {v1, v4}, Lpqf;->e(Lb45;)J

    move-result-wide v4

    invoke-static {v4, v5, p1}, Lgt4;->b(JLandroid/content/Context;)F

    move-result v4

    invoke-virtual {v3, v4}, Landroid/graphics/Paint;->setTextSize(F)V

    iget-wide v4, v1, Lpqf;->e:J
    ...
    iget-object p1, v1, Lpqf;->f:Ljava/lang/String;
    ...
    sget-object p1, Lokg;->C0:[Lwq7;

    const/4 v1, 0x2

    aget-object p1, p1, v1

    iget-object p1, v2, Lqci;->b:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lokg;->getDrawableColor()I

    move-result v0

    invoke-virtual {p1, v0}, Landroid/graphics/drawable/Drawable;->setTint(I)V

    iput-object p1, p0, Lokg;->y0:Landroid/graphics/drawable/Drawable;

    :cond_0
    return-void
.end method

.method public static final synthetic a(Lokg;)I
    .locals 0
...
.method public static final synthetic b(Lokg;)Landroid/text/BoringLayout$Metrics;
    .locals 0

    invoke-direct {p0}, Lokg;->getMetrics()Landroid/text/BoringLayout$Metrics;
...
.method private final getBackgroundColor()I
    ...
    sget-object v0, Lokg;->C0:[Lwq7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lokg;->w0:Lnkg;
...
.method private final getMetrics()Landroid/text/BoringLayout$Metrics;
    ...
    iget-object v0, p0, Lokg;->A0:Ljava/lang/Object;
...
.method private final getText()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lokg;->B0:Lnkg;
...
.method private final setText(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, p0, Lokg;->B0:Lnkg;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lokg;->z0:Landroid/text/Layout;
    ...
    sget-object v3, Lokg;->C0:[Lwq7;

    const/4 v4, 0x0

    aget-object v3, v3, v4

    iget-object v3, p0, Lokg;->v0:Lnkg;
    ...
    iget-object v3, p0, Lokg;->t0:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lokg;->getBackgroundColor()I
    ...
    iget-object p1, p0, Lokg;->y0:Landroid/graphics/drawable/Drawable;
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Lokg;->z0:Landroid/text/Layout;
    ...
    :goto_0
    iget-object v1, p0, Lokg;->y0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget-object v1, Lokg;->C0:[Lwq7;

    aget-object p2, v1, p2

    iget-object p2, p0, Lokg;->v0:Lnkg;
...
.method public final setBackgroundEnabled(Z)V
    ...
    iget-object v1, p0, Lokg;->v0:Lnkg;
...
.method public final setCapsuleInside(Z)V
    ...
    iget-object v1, p0, Lokg;->w0:Lnkg;
...
.method public final setContent(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Lokg;->setText(Ljava/lang/CharSequence;)V
...
.method public final setDrawableEnabled(Z)V
    ...
    iget-object v1, p0, Lokg;->x0:Lnkg;

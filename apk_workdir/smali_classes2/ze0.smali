...
.method public constructor <init>(Llt7;Llt7;)V
    ...
    iput-object p1, p0, Lze0;->a:Llt7;

    iput-object p2, p0, Lze0;->b:Llt7;

    return-void
.end method

.method public static final a(Lze0;[BLgig;)Lrgf;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, v1}, Lrgf;-><init>(Ljava/lang/String;II)V

    iget p1, p2, Lgig;->d:I

    invoke-virtual {p0, p1}, Lrgf;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    iget-boolean v0, p2, Lgig;->e:Z
    ...
    sget-object p2, Liq0;->a:Liq0;

    invoke-static {p2}, Ljq0;->a(Liq0;)Ljava/lang/Object;

    move-result-object p2

    if-eqz p2, :cond_2

    invoke-static {p1, p2}, Lhq0;->a(ILjava/lang/Object;)Landroid/graphics/ColorFilter;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, v1}, Lrgf;->setColorFilter(Landroid/graphics/ColorFilter;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lbfi;->b(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lfig;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Ljf0;)Ljava/util/LinkedHashMap;
    .locals 35
    ...
    sget-object v9, Lz92;->a:Ljava/nio/charset/Charset;
    ...
    new-instance v13, Ljf0;

    invoke-virtual {v9, v2}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v14

    iget-object v15, v10, Lxe0;->a:Ljava/lang/String;
    ...
    invoke-direct {v13, v2}, Ljf0;-><init>(Ljava/lang/String;)V

    sget-object v2, Lsz4;->t0:Lc82;

    move-object/from16 v14, p1

    invoke-virtual {v2, v14}, Lc82;->c(Landroid/content/Context;)Lsz4;

    move-result-object v2

    iget-object v2, v2, Lsz4;->X:Ljava/lang/Object;

    check-cast v2, Lw4b;

    iget-object v2, v2, Lw4b;->b:Ljava/util/Map;
    ...
    :goto_3
    invoke-static {v2, v12}, Lc0i;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-boolean v2, v10, Lxe0;->b:Z

    invoke-virtual {v15, v2}, Lcva;->a(Z)Lu4b;
    ...
    :try_start_2
    invoke-virtual {v0, v13}, Ljf0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v9, v6}, Lz8i;->a(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/Boolean;

    move-result-object v6

    if-eqz v15, :cond_b

    new-instance v20, Lgig;
    ...
    invoke-direct/range {v20 .. v26}, Lgig;-><init>(Ljava/lang/String;IIIZI)V
    ...
    invoke-direct {v12, v7, v0}, Leig;-><init>([IF)V
    ...
    invoke-static {v4, v0}, Lze0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v0}, Lze0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v6, v0}, Lc0i;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    new-instance v20, Lhig;

    invoke-direct/range {v20 .. v25}, Lhig;-><init>(Lgig;Leig;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Lgig;Llff;)Ljava/lang/Object;
    .locals 3

    iget-object v0, p0, Lze0;->a:Llt7;
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lye0;-><init>(Lze0;Landroid/content/Context;Lgig;Lkotlin/coroutines/Continuation;)V

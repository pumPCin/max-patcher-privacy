...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Ldl0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v2}, Lkse;->setValue(F)V
    ...
    iput v0, p0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->I1:I

    new-array v0, v1, [F

    iput-object v0, p0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->J1:[F

    const/4 v0, 0x1

    iput-boolean v0, p0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->K1:Z
    ...
    sget v6, Lfvc;->Slider_tickColor:I
    ...
    sget v7, Lfvc;->Slider_tickColor:I

    goto :goto_0

    :cond_1
    sget v7, Lfvc;->Slider_tickColorInactive:I
    ...
    :cond_2
    sget v6, Lfvc;->Slider_tickColorActive:I
    ...
    sget-object v0, Lhvc;->SliderWithCustomTicks:[I

    invoke-virtual {p1, p2, v0, v1, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lhvc;->SliderWithCustomTicks_tickRadius:I
    ...
    sget p2, Lhvc;->SliderWithCustomTicks_normalValue:I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-super/range {p0 .. p1}, Ldl0;->onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    invoke-virtual {v0}, Lkse;->getStepSize()F
    ...
    :cond_1
    invoke-virtual {v0}, Lkse;->getValueTo()F

    move-result v2

    invoke-virtual {v0}, Lkse;->getValueFrom()F
    ...
    invoke-virtual {v0}, Lkse;->getTrackWidth()I

    move-result v6

    invoke-virtual {v0}, Lkse;->getTrackHeight()I
    ...
    invoke-virtual {v0}, Lkse;->getTrackSidePadding()I
    ...
    :cond_3
    iput-boolean v4, v0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->K1:Z
    ...
    :cond_4
    invoke-virtual {v0}, Lkse;->getValue()F
    ...
    iget v3, v0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->P1:F
    ...
    iget-object v9, v0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->L1:Landroid/graphics/Paint;

    iget-object v10, v0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->M1:Landroid/graphics/Paint;
    ...
    invoke-virtual {v0}, Lkse;->getThumbRadius()I
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Ldl0;->onSizeChanged(IIII)V
...
.method public setBackgroundColor(I)V
    ...
    iget-object v0, p0, Lru/ok/messages/settings/view/SliderWithCustomTicks;->N1:Landroid/graphics/Paint;
...
.method public setStepSize(F)V
    ...
    invoke-super {p0, p1}, Lkse;->setStepSize(F)V
...
.method public setValueFrom(F)V
    ...
    invoke-super {p0, p1}, Lkse;->setValueFrom(F)V
...
.method public setValueTo(F)V
    ...
    invoke-super {p0, p1}, Lkse;->setValueTo(F)V

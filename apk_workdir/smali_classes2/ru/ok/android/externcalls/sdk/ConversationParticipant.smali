...
.method public static fromExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lyg1;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setInternalId(Lyg1;)V

    :cond_0
    return-object v0
.end method

.method public static fromInternal(Lyg1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lyg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
# virtual methods
.method public deAnonymize(Lch1;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lch1;
...
.method public getAcceptCallEpochMs()J
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lch1;

    if-eqz v0, :cond_0

    iget-wide v0, v0, Lch1;->m:J
...
.method public getAcceptedCallClientType()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Lch1;->k:Ljava/lang/String;
...
.method public getAcceptedCallPlatform()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Lch1;->l:Ljava/lang/String;

    return-object v0
.end method

.method public getAudioOptionState()Lin8;
    .locals 1
...
.method public getCallParticipant()Lch1;
    .locals 1
...
.method public getInternalId()Lyg1;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lyg1;
...
.method public getMovies()Ljava/util/List;
    ...
    :cond_0
    iget-object v0, v0, Lch1;->q:Ljava/util/List;

    return-object v0
.end method

.method public getNetworkStatus()Lhx9;
    .locals 1
    ...
    :cond_0
    iget-object v0, v0, Lch1;->i:Lhx9;

    return-object v0
.end method

.method public getScreenshareOptionState()Lin8;
    .locals 1
...
.method public getVideoOptionState()Lin8;
    .locals 1
...
.method public getWatchTogetherOptionState()Lin8;
    .locals 1
...
.method public hasRegisteredPeers()Z
    ...
    iget-object v0, v0, Lch1;->f:Ljava/util/HashMap;
...
.method public setCallParticipant(Lch1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lyg1;
...
.method public setDeviceIndex(ILru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    iget-wide v2, v0, Lyg1;->a:J

    iget v0, v0, Lyg1;->b:I

    invoke-direct {v1, v0, p1, v2, v3}, Lyg1;-><init>(IIJ)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lyg1;
    ...
    iget-wide v3, v1, Lyg1;->a:J

    iget v1, v1, Lyg1;->b:I

    invoke-direct {v2, v1, p1, v3, v4}, Lyg1;-><init>(IIJ)V

    iput-object v2, v0, Lch1;->a:Lyg1;

    iget-object v1, v0, Lch1;->p:Lr61;

    if-eqz v1, :cond_3

    new-instance v2, Lr61;

    iget-object v3, v1, Lr61;->a:Ljava/lang/String;

    iget v1, v1, Lr61;->b:I

    invoke-direct {v2, v3, v1, p1}, Lr61;-><init>(Ljava/lang/String;II)V

    iput-object v2, v0, Lch1;->p:Lr61;
...
.method public setInternalId(Lyg1;)V
    .locals 1
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lyg1;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lch1;

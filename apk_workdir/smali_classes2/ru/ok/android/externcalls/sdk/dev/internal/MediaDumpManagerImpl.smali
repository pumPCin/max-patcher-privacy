...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "signalingProvider",
        "<init>",
        "(Lyz0;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V",
        "",
        "path",
        "Lzag;",
...
# direct methods
.method public constructor <init>(Lyz0;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;->call:Lyz0;
...
.method public cancelAudioDumpRecord()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;->call:Lyz0;

    iget-object v1, v0, Lyz0;->c:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lbz0;

    const/4 v3, 0x1

    invoke-direct {v2, v0, v3}, Lbz0;-><init>(Lyz0;I)V
...
.method public recordAudioDump(ILjava/util/Set;Lru/ok/android/externcalls/sdk/dev/MediaDumpManager$LocalAudioDumpRecordListener;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v5, p0, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;->call:Lyz0;
    ...
    iget-object p2, v5, Lyz0;->c:Ljava/util/concurrent/ExecutorService;
...
.method public requestMediaDump(IZZLru/ok/android/externcalls/sdk/dev/MediaDumpManager$RemoteMediaDumpRequestListener;)V
    ...
    invoke-static {v1, p1}, Lazi;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lrm6;
    ...
    invoke-direct {p2, p3, p4}, Lsz0;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, p1, p2}, Ljme;->h(Lrm6;Lgme;)V

...
.method private constructor <init>(Landroid/content/Context;Lyuc;)V
    .locals 1
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lyuc;
...
.method private declared-synchronized ensureMappingNotOutdated(Lzh1;)V
    .locals 1
...
.method public static get(Landroid/content/Context;Lyuc;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;-><init>(Landroid/content/Context;Lyuc;)V
...
.method private getFile(Z)Ljava/io/File;
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lyuc;
...
.method private declared-synchronized read()V
    ...
    :catch_0
    :try_start_4
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lyuc;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lyuc;

    const-string v1, "IdMappingWrapper"

    const-string v3, "empty mapping"

    invoke-interface {v0, v1, v3}, Lyuc;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
...
.method private declared-synchronized write()V
    ...
    invoke-virtual {v3}, Lzh1;->b()Ljava/lang/String;
...
# virtual methods
.method public declared-synchronized addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lzh1;)V
    .locals 2
...
.method public declared-synchronized getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lzh1;
    .locals 1
...
.method public declared-synchronized getByInternal(Lzh1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .locals 1
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->ensureMappingNotOutdated(Lzh1;)V
...
.method public scheduleReadCacheFromDisk()V
    ...
    invoke-direct {v1, p0, v2}, Ln77;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;I)V

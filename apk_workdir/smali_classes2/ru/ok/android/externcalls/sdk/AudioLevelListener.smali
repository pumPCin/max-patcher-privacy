...
.field private final noise:La5h;
...
.method public constructor <init>(SLandroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    iput-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:La5h;
...
.method public onSample(IIILk2b;)V
    ...
    invoke-virtual {p4, p2}, Lk2b;->a(I)S
    ...
    :goto_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:La5h;
    ...
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:La5h;

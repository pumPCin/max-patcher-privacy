...
.field private final noise:Ltkh;
...
.method public constructor <init>(SLandroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    iput-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ltkh;
...
.method public onSample(IIILsab;)V
    ...
    invoke-virtual {p4, p2}, Lsab;->a(I)S
    ...
    :goto_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ltkh;
    ...
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/AudioLevelListener;->noise:Ltkh;

...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ltb5;Ljava/lang/String;Ljava/lang/String;FFLr6c;ZLw9h;)V
    .locals 1
    ...
    iput-boolean v0, p0, Ls7g;->j:Z

    iput-boolean v0, p0, Ls7g;->k:Z

    iput-boolean v0, p0, Ls7g;->l:Z

    iput-boolean v0, p0, Ls7g;->m:Z

    iput-boolean v0, p0, Ls7g;->n:Z

    iput-object p1, p0, Ls7g;->o:Landroid/content/Context;

    iput-object p2, p0, Ls7g;->p:Ltb5;

    iput-object p3, p0, Ls7g;->q:Ljava/lang/String;

    iput-object p4, p0, Ls7g;->r:Ljava/lang/String;

    iput p5, p0, Ls7g;->s:F

    iput p6, p0, Ls7g;->t:F

    iput-object p7, p0, Ls7g;->u:Lr6c;

    iput-boolean p8, p0, Ls7g;->v:Z

    iput-object p9, p0, Ls7g;->w:Lw9h;

    return-void
.end method

.method public static a(Landroid/content/Context;Ltb5;Ljava/lang/String;Ljava/lang/String;FFLr6c;ZLw9h;)Z
    .locals 13
    ...
    invoke-direct/range {v1 .. v10}, Ls7g;-><init>(Landroid/content/Context;Ltb5;Ljava/lang/String;Ljava/lang/String;FFLr6c;ZLw9h;)V
    ...
    invoke-static {p1, p2, p0}, Lyt3;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object p0, v1, Ls7g;->h:Ltsb;

    if-eqz p0, :cond_0

    iget-object p0, p0, Ltsb;->a:Ljava/lang/Object;
    ...
    :cond_1
    iget-object p0, v1, Ls7g;->b:Landroid/media/MediaExtractor;
    ...
    :cond_2
    iget-object p0, v1, Ls7g;->c:Lts9;

    if-eqz p0, :cond_3

    iget-object p0, p0, Lts9;->f:Ljava/lang/Object;
    ...
    :cond_3
    iget-object p0, v1, Ls7g;->i:Lhpd;

    if-eqz p0, :cond_4

    iget-object p1, p0, Lhpd;->X:Ljava/lang/Object;

    check-cast p1, Landroid/view/Surface;

    if-eqz p1, :cond_4

    invoke-virtual {p0}, Lhpd;->u()V

    :cond_4
    iget-object p0, v1, Ls7g;->g:Ln1b;

    if-eqz p0, :cond_23

    iget-object p1, p0, Ln1b;->b:Landroid/view/Surface;
    ...
    iget-object v0, v1, Ls7g;->b:Landroid/media/MediaExtractor;
    ...
    iget-boolean v6, v1, Ls7g;->n:Z

    if-eqz v6, :cond_8

    iget-boolean v6, v1, Ls7g;->m:Z
    ...
    iget-object v0, v1, Ls7g;->f:Lqd;

    iget-object v2, v1, Ls7g;->b:Landroid/media/MediaExtractor;
    ...
    iget-wide v5, v1, Ls7g;->x:J

    cmp-long v0, v3, v5

    if-lez v0, :cond_e

    iget-object v0, v1, Ls7g;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Ls7g;->b:Landroid/media/MediaExtractor;

    iget-object v4, v1, Ls7g;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Ls7g;->c:Lts9;

    iget-object v4, v1, Ls7g;->a:Ljava/nio/ByteBuffer;

    iget-object v5, v3, Lts9;->f:Ljava/lang/Object;

    check-cast v5, Landroid/media/MediaMuxer;

    invoke-virtual {v3}, Lts9;->b()Z

    move-result v6

    if-eqz v6, :cond_c

    iget-boolean v6, v3, Lts9;->c:Z

    if-nez v6, :cond_b

    invoke-virtual {v5}, Landroid/media/MediaMuxer;->start()V

    iput-boolean v2, v3, Lts9;->c:Z

    :cond_b
    invoke-virtual {v3}, Lts9;->a()V
    ...
    :cond_c
    iget-object v5, v3, Lts9;->g:Ljava/lang/Object;
    ...
    invoke-direct {v6, v3, v4, v0}, Lss9;-><init>(ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    :cond_13
    :goto_5
    iget-boolean v0, v1, Ls7g;->k:Z

    if-nez v0, :cond_14

    iget-object v0, v1, Ls7g;->f:Lqd;

    invoke-virtual {v0}, Lqd;->k()V
    ...
    iget-object p2, p0, Lhpd;->X:Ljava/lang/Object;
    ...
    iget-object p2, p0, Ln1b;->b:Landroid/view/Surface;
    ...
    invoke-static {p1, p0}, Lyt3;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1c
    invoke-static {p1, v3, p0}, Lyt3;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p0, v0}, Lyt3;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, v1, Ls7g;->p:Ltb5;
    ...
    invoke-virtual {p0, p1}, Lsla;->c(Ljava/lang/Throwable;)V
    :try_end_3
    ...
    :goto_8
    iget-object p1, v1, Ls7g;->h:Ltsb;

    if-eqz p1, :cond_25

    iget-object p1, p1, Ltsb;->a:Ljava/lang/Object;
    ...
    :cond_26
    iget-object p1, v1, Ls7g;->b:Landroid/media/MediaExtractor;
    ...
    :cond_27
    iget-object p1, v1, Ls7g;->c:Lts9;

    if-eqz p1, :cond_28

    iget-object p1, p1, Lts9;->f:Ljava/lang/Object;
    ...
    :cond_28
    iget-object p1, v1, Ls7g;->i:Lhpd;

    if-eqz p1, :cond_29

    iget-object p2, p1, Lhpd;->X:Ljava/lang/Object;

    check-cast p2, Landroid/view/Surface;

    if-eqz p2, :cond_29

    invoke-virtual {p1}, Lhpd;->u()V

    :cond_29
    iget-object p1, v1, Ls7g;->g:Ln1b;

    if-eqz p1, :cond_2a

    iget-object p2, p1, Ln1b;->b:Landroid/view/Surface;
...
.method public final b()Z
    ...
    iput-object v2, v0, Ls7g;->a:Ljava/nio/ByteBuffer;

    new-instance v2, Landroid/media/MediaExtractor;

    invoke-direct {v2}, Landroid/media/MediaExtractor;-><init>()V

    iput-object v2, v0, Ls7g;->b:Landroid/media/MediaExtractor;

    iget-object v3, v0, Ls7g;->q:Ljava/lang/String;

    invoke-static {v3}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v3

    iget-object v4, v0, Ls7g;->o:Landroid/content/Context;
    ...
    iget-object v3, v0, Ls7g;->r:Ljava/lang/String;
    ...
    iput-boolean v4, v2, Lts9;->d:Z

    iput-boolean v4, v2, Lts9;->e:Z

    new-instance v7, Ljava/util/ArrayList;

    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    iput-object v7, v2, Lts9;->g:Ljava/lang/Object;

    new-instance v7, Landroid/media/MediaMuxer;

    invoke-direct {v7, v3, v4}, Landroid/media/MediaMuxer;-><init>(Ljava/lang/String;I)V

    iput-object v7, v2, Lts9;->f:Ljava/lang/Object;

    iput-object v2, v0, Ls7g;->c:Lts9;

    iget-object v2, v0, Ls7g;->b:Landroid/media/MediaExtractor;
    ...
    iget-object v8, v0, Ls7g;->b:Landroid/media/MediaExtractor;
    ...
    const-string v10, "s7g"

    invoke-static {v10, v9}, Lyt3;->j(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v8}, Landroid/media/MediaFormat;->toString()Ljava/lang/String;

    move-result-object v11

    invoke-static {v10, v11}, Lyt3;->j(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v10, v0, Ls7g;->b:Landroid/media/MediaExtractor;
    ...
    iget v11, v0, Ls7g;->s:F

    mul-float/2addr v11, v10

    float-to-long v11, v11

    iput-wide v11, v0, Ls7g;->x:J

    iget v11, v0, Ls7g;->t:F

    mul-float/2addr v10, v11

    float-to-long v10, v10

    iput-wide v10, v0, Ls7g;->y:J

    iget-object v10, v0, Ls7g;->u:Lr6c;

    iget v11, v10, Lr6c;->b:I

    iget v12, v10, Lr6c;->c:I
    ...
    :goto_2
    new-instance v14, Ltsb;

    iget v10, v10, Lr6c;->d:I

    invoke-direct {v14}, Ljava/lang/Object;-><init>()V

    iput-object v0, v14, Ltsb;->b:Ljava/lang/Object;
    ...
    iput-object v10, v14, Ltsb;->a:Ljava/lang/Object;
    ...
    iget-object v11, v10, Lhpd;->b:Ljava/lang/Object;
    ...
    iget-object v12, v10, Lhpd;->b:Ljava/lang/Object;
    ...
    iput-object v11, v10, Lhpd;->c:Ljava/lang/Object;

    const-string v11, "eglCreateContext"

    invoke-static {v11}, Lhpd;->d(Ljava/lang/String;)V

    iget-object v11, v10, Lhpd;->c:Ljava/lang/Object;
    ...
    iget-object v14, v10, Lhpd;->X:Ljava/lang/Object;
    ...
    iput-object v11, v10, Lhpd;->o:Ljava/lang/Object;

    const-string v11, "eglCreateWindowSurface"

    invoke-static {v11}, Lhpd;->d(Ljava/lang/String;)V

    iget-object v11, v10, Lhpd;->o:Ljava/lang/Object;

    check-cast v11, Landroid/opengl/EGLSurface;

    if-eqz v11, :cond_3

    iput-object v10, v0, Ls7g;->i:Lhpd;

    iget-object v12, v10, Lhpd;->b:Ljava/lang/Object;

    check-cast v12, Landroid/opengl/EGLDisplay;

    iget-object v10, v10, Lhpd;->c:Ljava/lang/Object;
    ...
    invoke-direct {v10}, Ln1b;-><init>()V

    iput-object v10, v0, Ls7g;->g:Ln1b;

    new-instance v10, Lqd;

    iget-object v11, v0, Ls7g;->g:Ln1b;

    invoke-direct {v10, v9, v8, v11, v0}, Lqd;-><init>(Ljava/lang/String;Landroid/media/MediaFormat;Ln1b;Ls7g;)V

    iput-object v10, v0, Ls7g;->f:Lqd;

    iget-object v8, v0, Ls7g;->c:Lts9;

    iput-boolean v7, v8, Lts9;->d:Z
    ...
    :cond_6
    iput-object v5, v10, Lhpd;->b:Ljava/lang/Object;
    ...
    iget-boolean v9, v0, Ls7g;->v:Z

    if-eqz v9, :cond_9

    iget-object v8, v0, Ls7g;->c:Lts9;

    iput-boolean v4, v8, Lts9;->e:Z

    goto :goto_3

    :cond_9
    iget-object v9, v0, Ls7g;->c:Lts9;

    iput-boolean v7, v9, Lts9;->e:Z

    iget-object v10, v9, Lts9;->f:Ljava/lang/Object;

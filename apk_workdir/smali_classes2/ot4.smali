...
.method public a(Lyid;Lijd;)V
    ...
    iget-object p1, p0, Lot4;->b:Lpt4;

    iget-object p1, p1, Lpt4;->a:Lfwc;
    ...
    :pswitch_0
    iget-object p1, p2, Lxdg;->a:Ljava/util/Map;
    ...
    iget-object p2, p1, Lpt4;->a:Lfwc;

    const-string v0, "DisplayLayouts"

    const-string v1, "Resend next time after response with errors"

    invoke-interface {p2, v0, v1}, Lfwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p2, 0x1

    iput-boolean p2, p1, Lpt4;->e:Z
...
.method public b(Lyid;Ljava/lang/Throwable;)V
    .locals 2

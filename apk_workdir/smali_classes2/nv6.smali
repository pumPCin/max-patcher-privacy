...
# direct methods
.method public static c(Ljava/nio/ByteBuffer;Liwf;Lq34;)Ljava/util/ArrayList;
    .locals 20
    ...
    sget-object v11, Lhwf;->b:Lhwf;

    iget-short v11, v11, Lhwf;->a:S
    ...
    invoke-virtual {v7, v0, v11, v6}, Lpj5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-direct {v6, v7, v0}, Ljec;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    :cond_8
    sget-object v11, Lhwf;->o:Lhwf;

    iget-short v14, v11, Lhwf;->a:S
    ...
    iput-object v12, v8, Lnne;->a:Ljava/util/List;

    iget-short v11, v11, Lhwf;->a:S

    invoke-virtual {v8, v0, v11, v7}, Lpj5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    new-instance v13, La83;

    const/4 v14, 0x4

    invoke-direct {v13, v7, v14}, La83;-><init>(II)V
    ...
    :cond_d
    sget-object v11, Lhwf;->Y:Lhwf;

    iget-short v14, v11, Lhwf;->a:S

    if-ne v8, v14, :cond_1e

    sget-object v6, Liwf;->c:Liwf;
    ...
    invoke-virtual {v6, v0, v14, v4}, Lpj5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0, v11, v12}, Lpj5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    iput-object v12, v6, Lf83;->a:Ljava/util/List;
    ...
    iget-object v7, v6, Lf83;->a:Ljava/util/List;
    ...
    invoke-direct {v4, v8, v9, v15}, Le83;-><init>(J[B)V
    ...
    iput-object v4, v6, Lf83;->b:Ljava/util/ArrayList;
    ...
    iget-object v9, v6, Lf83;->b:Ljava/util/ArrayList;

    new-instance v12, Ld83;

    invoke-direct {v12, v8}, Ld83;-><init>([B)V
    ...
    iget-object v4, v6, Lf83;->a:Ljava/util/List;

    invoke-interface {v4}, Ljava/util/List;->size()I

    move-result v4

    iget-object v7, v6, Lf83;->b:Ljava/util/ArrayList;
    ...
    invoke-static {}, Liwf;->values()[Liwf;
    ...
    invoke-virtual {v7, v0, v4, v6}, Lpj5;->b(Ljava/nio/ByteBuffer;II)I

    move-result v4

    sget-object v6, Liwf;->o:Liwf;
    ...
    iput-object v4, v7, Lo45;->a:Ljava/lang/Long;
    ...
    invoke-direct {v4, v0, v1}, Lhef;-><init>(Ljava/nio/ByteBuffer;Liwf;)V
    ...
    invoke-direct {v4, v6, v0}, Ljec;-><init>(ILjava/nio/ByteBuffer;)V
    ...
    invoke-direct {v4, v0}, Ly52;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :cond_25
    sget-object v4, Lhwf;->u0:Lhwf;

    iget-short v6, v4, Lhwf;->a:S
    ...
    iput-object v7, v6, Lhr7;->b:Ljava/util/ArrayList;

    iget-short v4, v4, Lhwf;->a:S

    const/4 v7, 0x1

    invoke-virtual {v6, v0, v4, v7}, Lpj5;->b(Ljava/nio/ByteBuffer;II)I
    ...
    invoke-virtual {v6, v0}, Lhr7;->d(Ljava/nio/ByteBuffer;)I
    ...
    iget-object v4, v2, Lq34;->b:Ljava/lang/Object;
    ...
    iget-object v6, v4, Lg84;->a:Lx6e;

    iget-object v6, v6, Lx6e;->b:Ljava/lang/Object;

    check-cast v6, Lgjg;

    invoke-direct {v13, v6}, Lahc;-><init>(Lgjg;)V

    iget-object v4, v4, Lg84;->f:Lt88;
    ...
    invoke-interface {v4, v12}, Lt88;->debug(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v13, v0, v11, v4}, Lahc;->e(Ljava/nio/ByteBuffer;Ljava/util/HashSet;Lt88;)V
    :try_end_0
    ...
    invoke-static {v4}, Ls88;->a(Ljava/lang/String;)V
...
.method public abstract b()Liwf;
.end method

.method public final d(Ljava/nio/ByteBuffer;Liwf;I)I
    .locals 3

...
# direct methods
.method public constructor <init>(Lmha;Lorg/webrtc/CameraVideoCapturer;Lmmf;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLfwc;)V
    .locals 4
    ...
    iput-object v2, p0, Li02;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Li02;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Li02;->h:Ljava/lang/String;

    iput-object p7, p0, Li02;->e:Lfwc;

    check-cast p1, Lyt1;

    new-instance p7, Ltvi;

    new-instance v2, Lseb;

    new-instance v3, Lm22;

    iget-object p1, p1, Lyt1;->a:Lfwc;

    invoke-direct {v3, p1}, Lm22;-><init>(Lfwc;)V

    invoke-direct {v2, p2, v3, p1}, Lseb;-><init>(Lorg/webrtc/CameraVideoCapturer;Lm22;Lfwc;)V

    invoke-direct {p7, v2}, Ltvi;-><init>(Ljava/lang/Object;)V

    iput-object p7, p0, Li02;->c:Ltvi;

    iput-object p3, p0, Li02;->d:Lmmf;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Li02;->i:Z
...
.method public final a()V
    ...
    iget-object v2, p0, Li02;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Li02;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v3}, Lv47;-><init>(I)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lzb3;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Lfwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Li57;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Li02;->e:Lfwc;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Lfwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Li02;->e:Lfwc;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Ley1;->k(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Lfwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Li02;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lw68;->r:Li02;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lw68;->n:Lfwc;
    ...
    invoke-interface {v8, v10, v11, v9}, Lfwc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lw68;->y:Llwg;

    iget-object v8, v7, Lhr3;->c:Ljava/lang/Object;
    ...
    invoke-static {v10, v2, v0, v5}, Li57;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Lfwc;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Llwg;->k:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Llwg;->u()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Li02;->k:Z
    ...
    iget-object v4, p0, Li02;->c:Ltvi;

    iget-object v4, v4, Ltvi;->a:Ljava/lang/Object;

    check-cast v4, Lseb;

    invoke-virtual {v4, v2, v0, v3}, Lseb;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lseb;->startCapture(III)V
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lseb;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Li02;->k:Z
    :try_end_0

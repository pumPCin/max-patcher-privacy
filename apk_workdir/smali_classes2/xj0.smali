...
.method private final a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v7, v2}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v2, v7}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v7, v6}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v8, v7}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v9, v7}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v9, v4}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v7, v4}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v4, v6}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v11, v7}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v4, v3}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v2, v5}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_2c
    invoke-direct {v0, v1}, Lx85;-><init>(Ljava/util/List;)V

    sput-object v0, Lfs4;->a:Lx85;
    ...
    invoke-static {v0}, Lx85;->J(Lx85;)Ljava/lang/String;
...
.method private final b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0}, Lg58;->d()Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, p1, Lg1a;->u0:Lhd;

    const-string v2, "LOCAL_MEDIA_CROP"

    invoke-virtual {v0, v2}, Lhd;->f(Ljava/lang/String;)V

    iget-object v0, p1, Lg1a;->w0:Lat5;

    const-string v2, "jpg"

    invoke-interface {v0, v2}, Lat5;->a(Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    iget-object v2, p1, Lg1a;->X:Lg58;

    invoke-virtual {v2}, Lg58;->a()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p1, Lg1a;->t0:Lvjb;
    ...
    iget-object v3, v3, Lvjb;->a:Landroid/net/Uri;
    ...
    iget-object v4, v3, Lvjb;->X:Landroid/net/Uri;
    ...
    iget-object v1, p1, Lg1a;->x0:Lwoe;
    ...
    invoke-direct {v1, p1, v2, v0}, Lka9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v0, Lc1a;

    const/4 v2, 0x0

    invoke-direct {v0, p1, v2}, Lc1a;-><init>(Lg1a;I)V

    new-instance p1, Lvt1;

    const/4 v2, 0x2

    invoke-direct {p1, v1, v2, v0}, Lvt1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :try_start_1
    invoke-interface {v3, v0}, Lnpe;->j(Luoe;)V
    :try_end_1
    ...
    :cond_9
    iget-object p1, p1, Lg1a;->c:Lru/ok/messages/media/mediabar/ActLocalMedias;

    invoke-virtual {p1, v2, v0, v6}, Lru/ok/messages/media/mediabar/ActLocalMedias;->e0(Landroid/net/Uri;Ljava/io/File;Ly64;)V
...
.method private final c(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lg1a;->t0:Lvjb;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v3, v0, Lvjb;->o:Lt55;
    ...
    :goto_0
    iget-object v4, p1, Lg1a;->X:Lg58;

    if-eqz v0, :cond_2

    iget-object v5, v0, Lvjb;->X:Landroid/net/Uri;
    ...
    :cond_2
    :goto_1
    invoke-static {v0, v4}, Lvjb;->a(Lvjb;Lg58;)Landroid/net/Uri;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v2, v1, Lg1a;->s0:Lwlg;

    iget-boolean v3, v2, Lwlg;->d:Z

    xor-int/lit8 v4, v3, 0x1

    invoke-virtual {v2}, Lwlg;->a()Lb20;

    move-result-object v2

    iput-boolean v4, v2, Lb20;->d:Z

    new-instance v5, Lwlg;

    invoke-direct {v5, v2}, Lwlg;-><init>(Lb20;)V

    iput-object v5, v1, Lg1a;->s0:Lwlg;

    invoke-virtual {v1}, Lg1a;->V0()V

    new-instance v2, Ld1a;

    invoke-direct {v2, v4}, Ld1a;-><init>(Z)V

    invoke-virtual {v1, v2}, Lg1a;->W0(Lpi6;)V

    iget-object v2, v1, Lg1a;->c:Lru/ok/messages/media/mediabar/ActLocalMedias;

    invoke-virtual {v2, v3, v13}, Lru/ok/messages/media/mediabar/ActLocalMedias;->a0(ZZ)V

    iget-object v1, v1, Lg1a;->u0:Lhd;
    ...
    :pswitch_0
    invoke-direct/range {p0 .. p1}, Lxj0;->c(Ljava/lang/Object;)V
    ...
    iget-object v3, v1, Lg1a;->X:Lg58;

    iget-object v3, v3, Lg58;->c:Ljava/lang/String;

    iget-object v4, v1, Lg1a;->s0:Lwlg;

    iget v5, v4, Lwlg;->b:F

    iget-wide v6, v1, Lg1a;->r0:J
    ...
    :pswitch_3
    invoke-direct/range {p0 .. p1}, Lxj0;->b(Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Lg1a;->c:Lru/ok/messages/media/mediabar/ActLocalMedias;
    ...
    iget-object v2, v1, Lg1a;->y0:Lye5;
    ...
    :cond_2
    iget-object v3, v1, Lg1a;->o:Ld68;

    iget-boolean v3, v3, Ld68;->a:Z
    ...
    :cond_3
    iget-object v3, v1, Lg1a;->B0:Lvt1;

    invoke-static {v3}, Lkjd;->c(Lev4;)Z
    ...
    :cond_4
    iget-object v3, v1, Lg1a;->s0:Lwlg;
    ...
    invoke-virtual {v2, v1}, Lvta;->c(Ljava/lang/Throwable;)V

    goto/16 :goto_2

    :cond_5
    iget-object v3, v1, Lg1a;->Z:Ljava/util/ArrayList;
    ...
    new-instance v14, Lggc;

    iget-object v15, v5, Lggc;->a:Legc;
    ...
    invoke-direct/range {v14 .. v21}, Lggc;-><init>(Legc;IIIJZ)V
    ...
    :cond_7
    iget-object v3, v1, Lg1a;->c:Lru/ok/messages/media/mediabar/ActLocalMedias;

    iget-object v1, v1, Lg1a;->s0:Lwlg;

    iget-object v1, v1, Lwlg;->a:Legc;
    ...
    sget-object v5, Lggc;->g:Lqy4;

    invoke-static {v5, v2}, Lfb3;->n(Ljava/util/Comparator;Ljava/util/List;)V

    new-instance v5, Ljava/util/ArrayList;

    const/16 v6, 0xa

    invoke-static {v2, v6}, Lcb3;->l(Ljava/lang/Iterable;I)I
    ...
    invoke-direct {v7, v6}, Ligc;-><init>(Lggc;)V
    ...
    invoke-direct {v2, v6, v5}, Lqbb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v6, v7, v1}, Lqbb;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v2, v5, v6}, [Lqbb;
    ...
    invoke-virtual {v3}, Landroidx/fragment/app/b;->D()Lde6;
    ...
    invoke-virtual {v2}, Landroidx/fragment/app/a;->L()Liw7;
    ...
    invoke-direct {v3, v13}, Lyth;-><init>(I)V

    new-instance v5, Lobf;

    const/16 v6, 0x18

    invoke-direct {v5, v3, v6, v4}, Lobf;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    const-string v3, "VideoQualityPickerDialog:result:request"

    invoke-virtual {v1, v3, v2, v5}, Landroidx/fragment/app/c;->d0(Ljava/lang/String;Liw7;Lge6;)V
    ...
    iget-object v2, v1, Li1a;->c:Lmv8;

    check-cast v2, Lo58;

    invoke-virtual {v2}, Lo58;->j()V

    iget-object v3, v1, Li1a;->Z:Lru/ok/messages/media/mediabar/FrgLocalVideo;
    ...
    invoke-virtual {v2}, Lo58;->i()V

    iget-object v1, v1, Li1a;->Z:Lru/ok/messages/media/mediabar/FrgLocalVideo;
    ...
    invoke-virtual {v1, v5, v4}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v4, v12}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_12
    invoke-direct {v2, v3}, Lx85;-><init>(Ljava/util/List;)V

    sput-object v2, Les4;->a:Lx85;
    ...
    sget-object v2, Les4;->a:Lx85;

    invoke-static {v2}, Lx85;->J(Lx85;)Ljava/lang/String;
    ...
    invoke-static {v8, v1}, Lgth;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v7, v12}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v8, v0}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v0, v8}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v8, v4}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v4, v2}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v10, v2}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v3, v2}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v2, v0}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v3, v0}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v0, v12}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_50
    invoke-direct {v5, v6}, Lx85;-><init>(Ljava/util/List;)V

    sput-object v5, Lds4;->a:Lx85;
    ...
    invoke-static {v1}, Lx85;->J(Lx85;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v8, v7}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v7, v8}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v10, v8}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v8, v2}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v2, v12}, Laic;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_5d
    invoke-direct {v4, v5}, Lx85;-><init>(Ljava/util/List;)V

    sput-object v4, Lcs4;->a:Lx85;
    ...
    invoke-virtual {v0, v5}, Ln1a;->T0(I)V
    ...
    iget-object v0, v0, Ln1a;->A0:Lru/ok/messages/location/FrgLocationMap;
    ...
    invoke-virtual {v0, v8}, Ln1a;->T0(I)V
    ...
    invoke-virtual {v0, v7}, Ln1a;->T0(I)V
    ...
    :cond_63
    iget-object v3, v0, Ln1a;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v2, v0, Ln1a;->A0:Lru/ok/messages/location/FrgLocationMap;
    ...
    iget-wide v4, v1, Lt68;->a:D

    iget-wide v6, v1, Lt68;->b:D

    const/4 v8, 0x0

    invoke-virtual/range {v3 .. v8}, Lh2a;->C(DDZ)V

    const/4 v8, 0x1

    iput-boolean v8, v0, Ln1a;->E0:Z
    ...
    iget-object v1, v0, Ln1a;->A0:Lru/ok/messages/location/FrgLocationMap;

    iget-object v2, v0, Ln1a;->B0:Lc78;

    iget-wide v2, v2, Lc78;->h:J
    ...
    :cond_66
    iget-object v3, v0, Ln1a;->B0:Lc78;

    iget-wide v3, v3, Lc78;->o:J

    cmp-long v3, v3, v9

    if-eqz v3, :cond_68

    iget-object v3, v0, Ln1a;->o:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, v2, Lqg8;->c:J
    ...
    invoke-virtual {v1, v4}, Lru/ok/messages/location/FrgLocationMap;->M0(Lqg8;)V

    goto :goto_24

    :cond_68
    invoke-virtual {v1, v2}, Lru/ok/messages/location/FrgLocationMap;->M0(Lqg8;)V
    ...
    iget-object v1, v0, Ln1a;->C0:Lt68;
    ...
    :cond_6b
    iget-object v1, v0, Ln1a;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, v3, Lc78;->e:Lb78;

    iget-object v4, v2, Lru/ok/messages/location/FrgLocationMap;->C1:Lc78;
    ...
    iget-object v4, v2, Lru/ok/messages/views/fragments/base/FrgBase;->n1:Lisd;
    ...
    invoke-direct {v7, v4, v5}, Lj4e;-><init>(J)V

    iput-object v1, v7, Lf4e;->g:Lt68;

    iget-wide v3, v3, Lb78;->b:J

    iput-wide v3, v7, Lf4e;->i:J
    ...
    invoke-direct {v1, v7}, Lg4e;-><init>(Lf4e;)V
    ...
    invoke-virtual {v3, v1}, Lsoh;->b(Lk3e;)V
    ...
    invoke-static {v8, v1, v2}, Lhyg;->z(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Ln1a;->U0(Lhr3;)V

    invoke-virtual {v0, v6}, Ln1a;->a1(Lj1a;)V
    ...
    :cond_6f
    iget-object v4, v0, Ln1a;->D0:Lqg8;

    iget-object v4, v4, Lqg8;->a:Lt68;
    ...
    invoke-virtual {v1}, Lh2a;->E()[D

    move-result-object v1

    iget-object v4, v0, Ln1a;->D0:Lqg8;

    invoke-virtual {v4}, Lqg8;->a()Lpg8;
    ...
    invoke-direct {v6, v10, v11, v12, v13}, Lt68;-><init>(DD)V

    iput-object v6, v4, Lpg8;->a:Lt68;

    new-instance v1, Lqg8;

    invoke-direct {v1, v4}, Lqg8;-><init>(Lpg8;)V

    iput-object v1, v0, Ln1a;->D0:Lqg8;

    :cond_70
    iget-object v0, v0, Ln1a;->D0:Lqg8;

    iget-object v0, v0, Lqg8;->a:Lt68;
    ...
    :cond_71
    iget-object v4, v2, Lru/ok/messages/location/FrgLocationMap;->x1:Lne6;
    ...
    iget-object v0, v2, Lru/ok/messages/location/FrgLocationMap;->x1:Lne6;

    iget v1, v2, Lru/ok/messages/location/FrgLocationMap;->E1:I

    invoke-interface {v0, v1, v5, v4}, Lne6;->c0(IILandroid/content/Intent;)V
    ...
    :cond_72
    iget-object v4, v2, Lru/ok/messages/location/FrgLocationMap;->y1:Ln1a;

    iget-object v6, v4, Ln1a;->B0:Lc78;

    iget-object v6, v4, Lqci;->b:Ljava/lang/Object;

    check-cast v6, Lq1a;

    check-cast v6, Lh2a;

    invoke-virtual {v6}, Lh2a;->F()Lve8;

    iget-object v4, v4, Ln1a;->C0:Lt68;

    iget-object v10, v2, Lru/ok/messages/location/FrgLocationMap;->A1:Lxkf;

    iget-wide v11, v0, Lt68;->a:D

    iget-wide v13, v0, Lt68;->b:D

    iget-wide v5, v4, Lt68;->a:D

    iget-wide v8, v4, Lt68;->b:D

    move-wide v15, v5

    move-wide/from16 v17, v8

    invoke-interface/range {v10 .. v18}, Lxkf;->c(DDDD)Z
    ...
    iget-object v2, v0, Ln1a;->x0:Lkoh;

    invoke-virtual {v2}, Lkoh;->E()V
    ...
    iget-object v2, v2, Lqg8;->a:Lt68;

    iget-wide v14, v2, Lt68;->a:D

    iget-wide v2, v2, Lt68;->b:D
    ...
    iput-object v3, v0, Ln1a;->D0:Lqg8;
    ...
    iget-object v0, v0, Ln1a;->C0:Lt68;

    iget-wide v4, v0, Lt68;->a:D

    iget-wide v6, v0, Lt68;->b:D
    ...
    invoke-direct {v3, v4, v5, v8, v9}, Lt68;-><init>(DD)V

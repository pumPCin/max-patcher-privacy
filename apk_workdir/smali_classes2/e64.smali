...
.field public static final c:Lve5;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1}, Lve5;-><init>(ILjava/lang/Object;)V
...
.method public static a(Ljava/io/File;)La64;
    .locals 13
    ...
    invoke-static {v1, v2, v4, v3}, Ls9f;->F(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {v0}, Lu9d;->w(Ljava/lang/String;)I
    ...
    invoke-static {p0, v0}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v1}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v2}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    const-string v3, "all_stacktraces"

    invoke-static {p0, v3}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    const-string v7, "all_logs"

    invoke-static {p0, v7}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct/range {v3 .. v12}, La64;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public b(ILjava/lang/Throwable;Lgjf;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)La64;
    .locals 9
    ...
    :try_start_0
    invoke-static {p2, v1}, Ltsd;->b(Ljava/lang/Throwable;Ljava/lang/Appendable;)V
    :try_end_0
...
.method public c(I[BLgjf;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)La64;
    .locals 17
    ...
    iget-object v3, v10, Le64;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v6, v7, v5}, Laaf;->n(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v4, v0}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, v3}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_1
    :try_start_0
    invoke-static {v11}, Lp0j;->b(Ljava/io/File;)V

    const-string v0, "stacktrace"

    invoke-static {v11, v0}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v11, v3}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    invoke-static/range {p3 .. p3}, Lrt;->c(Lgjf;)Lorg/json/JSONObject;
    ...
    invoke-static {v3, v4}, Lpu5;->h(Ljava/io/File;Ljava/lang/String;)V

    const-string v4, "tags"

    invoke-static {v11, v4}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v4, v6}, Lpu5;->h(Ljava/io/File;Ljava/lang/String;)V

    :cond_3
    const-string v6, "all_stacktraces"

    invoke-static {v11, v6}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v15, v13, v5, v8}, Ltsd;->d(Ljava/lang/StackTraceElement;Ljava/lang/Appendable;II)V
    :try_end_4
    ...
    :try_start_7
    invoke-static {v13, v1}, Lqoi;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v11, v7}, Lpu5;->g(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v13, v9, v5}, Lz78;->a(Ljava/io/OutputStream;I)V
    :try_end_8
    ...
    invoke-direct/range {v0 .. v9}, La64;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_b
    ...
    :catch_1
    :goto_b
    invoke-static {v11}, Lpu5;->b(Ljava/io/File;)Z

...
.field public volatile j:Lmp3;

.field public final k:Ljava/util/concurrent/CopyOnWriteArraySet;

.field public final l:Lzo3;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Lwoe;Lrhf;)V
    .locals 0
    ...
    iput-object p2, p0, Lap3;->b:Ljava/util/concurrent/ExecutorService;

    iput-object p3, p0, Lap3;->c:Lwoe;

    iput-object p4, p0, Lap3;->d:Lrhf;
    ...
    iput-object p1, p0, Lap3;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lap3;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p3, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p3, p0, Lap3;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p3, Lxo3;

    const/4 p4, 0x0

    invoke-direct {p3, p0, p4}, Lxo3;-><init>(Lap3;I)V

    new-instance p4, Lrhf;

    invoke-direct {p4, p3}, Lrhf;-><init>(Loh6;)V

    iput-object p4, p0, Lap3;->h:Lrhf;
    ...
    iput-object p4, p0, Lap3;->i:Lrhf;

    sget-object p3, Lmp3;->a:Lmp3;

    iput-object p3, p0, Lap3;->j:Lmp3;

    new-instance p3, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {p3}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object p3, p0, Lap3;->k:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance p3, Lzo3;

    const/4 p4, 0x0

    invoke-direct {p3, p4, p0}, Lzo3;-><init>(ILjava/lang/Object;)V

    iput-object p3, p0, Lap3;->l:Lzo3;

    new-instance p3, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p4, Lyo3;->g:Lyo3;

    invoke-direct {p3, p4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, p0, Lap3;->m:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p3, p0, Lap3;->n:Ljava/lang/String;

    invoke-virtual {p0, p2}, Lap3;->n(Z)Z

    move-result p2

    invoke-virtual {p1, p2}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p0}, Lap3;->l()V

    return-void
.end method

.method public static j(Landroid/net/NetworkCapabilities;)Lmp3;
    .locals 1
    ...
    sget-object p0, Lmp3;->o:Lmp3;

    return-object p0

    :cond_3
    sget-object p0, Lmp3;->X:Lmp3;

    return-object p0

    :cond_4
    :goto_0
    sget-object p0, Lmp3;->a:Lmp3;
...
.method public final a()Z
    ...
    invoke-virtual {p0}, Lap3;->k()Landroid/net/ConnectivityManager;
...
.method public final b()Lmp3;
    ...
    invoke-static {v0}, Lap3;->j(Landroid/net/NetworkCapabilities;)Lmp3;
    ...
    invoke-virtual {p0, v2, v0}, Lap3;->m(Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v1, p0, Lap3;->j:Lmp3;
...
.method public final c(Luo3;)V
    ...
    iget-object v0, p0, Lap3;->k:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final d()Z
    ...
    iget-object v0, p0, Lap3;->m:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v1, p0, Lap3;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-boolean v0, v0, Lyo3;->f:Z

    return v0

    :cond_0
    invoke-virtual {p0}, Lap3;->h()Landroid/net/Network;

    move-result-object v0

    invoke-virtual {p0, v0}, Lap3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
...
.method public final f()Z
    ...
    iget-object v0, p0, Lap3;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {v4, v0}, Lyy8;->e(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public final h()Landroid/net/Network;
    ...
    iget-object v0, p0, Lap3;->n:Ljava/lang/String;
...
.method public final invalidate()V
    ...
    invoke-virtual {p0, v1}, Lap3;->n(Z)Z
    ...
    invoke-virtual {p0, v2, v2}, Lap3;->p(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
...
.method public final l()V
    ...
    iget-object v0, p0, Lap3;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v3, v5, v0, v6, v4}, Lkwa;->c(Lf88;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iget-object v3, p0, Lap3;->a:Landroid/content/Context;

    new-instance v5, Ljo;

    const/4 v6, 0x5

    invoke-direct {v5, v6, p0}, Ljo;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v3, p0, Lap3;->n:Ljava/lang/String;
    ...
    invoke-virtual {v5, v6, v3, v7, v4}, Lkwa;->c(Lf88;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_2
    iget-object v4, p0, Lap3;->n:Ljava/lang/String;
    ...
    iget-object v4, p0, Lap3;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2, v4}, Lvta;->c(Ljava/lang/Throwable;)V
...
.method public final m(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1, v0, p2}, Ld64;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final n(Z)Z
    ...
    iget-object p1, p0, Lap3;->n:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p1}, Lap3;->m(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final o(Lyo3;)V
    ...
    :cond_3
    :goto_0
    iget-object p1, p0, Lap3;->b:Ljava/util/concurrent/ExecutorService;
...
.method public final p(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {v1}, Lap3;->h()Landroid/net/Network;
    ...
    :goto_0
    invoke-virtual {v1, v4}, Lap3;->i(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    :try_start_0
    invoke-virtual {v1}, Lap3;->k()Landroid/net/ConnectivityManager;
    ...
    iget-object v0, v1, Lap3;->n:Ljava/lang/String;

    const-string v7, "Unable to get active network info"

    invoke-static {v0, v7}, Lndi;->z(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v7, v1, Lap3;->n:Ljava/lang/String;
    ...
    :cond_a
    iget-object v8, v1, Lap3;->n:Ljava/lang/String;
    ...
    :cond_b
    sget-object v7, Lf88;->X:Lf88;

    invoke-virtual {v15, v7}, Lkwa;->b(Lf88;)Z
    ...
    invoke-virtual {v15, v7, v8, v9, v5}, Lkwa;->c(Lf88;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_f
    sget-object v15, Lf88;->o:Lf88;

    invoke-virtual {v8, v15}, Lkwa;->b(Lf88;)Z
    ...
    invoke-virtual {v8, v15, v7, v0, v2}, Lkwa;->c(Lf88;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct/range {v8 .. v14}, Lyo3;-><init>(ZZZZZZ)V
    ...
    :cond_10
    invoke-virtual {v1, v5}, Lap3;->o(Lyo3;)V

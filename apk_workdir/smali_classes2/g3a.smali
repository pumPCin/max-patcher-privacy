...
# direct methods
.method public constructor <init>(Landroid/content/Context;Llpa;Lre4;Lala;Lnnb;)V
    .locals 0
    ...
    iput-object p2, p0, Lg3a;->b:Llpa;

    iput-object p3, p0, Lg3a;->c:Lre4;

    iput-object p4, p0, Lg3a;->d:Lala;

    iput-object p5, p0, Lg3a;->e:Lnnb;
...
# virtual methods
.method public final a()Lf3a;
    .locals 14

    iget-object v0, p0, Lg3a;->c:Lre4;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, p0, Lg3a;->a:Landroid/content/Context;

    sget v1, Lajc;->tt_notif_category_active_calls:I
    ...
    invoke-direct/range {v2 .. v13}, Lf3a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    return-object v2
.end method

.method public final b()Lf3a;
    .locals 14
    ...
    sget v1, Lajc;->tt_notif_category_incoming_calls:I

    invoke-virtual {v0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    iget-object v0, p0, Lg3a;->e:Lnnb;
...
.method public final c()Lf3a;
    ...
    iget-object v1, v0, Lpnb;->c:Lz2g;

    const-string v2, "app.notification.chats.ringtone"

    invoke-virtual {v1, v2}, Lz2g;->t(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lg3a;->i(Z)Landroid/net/Uri;

    move-result-object v8

    iget-object v1, p0, Lg3a;->c:Lre4;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, p0, Lg3a;->a:Landroid/content/Context;

    sget v3, Lajc;->tt_notif_category_chats:I
    ...
    invoke-direct/range {v3 .. v14}, Lf3a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    return-object v3
.end method

.method public final d()Lf3a;
    .locals 15
    ...
    invoke-virtual {p0, v2}, Lg3a;->i(Z)Landroid/net/Uri;
    ...
    sget v3, Lajc;->tt_notif_category_dialogs:I
...
.method public final e()Lf3a;
    ...
    sget v1, Lajc;->tt_notif_category_inapp:I
...
.method public final f(Lf3a;)V
    ...
    iget-object v1, p1, Lf3a;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lf3a;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Lf3a;->f:Z
    ...
    iget-object v5, p1, Lf3a;->b:Ljava/lang/String;

    invoke-direct {v3, v1, v5, v0}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    iget-object v0, p1, Lf3a;->e:Landroid/net/Uri;

    if-eqz v0, :cond_5

    iget-object v5, p0, Lg3a;->c:Lre4;
    ...
    iget-object v0, p0, Lg3a;->d:Lala;

    invoke-virtual {v0, v1}, Lala;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final g()V
    ...
    iget-object v1, v0, Lg3a;->d:Lala;

    iget-object v2, v1, Lala;->e:Lh4f;
    ...
    invoke-direct {v3, v4}, Lus;-><init>(I)V
    ...
    invoke-virtual {v3, v4}, Lus;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v2}, Lus;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v4, v2}, Lala;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v2}, Lala;->a(ILjava/lang/String;)V

    :cond_3
    invoke-virtual {v0}, Lg3a;->j()Landroid/app/NotificationManager;
    ...
    invoke-virtual {v0}, Lg3a;->c()Lf3a;

    move-result-object v3

    invoke-virtual {v0, v3}, Lg3a;->f(Lf3a;)V
    ...
    iget-object v4, v0, Lg3a;->a:Landroid/content/Context;

    if-nez v3, :cond_7

    iget-object v3, v0, Lg3a;->e:Lnnb;

    check-cast v3, Lpnb;

    iget-object v5, v3, Lpnb;->c:Lz2g;

    const-string v6, "app.notification.ringtone"

    invoke-virtual {v5, v6}, Lz2g;->t(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lg3a;->i(Z)Landroid/net/Uri;

    move-result-object v12

    sget v5, Lajc;->tt_notif_category_misc:I
    ...
    invoke-virtual {v3, v5, v6}, Lbo7;->getBoolean(Ljava/lang/String;Z)Z

    move-result v11

    new-instance v7, Lf3a;
    ...
    invoke-direct/range {v7 .. v18}, Lf3a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    invoke-virtual {v0, v7}, Lg3a;->f(Lf3a;)V
    ...
    sget v3, Lajc;->tt_notif_category_file_loading:I
    ...
    invoke-direct/range {v5 .. v16}, Lf3a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZZ)V

    invoke-virtual {v0, v5}, Lg3a;->f(Lf3a;)V
    ...
    sget v3, Lajc;->tt_notif_category_media:I
    ...
    sget v3, Lajc;->tt_notif_category_live_location:I
...
.method public final i(Z)Landroid/net/Uri;
    ...
    iget-object p1, v0, Lpnb;->c:Lz2g;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Lz2g;->t(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lg3a;->f:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lg3a;->f:Landroid/app/NotificationManager;
...
.method public final k()Z
    ...
    invoke-virtual {p0, v0}, Lg3a;->h(Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object v1

    invoke-virtual {p0}, Lg3a;->a()Lf3a;
    ...
    invoke-virtual {p0, v2}, Lg3a;->f(Lf3a;)V

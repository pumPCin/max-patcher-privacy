...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lqh;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lqh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-virtual {v0, v7, v3}, Lqh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lgh;->Y:Lgh;
    ...
    instance-of v12, v3, Luh;

    if-nez v12, :cond_6

    instance-of v3, v3, Lvh;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    :cond_0
    instance-of v1, p2, Lvh;

    if-eqz v1, :cond_2

    new-instance p2, Lsh;

    invoke-direct {p2, v5}, Lsh;-><init>(F)V
    ...
    invoke-direct {p2, v4}, Lrh;-><init>(I)V

    :cond_2
    :goto_1
    instance-of v1, p2, Lsh;

    instance-of v6, p2, Luh;

    const/4 v7, 0x0

    if-eqz v6, :cond_11

    instance-of p2, v2, Luh;
    ...
    iget-object v1, v1, Luh;->a:Ljava/lang/String;
    ...
    iget-object v5, v5, Luh;->a:Ljava/lang/String;
    ...
    iget-object p2, v2, Luh;->a:Ljava/lang/String;
    ...
    iget-object v7, v3, Luh;->a:Ljava/lang/String;

...
# instance fields
.field public final X:Luhd;

.field public volatile Y:Lorg/webrtc/VpxEncoderWrapper;

.field public volatile Z:Lig6;
...
.field public volatile q0:Lig6;

.field public volatile r0:J

.field public final s0:Livf;

.field public final t0:Livf;
...
# direct methods
.method public constructor <init>(Lfwc;Luhd;)V
    .locals 4
    ...
    iput-object v0, p0, Luf6;->u0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, Luf6;->o:Lfwc;

    iput-object p2, p0, Luf6;->X:Luhd;

    new-instance p1, Ld24;

    const-string p2, "SSFrameEncoder"

    invoke-direct {p1, p2}, Ld24;-><init>(Ljava/lang/String;)V

    iput-object p1, p0, Luf6;->c:Ld24;

    new-instance p1, Livf;

    invoke-direct {p1}, Livf;-><init>()V

    iput-object p1, p0, Luf6;->s0:Livf;

    new-instance p1, Livf;

    invoke-direct {p1}, Livf;-><init>()V

    iput-object p1, p0, Luf6;->t0:Livf;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Luf6;->v0:Z

    iget-object v0, p0, Luf6;->Y:Lorg/webrtc/VpxEncoderWrapper;
    ...
    iput-object v0, p0, Luf6;->Y:Lorg/webrtc/VpxEncoderWrapper;
...
.method public final onEncodedImage(Lorg/webrtc/EncodedImage;)V
    ...
    iget-object v0, p0, Luf6;->s0:Livf;
    ...
    iput-wide v2, p0, Luf6;->r0:J

    :cond_0
    iget-object v0, p0, Luf6;->Z:Lig6;

    if-eqz v0, :cond_3

    iget-object v0, p0, Luf6;->Z:Lig6;

    iget-boolean v2, v0, Lig6;->a:Z
    ...
    iput-boolean v1, v0, Lig6;->h:Z

    :cond_2
    iget-object v1, v0, Lig6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Lig6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, v0, Lig6;->g:Lbsh;

    invoke-static {p1}, Lig6;->b(Lbsh;)V
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v2, p0, Luf6;->q0:Lig6;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v3

    iget-wide v5, p0, Luf6;->w0:J

    iget-wide v7, p0, Luf6;->b:J
    ...
    iget-object v5, v2, Lig6;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iget-object v5, v2, Lig6;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-object v5, p0, Luf6;->u0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v7, v0, v1}, Lfwc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v3, p0, Luf6;->w0:J

    iget-object p1, p0, Luf6;->u0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object p1, p0, Luf6;->c:Ld24;

    new-instance v0, Lo65;

    const/16 v3, 0xe

    invoke-direct {v0, p0, v2, v1, v3}, Lo65;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final onFrameDropped(I)V
    ...
    iget-object p1, p0, Luf6;->t0:Livf;

    invoke-virtual {p1}, Livf;->a()V

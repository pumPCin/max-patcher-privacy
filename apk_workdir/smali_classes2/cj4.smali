...
# static fields
.field public static final j:[Luhg;
...
.method public constructor <init>(Lnae;Lwkc;Lh6b;Lho4;)V
    ...
    iput-object p1, p0, Lcj4;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcj4;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lcj4;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Lcj4;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Lyg1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Lcj4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v0, p2}, Lbhg;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, v2, p0}, Llo3;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Lc;-><init>(Lo6b;Loo3;I)V

    const-string v1, "DefaultRemoteVideoTracks.clearRemoteVideoRenderers"

    invoke-virtual {v0, v1, v2}, Lo6b;->j(Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method public final e(Lyg1;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3}, Lzzb;-><init>(I)V

    iput-object v1, v2, Lzzb;->c:Ljava/lang/Object;

    iput-object p1, v2, Lzzb;->b:Ljava/lang/Object;

    invoke-virtual {v2}, Lzzb;->a()Lpr1;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Lcj4;->p(Ljava/lang/String;Lpr1;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Lcj4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lbhg;->a:Lorg/webrtc/VideoSink;
...
.method public final p(Ljava/lang/String;Lpr1;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Laj4;-><init>(Lcj4;Ljava/lang/String;Lpr1;Ljava/util/List;)V
    ...
    invoke-direct {p2, p1, v1, p3}, Lc;-><init>(Lo6b;Loo3;I)V

    const-string p3, "DefaultRemoteVideoTracks.setRemoteVideoRenderersOnExecutor"

    invoke-virtual {p1, p3, p2}, Lo6b;->j(Ljava/lang/String;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final u(Ljava/lang/String;Lpr1;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Lcj4;->g:Ljava/util/HashMap;
    ...
    invoke-interface {p1, p3, p2}, Lwkc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, Lcj4;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v4, v1, Lbhg;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Lcj4;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lcj4;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Lcj4;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Lcj4;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Lcj4;->f:Ljava/util/concurrent/ConcurrentHashMap;

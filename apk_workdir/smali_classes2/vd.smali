...
.field public final d:Lro7;

.field public final e:Lh4f;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lo5b;Lro7;)V
    .locals 0
    ...
    iput-object p2, p0, Lvd;->c:Lo5b;

    iput-object p3, p0, Lvd;->d:Lro7;
...
# virtual methods
.method public final a(Lldd;Ljava/lang/String;)Landroid/net/Uri;
    .locals 7

    invoke-interface {p1}, Lldd;->d()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1}, Lldd;->a()I
    ...
    invoke-direct {v0, v5, p2}, Ld3b;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v1}, Ln29;->f(I)Ljava/lang/String;
    ...
    invoke-direct {v1, v5, p2}, Ld3b;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v6, p2}, Ld3b;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v4, p2}, Ld3b;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v0, v1, v5, v2, v3}, [Ld3b;
    ...
    iget-object v5, v4, Ld3b;->a:Ljava/lang/Object;
    ...
    :cond_a
    invoke-interface {p1}, Lldd;->e()Ljava/lang/Integer;
    ...
    :cond_b
    invoke-interface {p1}, Lldd;->getWidth()Ljava/lang/Integer;
    ...
    :cond_c
    invoke-interface {p1}, Lldd;->getHeight()Ljava/lang/Integer;
    ...
    invoke-interface {p1}, Lldd;->c()Landroid/net/Uri;
    ...
    invoke-interface {p1, v5, v3}, Lldd;->b(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    iget-object p1, p0, Lvd;->b:Landroid/content/Context;

    invoke-static {p1, v3}, Lkdd;->e(Landroid/content/Context;Landroid/net/Uri;)V

    return-object v3
.end method

.method public final b(Lldd;Ljava/lang/String;)Landroid/net/Uri;
    .locals 3

    new-instance v0, Ljava/io/File;

    iget-object v1, p0, Lvd;->c:Lo5b;

    invoke-virtual {v1}, Lo5b;->a()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v0, v2, p2}, Ljava/io/File;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {p1, v0}, Lldd;->f(Ljava/io/File;)V

    iget-object p1, v1, Lo5b;->a:Landroid/content/Context;

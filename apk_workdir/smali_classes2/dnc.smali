...
.method public constructor <init>(Lenc;Lone/me/rlottie/RLottieImageView;)V
    ...
    iput-object p2, p0, Ldnc;->c:Lone/me/rlottie/RLottieImageView;
...
.method public final onAllFramesRendered(Lone/me/rlottie/RLottieDrawable;Z)V
    ...
    iget-object p2, p1, Lenc;->a:Ljava/lang/String;

    iget-boolean v0, p0, Ldnc;->a:Z

    const-string v1, "Reaction effect. OnAllFramesRendered, called:"

    invoke-static {v1, p2, v0}, Lbk7;->q(Ljava/lang/String;Ljava/lang/String;Z)V

    iget-boolean p2, p0, Ldnc;->a:Z
    ...
    iget-object v1, p0, Ldnc;->c:Lone/me/rlottie/RLottieImageView;

    invoke-direct {p2, p0, p1, v1, v0}, Lyda;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

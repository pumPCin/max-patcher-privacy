...
# direct methods
.method public constructor <init>(Lkga;Lorg/webrtc/CameraVideoCapturer;Lhlf;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLyuc;)V
    .locals 4
    ...
    iput-object v0, p0, Lb02;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lb02;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lb02;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lb02;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Lb02;->h:Ljava/lang/String;

    iput-object p7, p0, Lb02;->e:Lyuc;

    check-cast p1, Lqt1;

    new-instance p7, Ltui;

    new-instance v2, Lpdb;

    new-instance v3, Le22;

    iget-object p1, p1, Lqt1;->a:Lyuc;

    invoke-direct {v3, p1}, Le22;-><init>(Lyuc;)V

    invoke-direct {v2, p2, v3, p1}, Lpdb;-><init>(Lorg/webrtc/CameraVideoCapturer;Le22;Lyuc;)V

    invoke-direct {p7, v2}, Ltui;-><init>(Ljava/lang/Object;)V

    iput-object p7, p0, Lb02;->c:Ltui;

    iput-object p3, p0, Lb02;->d:Lhlf;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Lb02;->i:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Lb02;->g:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lb02;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Lb02;->b:Ljava/util/ArrayList;
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lmb3;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-interface {v5, v6, v2}, Lyuc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lf67;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Lb02;->e:Lyuc;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Lyuc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lb02;->e:Lyuc;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Lxx1;->k(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Lyuc;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lb02;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lz58;->r:Lb02;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lz58;->n:Lyuc;
    ...
    invoke-interface {v8, v10, v11, v9}, Lyuc;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lz58;->y:Lgvg;

    iget-object v8, v7, Ltq3;->c:Ljava/lang/Object;
    ...
    invoke-static {v10, v2, v0, v5}, Lf67;->g(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Lyuc;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lgvg;->k:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Lgvg;->u()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Lb02;->k:Z
    ...
    iget-object v4, p0, Lb02;->c:Ltui;

    iget-object v4, v4, Ltui;->a:Ljava/lang/Object;

    check-cast v4, Lpdb;

    invoke-virtual {v4, v2, v0, v3}, Lpdb;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lpdb;->startCapture(III)V

    iput-boolean v1, p0, Lb02;->k:Z
    :try_end_1
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lpdb;->stopCapture()V

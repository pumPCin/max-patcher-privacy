...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ly71;->i:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lavf;Lj9f;Lbua;Lcs8;Lfwc;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ly71;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Ly71;->b:Lavf;

    iput-object p3, p0, Ly71;->c:Lj9f;

    iput-object p4, p0, Ly71;->d:Lbua;

    iput-object p5, p0, Ly71;->e:Lcs8;

    iput-object p6, p0, Ly71;->f:Lfwc;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Ly71;->h:Ljava/util/ArrayList;
...
.method public final b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Ly71;->h:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Ly71;->h:Ljava/util/ArrayList;

    invoke-static {v1}, Lnb3;->Y(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Ly71;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lrth;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object v3, v1, Lrth;->d:Ljava/lang/Long;
    ...
    invoke-interface {v3}, Lavf;->localTimeMs()J
    ...
    iget-object v6, v1, Lrth;->a:Ljava/lang/String;

    iget-object v1, v1, Lrth;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object v2, p0, Ly71;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Ly71;->b:Lavf;

    invoke-interface {v1}, Lavf;->getServerTimeMs()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Lrth;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object v2, p0, Ly71;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez v2, :cond_0

    iget-object p1, p0, Ly71;->h:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Ly71;->h:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p0, Ly71;->b:Lavf;

    invoke-interface {v0}, Lavf;->getServerTimeMs()Ljava/lang/Long;
    ...
    invoke-interface {v0}, Lavf;->localTimeMs()J
    ...
    iget-object p2, p0, Ly71;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final onTopologyUpdated(Lrzf;Lrzf;)V
    ...
    iget-object p1, p0, Ly71;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p0, Ly71;->c:Lj9f;

    invoke-virtual {p2, p1}, Lj9f;->a(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iget-object p2, p0, Ly71;->d:Lbua;

    iget-object p2, p2, Lbua;->b:Ljava/lang/Object;

    check-cast p2, Lz34;

    iget-object p2, p2, Lz34;->a:Ljava/lang/String;
    ...
    iget-object p2, p0, Ly71;->e:Lcs8;

    iget-object v0, p2, Lcs8;->c:Ljava/lang/Object;

    check-cast v0, Landroid/net/ConnectivityManager;

    iget-object p2, p2, Lcs8;->b:Ljava/lang/Object;

    check-cast p2, Landroid/telephony/TelephonyManager;

    invoke-static {v0, p2}, Let9;->b(Landroid/net/ConnectivityManager;Landroid/telephony/TelephonyManager;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Ly71;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iput-object p1, p0, Ly71;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

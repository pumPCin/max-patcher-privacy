...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgm0;->c:Landroid/net/Uri;
...
.method public final getPriority()I
    ...
    iget-object v4, v4, Lrm;->b:Lem;

    invoke-interface {v4}, Lom;->getPriority()I
...
.method public final getScope()Ltm;
    ...
    invoke-interface {v5}, Lom;->getScope()Ltm;
    ...
    invoke-interface {v4}, Lem;->getScopeAfter()Lum;

    move-result-object v4

    sget-object v5, Lum;->a:Lum;
...
.method public final getScopeAfter()Lum;
    ...
    iget-object v3, v3, Lrm;->b:Lem;

    invoke-interface {v3}, Lem;->getScopeAfter()Lum;
    ...
    invoke-interface {v0}, Lem;->getScopeAfter()Lum;
...
.method public final getUri()Landroid/net/Uri;
    ...
    sget-object v0, Lgm0;->c:Landroid/net/Uri;
...
.method public final shouldGzip()Z
    ...
    invoke-interface {v4}, Lom;->shouldGzip()Z
...
.method public final writeParams(Lcr7;)V
    ...
    iget-object v4, v3, Lrm;->b:Lem;

    invoke-interface {p1}, Lcr7;->s()V

    iget-object v3, v3, Lrm;->c:Ljava/lang/String;

    invoke-interface {p1, v3}, Lcr7;->b0(Ljava/lang/String;)Lcr7;

    invoke-interface {p1}, Lcr7;->s()V

    invoke-interface {v4}, Lom;->willWriteParams()Z
    ...
    invoke-interface {v4, p1}, Lom;->writeParams(Lcr7;)V

    invoke-interface {p1}, Lcr7;->q()V

    :cond_0
    invoke-interface {v4}, Lom;->willWriteSupplyParams()Z
    ...
    invoke-interface {v4, p1}, Lom;->writeSupplyParams(Lcr7;)V

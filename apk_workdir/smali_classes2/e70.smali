...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Le70;->x0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Le70;->y0:Landroid/graphics/Path;
    ...
    iput-object v1, p0, Le70;->u0:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, Le70;->w0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1, v1}, Landroid/graphics/Paint;-><init>(Landroid/graphics/Paint;)V

    iput-object p1, p0, Le70;->v0:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, p1}, Le70;->onThemeChanged(Lv5b;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Le70;->r0:Ljava/util/List;
    ...
    iget-object v8, p0, Le70;->y0:Landroid/graphics/Path;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Le70;->y0:Landroid/graphics/Path;
    ...
    iget-wide v6, p0, Le70;->q0:J

    long-to-float v4, v6

    iget-wide v6, p0, Le70;->z0:J
    ...
    iget-boolean v3, p0, Le70;->t0:Z

    if-nez v3, :cond_2

    iget-boolean v3, p0, Le70;->A0:Z
    ...
    :goto_2
    iget-object v7, p0, Le70;->u0:Landroid/graphics/Paint;
    ...
    iget-object v9, p0, Le70;->v0:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, Le70;->x0:Landroid/graphics/Paint;

    invoke-virtual {p1, v8, v1, v0, v2}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object v0, p0, Le70;->w0:Landroid/graphics/Paint;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p1, p0, Le70;->B0:Ld70;

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Le70;->getPeaksCount()I
    ...
    sget-object p2, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->f1:[Ltr7;

    invoke-virtual {p1}, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->X0()Lg4d;

    move-result-object p1

    iget-object p1, p1, Lg4d;->s0:Lwif;
    ...
    iget-object p1, v1, Lc70;->e:Lkotlinx/coroutines/internal/ContextScope;
...
.method public final onThemeChanged(Lv5b;)V
    ...
    :goto_0
    iget-object v1, p0, Le70;->u0:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Le70;->x0:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Le70;->v0:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Le70;->t0:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Le70;->A0:Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Le70;->b(Landroid/view/MotionEvent;)F

    move-result v0

    iget-wide v3, p0, Le70;->z0:J
    ...
    iput-wide v0, p0, Le70;->q0:J

    iget-object v0, p0, Le70;->B0:Ld70;
    ...
    invoke-static {v3, v4}, Lp4a;->b(J)Ljava/lang/String;
    ...
    sget-object v3, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->f1:[Ltr7;

    invoke-virtual {v0}, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->X0()Lg4d;

    move-result-object v0

    iget-object v3, v0, Lg4d;->x0:Ln0d;
    ...
    invoke-interface {v0, v3, v4}, Lk28;->seekTo(J)V
...
.method public final setListener(Ld70;)V
    ...
    iput-object p1, p0, Le70;->B0:Ld70;
...
.method public final setPauseRecordingData(Ljava/util/List;)V
    ...
    iput-object p1, p0, Le70;->r0:Ljava/util/List;

    const/4 p1, 0x1

    iput-boolean p1, p0, Le70;->s0:Z

    iget-object p1, p0, Le70;->y0:Landroid/graphics/Path;

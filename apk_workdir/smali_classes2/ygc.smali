...
.method public constructor <init>()V
    ...
    iput-wide v0, p0, Lygc;->b:J

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lygc;->c:Ljava/util/ArrayList;
...
# virtual methods
.method public abstract a(Lvgc;Lfj;)I
.end method

.method public final b(Lxgc;)V
    .locals 1

    iget-object v0, p0, Lygc;->c:Ljava/util/ArrayList;
...
.method public final j(I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {v1, v2}, Lfbb;-><init>(I)V

    iget-object p1, p0, Lygc;->c:Ljava/util/ArrayList;

    invoke-virtual {p1, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1, v0}, Lfbb;->g(Ljava/nio/ByteBuffer;)V
...
.method public abstract s(Ljava/nio/ByteBuffer;Llc;JLt88;I)V
.end method

.method public final t(Ljava/nio/ByteBuffer;BILlc;JLt88;)V
    .locals 22
    ...
    :goto_1
    invoke-virtual {v0, v2}, Lygc;->v(B)V
    ...
    invoke-interface {v5, v7}, Lt88;->decrypted(Ljava/lang/String;)V
    ...
    invoke-interface {v5, v7, v9}, Lt88;->encrypted(Ljava/lang/String;[B)V
    ...
    invoke-interface {v5, v1, v6}, Lt88;->encrypted(Ljava/lang/String;[B)V

    iget-wide v7, v0, Lygc;->b:J
    ...
    iget-short v7, v7, Lkje;->g:S

    move-object v8, v4

    check-cast v8, Loc;

    iget-object v12, v8, Loc;->b:Lt88;
    ...
    invoke-interface {v12, v7, v13}, Lt88;->secret(Ljava/lang/String;[B)V
    ...
    invoke-interface {v12, v7}, Lt88;->info(Ljava/lang/String;)V
    ...
    invoke-interface {v5, v3, v1}, Lt88;->decrypted(Ljava/lang/String;[B)V

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, v0, Lygc;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, Lygc;->c:Ljava/util/ArrayList;

    new-instance v8, Le8f;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1, v5}, Le8f;->h(Ljava/nio/ByteBuffer;Lt88;)V
    ...
    invoke-virtual {v8, v1}, Lmv6;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v8}, Ljo3;-><init>()V

    invoke-virtual {v8, v1}, Ljo3;->j(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Ldeb;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lvdb;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1}, Lxgc;->e(Ljava/nio/ByteBuffer;)I
    ...
    new-instance v8, Lm7a;

    invoke-direct {v8}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v8, v1}, Lm7a;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Le9f;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v8, v9}, Lri8;-><init>(I)V

    invoke-virtual {v8, v1}, Lri8;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v8, v9}, Lza4;-><init>(I)V

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->get()B

    invoke-static {v1}, Loai;->i(Ljava/nio/ByteBuffer;)J

    move-result-wide v9

    iput-wide v9, v8, Lza4;->b:J
    ...
    invoke-virtual {v8, v1}, Lsi8;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Lri8;->j(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1, v5}, Lv7a;->h(Ljava/nio/ByteBuffer;Lt88;)V
    ...
    invoke-virtual {v8, v1, v5}, Lb84;->h(Ljava/nio/ByteBuffer;Lt88;)V
    ...
    invoke-virtual {v8, v1}, Lri8;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Libd;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1, v5}, Ly5;->i(Ljava/nio/ByteBuffer;Lt88;)V
    ...
    invoke-virtual {v8, v1}, Lfbb;->h(Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v8, v1}, Ldc4;->h(Ljava/nio/ByteBuffer;)V
    ...
    :cond_b
    invoke-virtual {v0, v2}, Lygc;->d(B)V
    ...
    invoke-interface {v5, v1}, Lt88;->error(Ljava/lang/String;)V
...
.method public final u(Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;Llc;)V
    ...
    iget-wide v5, v0, Lygc;->b:J

    invoke-static {v5, v6}, Lygc;->f(J)[B

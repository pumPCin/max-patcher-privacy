...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILkuc;)V
    .locals 0

    invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V

    iput-object p1, p0, Lco0;->a:Landroid/content/Context;

    iput-object p2, p0, Lco0;->b:Landroid/net/Uri;

    iput-object p3, p0, Lco0;->c:Landroid/net/Uri;

    iput p4, p0, Lco0;->d:I

    iput p5, p0, Lco0;->e:I

    iput-object p6, p0, Lco0;->f:Lkuc;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    :try_start_0
    iget-object v2, p0, Lco0;->a:Landroid/content/Context;
    ...
    :cond_0
    invoke-static {v2}, Lr5b;->k(Ljava/io/Closeable;)V

    invoke-static {p1}, Lr5b;->k(Ljava/io/Closeable;)V

    iput-object v0, p0, Lco0;->b:Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {v1}, Lr5b;->k(Ljava/io/Closeable;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-direct {v4, v5}, Lm26;-><init>(I)V

    invoke-virtual {p1}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v4, p1}, Lm26;->w(Ljava/lang/String;)V

    invoke-virtual {v4}, Lm26;->c()Lwzc;

    move-result-object p1

    invoke-virtual {v1, p1}, Lsca;->b(Lwzc;)Lgpc;
    ...
    :try_start_2
    iget-object v5, p0, Lco0;->a:Landroid/content/Context;
    ...
    sget-object v5, Lxca;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v5, p2, v7, v6}, Lnx;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-interface {v4, v5}, Llu0;->G(Lnx;)J
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-static {v4}, Lr5b;->k(Ljava/io/Closeable;)V

    invoke-static {v5}, Lr5b;->k(Ljava/io/Closeable;)V

    invoke-static {v1}, Lr5b;->k(Ljava/io/Closeable;)V

    invoke-virtual {v2}, Ltoe;->a()V
    ...
    :goto_2
    invoke-static {v3}, Lr5b;->k(Ljava/io/Closeable;)V

    invoke-static {v5}, Lr5b;->k(Ljava/io/Closeable;)V

    if-eqz p1, :cond_1

    iget-object p1, p1, Lj1d;->Z:Ll1d;
...
.method public final c()Ljava/lang/String;
    ...
    iget-object v1, p0, Lco0;->a:Landroid/content/Context;
    ...
    iget-object v0, p0, Lco0;->b:Landroid/net/Uri;
    ...
    invoke-static {v1, v0, v2, v2}, Lb88;->k(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v0}, Lb88;->k(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()Lbo0;
    ...
    iget-object v3, v1, Lco0;->a:Landroid/content/Context;

    iget-object v0, v1, Lco0;->b:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Lbo0;-><init>(Ljava/lang/Exception;)V
    ...
    iget-object v4, v1, Lco0;->b:Landroid/net/Uri;
    ...
    :cond_1
    iget v12, v1, Lco0;->d:I

    iget v13, v1, Lco0;->e:I
    ...
    invoke-direct {v3, v0}, Lv37;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Lv37;->a()I
    ...
    :try_start_4
    invoke-static {v0}, Lr5b;->k(Ljava/io/Closeable;)V
    :try_end_4
    ...
    iput v11, v4, Lbd5;->b:I

    iput v10, v4, Lbd5;->c:I
    ...
    :cond_b
    :goto_7
    invoke-direct {v3, v13, v4}, Lbo0;-><init>(Landroid/graphics/Bitmap;Lbd5;)V
    ...
    invoke-direct {v0, v13, v4}, Lbo0;-><init>(Landroid/graphics/Bitmap;Lbd5;)V
    ...
    invoke-direct {v2, v0}, Lbo0;-><init>(Ljava/lang/Exception;)V
...
.method public final e()V
    ...
    iget-object v3, p0, Lco0;->c:Landroid/net/Uri;
    ...
    iget-object v0, p0, Lco0;->a:Landroid/content/Context;
    ...
    :try_start_0
    iget-object v1, p0, Lco0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Lco0;->c()Ljava/lang/String;
    ...
    iput-object v1, p0, Lco0;->b:Landroid/net/Uri;
    :try_end_1
    ...
    invoke-virtual {p0, v1, v3}, Lco0;->a(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_2
    ...
    iget-object v2, p0, Lco0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v0, v3}, Lco0;->b(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_7
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lbo0;->b:Ljava/lang/Exception;

    iget-object v1, p0, Lco0;->f:Lkuc;

    if-nez v0, :cond_1

    iget-object p1, p1, Lbo0;->a:Landroid/graphics/Bitmap;
    ...
    iput-object v0, v1, Ldof;->z0:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, v1, Ldof;->w0:Z

    invoke-virtual {v1, p1}, Ldof;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, v1, Lkuc;->b:Ljava/lang/Object;
